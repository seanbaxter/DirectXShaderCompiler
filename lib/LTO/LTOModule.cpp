//===-- LTOModule.cpp - LLVM37 Link Time Optimizer --------------------------===//
//
...
/// isBitcodeFile - Returns 'true' if the file (or memory contents) is LLVM37
/// bitcode.
...
LTOModule *LTOModule::makeLTOModule(MemoryBufferRef Buffer,
  ...
  if (!Context) {
    OwnedContext = llvm37::make_unique<LLVM37Context>();
