...
char LICM::ID = 0;
INITIALIZELLVM37_PASS_BEGIN(LICM, "licm", "Loop Invariant Code Motion", false, false)
...
INITIALIZELLVM37_PASS_END(LICM, "licm", "Loop Invariant Code Motion", false, false)
