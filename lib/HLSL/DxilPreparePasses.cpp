...
public:
        ...
        for (BasicBlock::iterator II = BB->begin(), IE = BB->end(); II != IE;
          ...
          if (I->hasMetadataOtherThanDebugLoc()) {
            ...
            for (auto &MD : MDs) {
              ...
              bool bNeedPatch = kind == LLVM37Context::MD_tbaa ||
                  kind == LLVM37Context::MD_prof ||
                  (kind > LLVM37Context::MD_fpmath &&
                  kind <= LLVM37Context::MD_dereferenceable_or_null);
              if (bNeedPatch)
  ...
  // Replace llvm37.lifetime.start/.end intrinsics with undef or zeroinitializer
