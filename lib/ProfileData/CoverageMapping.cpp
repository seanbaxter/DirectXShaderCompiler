...
//===----------------------------------------------------------------------===//
//
// This file contains support for clang's and llvm37's instrumentation based
// code coverage.
//
//===----------------------------------------------------------------------===//
...
ErrorOr<int64_t> CounterMappingContext::evaluate(const Counter &C) const {
  ...
  llvm37_unreachable("Unhandled CounterKind");
}
...
class CoverageMappingErrorCategoryType : public std::error_category {
  ...
  std::string message(int IE) const override {
    ...
    llvm37_unreachable("A value of coveragemap_error has no message.");
  }
};
}
