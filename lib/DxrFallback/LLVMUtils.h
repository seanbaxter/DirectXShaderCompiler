...
llvm37::ConstantInt* makeInt32(int val, llvm37::LLVMContext& context);

llvm37::Instruction* getInstructionAfter(llvm37::Instruction* inst);

std::unique_ptr<llvm37::Module> loadModuleFromAsmFile(llvm37::LLVMContext& context, const std::string& filename);
std::unique_ptr<llvm37::Module> loadModuleFromAsmString(llvm37::LLVMContext& context, const std::string& str);
