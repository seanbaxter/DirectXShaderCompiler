...
INITIALIZELLVM37_PASS_BEGIN(ShrinkWrap, "shrink-wrap", "Shrink Wrap Pass", false,
                      false)
...
INITIALIZELLVM37_PASS_END(ShrinkWrap, "shrink-wrap", "Shrink Wrap Pass", false, false)
