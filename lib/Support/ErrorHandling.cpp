...
void llvm37::llvm37_unreachable_internal(const char *msg, const char *file,
                                     unsigned line) {
  // This code intentionally doesn't call the ErrorHandler callback, because
  // llvm37_unreachable is intended to be used to indicate "impossible"
...
static void bindingsErrorHandler(void *user_data, const std::string& reason,
                                 bool gen_crash_diag) {
  LLVM37FatalErrorHandler handler =
      LLVM37_EXTENSION reinterpret_cast<LLVM37FatalErrorHandler>(user_data);
...
void LLVM37ResetFatalErrorHandler() {
