...
void pix_dxil::PixDxilInstNum::AddMD(llvm37::LLVM37Context &Ctx,
...
void pix_dxil::PixDxilReg::AddMD(llvm37::LLVM37Context &Ctx, llvm37::Instruction *pI,
                                 std::uint32_t RegNum) {
  llvm37::IRBuilder<> B(Ctx);
  pI->setMetadata(
      llvm37::StringRef(MDName),
...
void pix_dxil::PixAllocaReg::AddMD(llvm37::LLVM37Context &Ctx,
...
void pix_dxil::PixAllocaRegWrite::AddMD(llvm37::LLVM37Context &Ctx,
