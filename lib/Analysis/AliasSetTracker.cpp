...
void AliasSet::print(raw_ostream &OS) const {
  ...
  default: llvm37_unreachable("Bad value for Access!");
  }
...
INITIALIZELLVM37_PASS_BEGIN(AliasSetPrinter, "print-alias-sets",
                "Alias Set Printer", false, true)
INITIALIZELLVM37_AG_DEPENDENCY(AliasAnalysis)
INITIALIZELLVM37_PASS_END(AliasSetPrinter, "print-alias-sets",
                "Alias Set Printer", false, true)
