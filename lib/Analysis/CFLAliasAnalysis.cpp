...
public:
  ...
  void visitInstruction(Instruction &) {
    llvm37_unreachable("Unsupported instruction encountered");
  }
...
static EdgeType flipWeight(EdgeType Initial) {
  ...
  llvm37_unreachable("Incomplete coverage of EdgeType enum");
}
...
static Level directionOfEdgeType(EdgeType Weight) {
  ...
  llvm37_unreachable("Incomplete switch coverage");
}
