...
///
/// \file
/// \brief This file implements the COFF-specific dumper for llvm37-objdump.
...
static StringRef getUnwindCodeTypeName(uint8_t Code) {
  switch(Code) {
  default: llvm37_unreachable("Invalid unwind code");
...
static StringRef getUnwindRegisterName(uint8_t Reg) {
  switch(Reg) {
  default: llvm37_unreachable("Invalid register");
  case 0: return "RAX";
  case 1: return "RCX";
  case 2: return "RDX";
  case 3: return "RBX";
