//===-- llvm37-objdump.cpp - Object file dumping utility for llvm37 -----------===//
//
...
static void printFaultMaps(const ObjectFile *Obj) {
  ...
  if (isa<ELFObjectFileBase>(Obj)) {
    FaultMapSectionName = ".llvm37_faultmaps";
  } else if (isa<MachOObjectFile>(Obj)) {
    FaultMapSectionName = "__llvm37_faultmaps";
  } else {
    errs() << "This operation is only currently supported "
...
int __cdecl main(int argc, char **argv) {
  ...
  cl::ParseCommandLineOptions(argc, argv, "llvm37 object file dumper\n");
