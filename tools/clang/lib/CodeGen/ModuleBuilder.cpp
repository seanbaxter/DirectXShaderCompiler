//===--- ModuleBuilder.cpp - Emit LLVM37 Code from ASTs ---------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This builds an AST and converts it to LLVM37 Code.
//
//===----------------------------------------------------------------------===//
  ...
  public:
    ...
    void HandleTranslationUnit(ASTContext &Ctx) override {
      ...
      if (CodeGenOpts.HLSLEmbedSourcesInModule) {
        ...
        llvm37::LLVM37Context &LLVM37Ctx = M->getContext();
        auto AddFile = [&](StringRef name, StringRef content) {
          ...
          llvm37::MDTuple *pFileInfo = llvm37::MDNode::get(
            LLVM37Ctx,
            { llvm37::MDString::get(LLVM37Ctx, name),
              llvm37::MDString::get(LLVM37Ctx, content) });
        ...
        std::transform(CodeGenOpts.HLSLDefines.begin(), CodeGenOpts.HLSLDefines.end(),
          vecDefines.begin(), [&LLVM37Ctx](const std::string &str) { return llvm37::MDString::get(LLVM37Ctx, str); });
        llvm37::MDTuple *pDefinesInfo = llvm37::MDNode::get(LLVM37Ctx, vecDefines);
        ...
        llvm37::MDTuple *pFileName = llvm37::MDNode::get(
          LLVM37Ctx, llvm37::MDString::get(LLVM37Ctx, CodeGenOpts.MainFileName));
        ...
        std::transform(CodeGenOpts.HLSLArguments.begin(), CodeGenOpts.HLSLArguments.end(),
          vecArguments.begin(), [&LLVM37Ctx](const std::string &str) { return llvm37::MDString::get(LLVM37Ctx, str); });
        llvm37::MDTuple *pArgumentsInfo = llvm37::MDNode::get(LLVM37Ctx, vecArguments);
...
CodeGenerator *clang::CreateLLVM37CodeGen(
    DiagnosticsEngine &Diags, const std::string &ModuleName,
    const HeaderSearchOptions &HeaderSearchOpts,
    const PreprocessorOptions &PreprocessorOpts, const CodeGenOptions &CGO,
    llvm37::LLVM37Context &C, CoverageSourceInfo *CoverageInfo) {
