...
AddDirectArgument(CodeGenFunction &CGF, CallArgList &Args,
  ...
  if (UseOptimizedLibcall) {
    ...
    llvm37::Type *IPtrTy = llvm37::IntegerType::get(CGF.getLLVMContext(),
...
RValue CodeGenFunction::EmitAtomicExpr(AtomicExpr *E, llvm37::Value *Dest) {
  ...
  llvm37::Type *ITy =
      llvm37::IntegerType::get(getLLVMContext(), Size * 8);
...
llvm37::Value *AtomicInfo::emitCastToAtomicIntPointer(llvm37::Value *addr) const {
  ...
  llvm37::IntegerType *ty =
    llvm37::IntegerType::get(CGF.getLLVMContext(), AtomicSizeInBits);
