...
llvm37::Type *CodeGenTypes::ConvertTypeForMem(QualType T) {
  ...
  if (R->isIntegerTy(1)) {
    ...
    return llvm37::IntegerType::get(getLLVMContext(), (unsigned)Context.getTypeSize(T));
  }
...
static llvm37::Type *getTypeForFormat(llvm37::LLVMContext &VMContext,
...
#include "clang/AST/TypeNodes.def"
  ...
  case Type::Builtin: {
    ...
    case BuiltinType::ObjCSel:
      ...
      ResultType = llvm37::Type::getInt8Ty(getLLVMContext());
      break;

    case BuiltinType::Bool:
      // Note that we always return bool as i1 for use as a scalar type.
      ResultType = llvm37::Type::getInt1Ty(getLLVMContext());
      break;
    ...
    case BuiltinType::Char32:
      ResultType = llvm37::IntegerType::get(getLLVMContext(),
...
#pragma prefast(disable: __WARNING_REDUNDANTTEST, "language options are constants, by design")
    ...
    case BuiltinType::NullPtr:
      ...
      ResultType = llvm37::Type::getInt8PtrTy(getLLVMContext());
      break;
        
    case BuiltinType::UInt128:
    case BuiltinType::Int128:
      ResultType = llvm37::IntegerType::get(getLLVMContext(), 128);
      break;
...
#include "clang/AST/BuiltinTypes.def"
  ...
  case Type::Pointer: {
    ...
    if (PointeeType->isVoidTy())
      PointeeType = llvm37::Type::getInt8Ty(getLLVMContext());
    unsigned AS = Context.getTargetAddressSpace(ETy);
    ResultType = llvm37::PointerType::get(PointeeType, AS);
    break;
  }
  ...
  case Type::ConstantArray: {
    ...
    if (!EltTy->isSized()) {
      SkippedLayout = true;
      EltTy = llvm37::Type::getInt8Ty(getLLVMContext());
    }
  ...
  case Type::FunctionProto: {
    ...
    if (!isFuncTypeConvertible(FT)) {
      ...
      ResultType = llvm37::StructType::get(getLLVMContext());
  ...
  case Type::ObjCInterface: {
    ...
    if (!T)
      T = llvm37::StructType::create(getLLVMContext());
    ResultType = T;
    break;
  }
  ...
  case Type::Enum: {
    ...
    // "right" answer.
    ResultType = llvm37::Type::getInt32Ty(getLLVMContext());
    break;
  }
  ...
  case Type::MemberPointer: {
    if (!getCXXABI().isMemberPointerConvertible(cast<MemberPointerType>(Ty)))
      return llvm37::StructType::create(getLLVMContext());
    ResultType = 
...
llvm37::StructType *CodeGenTypes::ConvertRecordDeclType(const RecordDecl *RD) {
  ...
  if (!Entry) {
    Entry = llvm37::StructType::create(getLLVMContext());
