//===--- CGCXX.cpp - Emit LLVM37 Code for declarations ----------------------===//
//
...
llvm37::Function *CodeGenModule::codegenCXXStructor(const CXXMethodDecl *MD,
  ...
  SetLLVM37FunctionAttributesForDefinition(MD, Fn);
  return Fn;
}
...
llvm37::GlobalValue *CodeGenModule::getAddrOfCXXStructor(
  ...
  return cast<llvm37::Function>(GetOrCreateLLVM37Function(Name, FnType, GD,
                                                      /*ForVTable=*/false,
                                                      DontDefer));
}
