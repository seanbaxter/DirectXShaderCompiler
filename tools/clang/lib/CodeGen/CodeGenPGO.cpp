...
void CodeGenPGO::createFuncNameVar(llvm37::GlobalValue::LinkageTypes Linkage) {
  ...
  auto *Value =
      llvm37::ConstantDataArray::getString(CGM.getLLVMContext(), FuncName, false);
  FuncNameVar =
...
void CodeGenPGO::emitCounterIncrement(CGBuilderTy &Builder, const Stmt *S) {
  ...
  auto *I8PtrTy = llvm37::Type::getInt8PtrTy(CGM.getLLVMContext());
...
llvm37::MDNode *CodeGenFunction::createProfileWeights(uint64_t TrueCount,
  ...
  llvm37::MDBuilder MDHelper(CGM.getLLVMContext());
