...
static FullSourceLoc ConvertBackendLocation(const llvm37::SMDiagnostic &D,
  ...
  // We need to copy the underlying LLVM memory buffer because llvm37::SourceMgr
...
llvm37::LLVMContext *CodeGenAction::takeLLVMContext() {
  OwnsVMContext = false;
  return VMContext;
}
...
GetOutputStream(CompilerInstance &CI, StringRef InFile, BackendAction Action) {
  ...
  case Backend_EmitPasses:
    return CI.createDefaultOutputFile(true, InFile, "passes.txt");
...
EmitAssemblyAction::EmitAssemblyAction(llvm37::LLVMContext *_VMContext)
  : CodeGenAction(Backend_EmitAssembly, _VMContext) {}

void EmitBCAction::anchor() { }
EmitBCAction::EmitBCAction(llvm37::LLVMContext *_VMContext)
  : CodeGenAction(Backend_EmitBC, _VMContext) {}

void EmitLLVMAction::anchor() { }
EmitLLVMAction::EmitLLVMAction(llvm37::LLVMContext *_VMContext)
  : CodeGenAction(Backend_EmitLL, _VMContext) {}

void EmitLLVMOnlyAction::anchor() { }
EmitLLVMOnlyAction::EmitLLVMOnlyAction(llvm37::LLVMContext *_VMContext)
  : CodeGenAction(Backend_EmitNothing, _VMContext) {}

void EmitCodeGenOnlyAction::anchor() { }
EmitCodeGenOnlyAction::EmitCodeGenOnlyAction(llvm37::LLVMContext *_VMContext)
  : CodeGenAction(Backend_EmitMCNull, _VMContext) {}

void EmitObjAction::anchor() { }
EmitObjAction::EmitObjAction(llvm37::LLVMContext *_VMContext)
  : CodeGenAction(Backend_EmitObj, _VMContext) {}

// HLSL Change Starts
void EmitOptDumpAction::anchor() { }
EmitOptDumpAction::EmitOptDumpAction(llvm37::LLVMContext *_VMContext)
