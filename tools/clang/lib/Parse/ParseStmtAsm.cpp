...
#if 0 // HLSL Change - disable this block to avoid having to build/link llvm37MC
namespace {
...
#endif // HLSL Change - disable this block to avoid having to build/link llvm37MC
...
#if 0 // HLSL Change Start - disable this block to avoid having to build/link llvm37MC
...
#endif // HLSL Change End - disable this block to avoid having to build/link llvm37MC
...
StmtResult Parser::ParseMicrosoftAsmStatement(SourceLocation AsmLoc) {
  assert(!getLangOpts().HLSL && "no MS assembly support in HLSL");    // HLSL Change
#if 1 // HLSL Change - disable this block to avoid having to build/link llvm37MC
  return StmtResult();
#else
