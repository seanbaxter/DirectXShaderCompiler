...
CFGImplicitDtor::getDestructorDecl(ASTContext &astContext) const {
  switch (getKind()) {
    ...
    case CFGElement::NewAllocator:
      llvm37_unreachable("getDestructorDecl should only be used with "
                       "ImplicitDtors");
  ...
  llvm37_unreachable("getKind() returned bogus value");
}
  ...
  void VisitBinaryOperator(BinaryOperator* B) {
    ...
    switch (B->getOpcode()) {
      ...
      case BO_LAnd:
        ...
        return;
      default:
        llvm37_unreachable("Invalid logical operator.");
    }
  }
...
static void print_block(raw_ostream &OS, const CFG* cfg,
  ...
  if (Stmt *Label = const_cast<Stmt*>(B.getLabel())) {
    ...
    if (LabelStmt *L = dyn_cast<LabelStmt>(Label))
      ...
      llvm37_unreachable("Invalid label statement in CFGBlock.");
