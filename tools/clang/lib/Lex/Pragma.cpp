...
struct PragmaDebugHandler : public PragmaHandler {
  ...
  void HandlePragma(Preprocessor &PP, PragmaIntroducerKind Introducer,
    ...
    if (II->isStr("assert")) {
      llvm37_unreachable("This is an assertion!");
    ...
    } else if (II->isStr("llvm37_fatal_error")) {
      llvm37::report_fatal_error("#pragma clang __debug llvm37_fatal_error");
    } else if (II->isStr("llvm37_unreachable")) {
      llvm37_unreachable("#pragma clang __debug llvm37_unreachable");
...
private:
  ...
  static const char* PragmaKind(PPCallbacks::PragmaMessageKind Kind,
    ...
    llvm37_unreachable("Unknown PragmaMessageKind!");
  }
...
void Preprocessor::RegisterBuiltinPragmas() {
  // HLSL Change Starts - pick only the pragma handlers we care about
  if (LangOpts.HLSL) {
