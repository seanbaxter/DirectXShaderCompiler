...
latex_documents = [
  ('index', 'dxc.tex', u'DirectX HLSL Compiler',
...
texinfo_documents = [
  ('index', 'DirectX HLSL Compiler', u'DirectX HLSL Compiler Documentation',
   u'Microsoft Corporation', 'DirectX HLSL Compiler', 'Compiler for HLSL language.',
   'Miscellaneous'),
]
