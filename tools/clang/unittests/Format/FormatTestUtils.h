...
#ifndef LLVM37_CLANG_UNITTESTS_FORMAT_FORMATTESTUTILS_H
#define LLVM37_CLANG_UNITTESTS_FORMAT_FORMATTESTUTILS_H
...
inline std::string messUp(llvm37::StringRef Code) {
