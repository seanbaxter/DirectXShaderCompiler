//===- FileCheckForTest.cpp - Check that File's Contents match what is expected --===//
///////////////////////////////////////////////////////////////////////////////
//                                                                           //
...
static size_t CheckTypeSize(Check::CheckType Ty) {
  ...
  case Check::CheckEOF:
    llvm37_unreachable("Should not be using EOF size");
  }

  llvm37_unreachable("Bad check type");
}
