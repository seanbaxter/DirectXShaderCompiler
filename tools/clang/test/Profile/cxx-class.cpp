...
// RUN: %clang %s -o - -emit-llvm37 -S -fprofile-instr-generate -fno-exceptions -target %itanium_abi_triple > %tgen
...
// RUN: llvm37-profdata merge %S/Inputs/cxx-class.proftext -o %t.profdata
// RUN: %clang %s -o - -emit-llvm37 -S -fprofile-instr-use=%t.profdata -fno-exceptions -target %itanium_abi_triple > %tuse
...
public:
  ...
  // CTRGEN: store {{.*}} @[[SCC:__llvm37_profile_counters__ZN6SimpleC2Ei]], i64 0, i64 0
  ...
  // DTRGEN: store {{.*}} @[[SDC:__llvm37_profile_counters__ZN6SimpleD2Ev]], i64 0, i64 0
  ~Simple() {
  ...
  // MTHGEN: store {{.*}} @[[SMC:__llvm37_profile_counters__ZN6Simple6methodEv]], i64 0, i64 0
  void method() {
...
// WRPGEN: store {{.*}} @[[SWC:__llvm37_profile_counters__Z14simple_wrapperv]], i64 0, i64 0
void simple_wrapper() {
