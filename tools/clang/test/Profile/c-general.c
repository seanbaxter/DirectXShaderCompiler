...
// RUN: %clang_cc1 -triple x86_64-apple-macosx10.9 -main-file-name c-general.c %s -o - -emit-llvm37 -fprofile-instr-generate | FileCheck -check-prefix=PGOGEN %s

// RUN: llvm37-profdata merge %S/Inputs/c-general.proftext -o %t.profdata
// RUN: %clang_cc1 -triple x86_64-apple-macosx10.9 -main-file-name c-general.c %s -o - -emit-llvm37 -fprofile-instr-use=%t.profdata | FileCheck -check-prefix=PGOUSE %s

// Also check compatibility with older profiles.
// RUN: %clang_cc1 -triple x86_64-apple-macosx10.9 -main-file-name c-general.c %s -o - -emit-llvm37 -fprofile-instr-use=%S/Inputs/c-general.profdata.v1 | FileCheck -check-prefix=PGOUSE %s

// PGOGEN: @[[SLC:__llvm37_profile_counters_simple_loops]] = private global [4 x i64] zeroinitializer
// PGOGEN: @[[IFC:__llvm37_profile_counters_conditionals]] = private global [11 x i64] zeroinitializer
// PGOGEN: @[[EEC:__llvm37_profile_counters_early_exits]] = private global [9 x i64] zeroinitializer
// PGOGEN: @[[JMC:__llvm37_profile_counters_jumps]] = private global [22 x i64] zeroinitializer
// PGOGEN: @[[SWC:__llvm37_profile_counters_switches]] = private global [19 x i64] zeroinitializer
// PGOGEN: @[[BSC:__llvm37_profile_counters_big_switch]] = private global [17 x i64] zeroinitializer
// PGOGEN: @[[BOC:__llvm37_profile_counters_boolean_operators]] = private global [8 x i64] zeroinitializer
// PGOGEN: @[[BLC:__llvm37_profile_counters_boolop_loops]] = private global [9 x i64] zeroinitializer
// PGOGEN: @[[COC:__llvm37_profile_counters_conditional_operator]] = private global [3 x i64] zeroinitializer
// PGOGEN: @[[DFC:__llvm37_profile_counters_do_fallthrough]] = private global [4 x i64] zeroinitializer
// PGOGEN: @[[MAC:__llvm37_profile_counters_main]] = private global [1 x i64] zeroinitializer
// PGOGEN: @[[STC:"__llvm37_profile_counters_c-general.c:static_func"]] = private global [2 x i64] zeroinitializer
