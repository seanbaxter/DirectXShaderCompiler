...
// CHECK: %[[x:.*]] = add i32
// CHECK: %[[y:.*]] = add i32
// CHECK-DAG: call void @llvm37.dbg.value(metadata i32 %[[x]], i64 0, metadata ![[vec:.*]], metadata ![[xexp:.*]]), !dbg
// CHECK-DAG: call void @llvm37.dbg.value(metadata i32 %[[y]], i64 0, metadata ![[vec]], metadata ![[yexp:.*]]), !dbg
