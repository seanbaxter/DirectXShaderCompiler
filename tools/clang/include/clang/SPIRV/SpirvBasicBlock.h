...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM37_CLANG_SPIRV_SPIRVBASICBLOCK_H
#define LLVM37_CLANG_SPIRV_SPIRVBASICBLOCK_H
...
class SpirvInstructionNode : public llvm37::ilist_node<SpirvInstructionNode> {
public:
...
public:
  SpirvBasicBlock(llvm37::StringRef name);
  ~SpirvBasicBlock();
  ...
  llvm37::StringRef getName() const { return labelName; }
  ...
  bool invokeVisitor(Visitor *, llvm37::ArrayRef<SpirvVariable *> vars,
  ...
  llvm37::ArrayRef<SpirvBasicBlock *> getSuccessors() const { return successors; }
...
private:
  ...
  llvm37::ilist<SpirvInstructionNode> instructions;

  /// Successors to this basic block.
  llvm37::SmallVector<SpirvBasicBlock *, 2> successors;
...
#endif // LLVM37_CLANG_SPIRV_SPIRVBASICBLOCK_H
