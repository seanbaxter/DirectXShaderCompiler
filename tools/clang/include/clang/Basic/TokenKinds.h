...
#ifndef LLVM37_CLANG_BASIC_TOKENKINDS_H
#define LLVM37_CLANG_BASIC_TOKENKINDS_H
...
const char *getTokenName(TokenKind Kind) LLVM37_READNONE;
...
const char *getPunctuatorSpelling(TokenKind Kind) LLVM37_READNONE;

/// \brief Determines the spelling of simple keyword and contextual keyword
/// tokens like 'int' and 'dynamic_cast'. Returns NULL for other token kinds.
const char *getKeywordSpelling(TokenKind Kind) LLVM37_READNONE;
