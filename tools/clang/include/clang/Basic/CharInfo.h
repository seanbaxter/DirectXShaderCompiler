...
#ifndef LLVM37_CLANG_BASIC_CHARINFO_H
#define LLVM37_CLANG_BASIC_CHARINFO_H
...
LLVM37_READNONE static inline bool isASCII(char c) {
  return static_cast<unsigned char>(c) <= 127;
}

/// Returns true if this is a valid first character of a C identifier,
/// which is [a-zA-Z_].
LLVM37_READONLY static inline bool isIdentifierHead(unsigned char c,
...
/// which is [a-zA-Z0-9_].
LLVM37_READONLY static inline bool isIdentifierBody(unsigned char c,
                                                  bool AllowDollar = false) {
  using namespace charinfo;
...
LLVM37_READONLY static inline bool isHorizontalWhitespace(unsigned char c) {
  using namespace charinfo;
...
///
/// Note that this returns false for '\\0'.
LLVM37_READONLY static inline bool isVerticalWhitespace(unsigned char c) {
  using namespace charinfo;
...
///
/// Note that this returns false for '\\0'.
LLVM37_READONLY static inline bool isWhitespace(unsigned char c) {
  using namespace charinfo;
  return (InfoTable[c] & (CHAR_HORZ_WS|CHAR_VERT_WS|CHAR_SPACE)) != 0;
}

/// Return true if this character is an ASCII digit: [0-9]
LLVM37_READONLY static inline bool isDigit(unsigned char c) {
  using namespace charinfo;
  return (InfoTable[c] & CHAR_DIGIT) != 0;
}

/// Return true if this character is a lowercase ASCII letter: [a-z]
LLVM37_READONLY static inline bool isLowercase(unsigned char c) {
  using namespace charinfo;
  return (InfoTable[c] & CHAR_LOWER) != 0;
}

/// Return true if this character is an uppercase ASCII letter: [A-Z]
LLVM37_READONLY static inline bool isUppercase(unsigned char c) {
  using namespace charinfo;
  return (InfoTable[c] & CHAR_UPPER) != 0;
}

/// Return true if this character is an ASCII letter: [a-zA-Z]
LLVM37_READONLY static inline bool isLetter(unsigned char c) {
  using namespace charinfo;
  return (InfoTable[c] & (CHAR_UPPER|CHAR_LOWER)) != 0;
}

/// Return true if this character is an ASCII letter or digit: [a-zA-Z0-9]
LLVM37_READONLY static inline bool isAlphanumeric(unsigned char c) {
  using namespace charinfo;
  return (InfoTable[c] & (CHAR_DIGIT|CHAR_UPPER|CHAR_LOWER)) != 0;
}

/// Return true if this character is an ASCII hex digit: [0-9a-fA-F]
LLVM37_READONLY static inline bool isHexDigit(unsigned char c) {
  using namespace charinfo;
...
LLVM37_READONLY static inline bool isPunctuation(unsigned char c) {
  using namespace charinfo;
...
/// terminal.
LLVM37_READONLY static inline bool isPrintable(unsigned char c) {
  using namespace charinfo;
...
/// which is [a-zA-Z0-9_.].
LLVM37_READONLY static inline bool isPreprocessingNumberBody(unsigned char c) {
  using namespace charinfo;
  return (InfoTable[c] &
...
LLVM37_READONLY static inline bool isRawStringDelimBody(unsigned char c) {
  using namespace charinfo;
...
LLVM37_READONLY static inline char toLowercase(char c) {
  if (isUppercase(c))
    return c + 'a' - 'A';
  return c;
}
...
LLVM37_READONLY static inline char toUppercase(char c) {
  if (isLowercase(c))
    return c + 'A' - 'a';
  return c;
}
...
LLVM37_READONLY static inline bool isValidIdentifier(StringRef S) {
