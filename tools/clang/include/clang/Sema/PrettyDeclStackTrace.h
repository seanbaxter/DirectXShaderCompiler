...
//===----------------------------------------------------------------------===//
//
// This file defines an llvm37::PrettyStackTraceEntry object for showing
// that a particular declaration was being processed when a crash
// occurred.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_CLANG_SEMA_PRETTYDECLSTACKTRACE_H
#define LLVM37_CLANG_SEMA_PRETTYDECLSTACKTRACE_H
...
class PrettyDeclStackTraceEntry : public llvm37::PrettyStackTraceEntry {
  Sema &S;
  Decl *TheDecl;
  SourceLocation Loc;
  const char *Message;
