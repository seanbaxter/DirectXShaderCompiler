...
public:
  ...
  /// native LLVM37 support.
  virtual bool HasNativeLLVM37Support() const;
  ...
  /// ComputeLLVM37Triple - Return the LLVM37 target triple to use, after taking
  /// command line arguments into account.
  virtual std::string
  ComputeLLVM37Triple(const llvm37::opt::ArgList &Args,
