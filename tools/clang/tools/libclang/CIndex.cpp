...
bool CursorVisitor::Visit(CXCursor Cursor, bool CheckedRegionOfInterest) {
  ...
  llvm37_unreachable("Invalid CXChildVisitResult!");
}
...
bool CursorVisitor::VisitTranslationUnitDecl(TranslationUnitDecl *D) {
  llvm37_unreachable("Translation units are visited directly by Visit()");
}
...
bool CursorVisitor::VisitTemplateName(TemplateName Name, SourceLocation Loc) {
  ...
  llvm37_unreachable("Invalid TemplateName::Kind!");
}
...
public:
  ...
  DeclarationNameInfo get() const {
    ...
    default:
      llvm37_unreachable("Unhandled Stmt");
...
CXString clang_getCursorKindSpelling(enum CXCursorKind Kind) {
  ...
  llvm37_unreachable("Unhandled CXCursorKind");
}
...
CXSourceLocation clang_getCursorLocation(CXCursor C) {
  if (clang_isReference(C.kind)) {
    ...
    default:
      ...
      llvm37_unreachable("Missed a reference kind");
    }
  }
...
CXCursor clang_getCursorReferenced(CXCursor C) {
  ...
  switch (C.kind) {
    ...
    default:
      ...
      llvm37_unreachable("Unhandled reference cursor kind");
  }
}
...
void clang_executeOnThread(void (*fn)(void*), void *user_data,
                           unsigned stack_size) {
  llvm37::llvm37_execute_on_thread(fn, user_data, stack_size);
}
...
static CXAvailabilityKind getCursorAvailabilityForDecl(const Decl *D) {
  ...
  llvm37_unreachable("Unknown availability kind!");
}
...
enum CX_StorageClass clang_Cursor_getStorageClass(CXCursor C) {
  ...
  llvm37_unreachable("Unhandled storage class!");
}
