//===- llvm37-link.cpp - Low-level LLVM37 linker ------------------------------===//
//
...
//  llvm37-link a.bc b.bc c.bc -o x.bc
//
//===----------------------------------------------------------------------===//
...
static cl::opt<bool>
OutputAssembly("S",
         cl::desc("Write output as LLVM37 assembly"), cl::Hidden);
...
static cl::opt<bool> PreserveAssemblyUseListOrder(
    ...
    cl::desc("Preserve use-list order when writing LLVM37 assembly."),
...
loadFile(const char *argv0, const std::string &FN, LLVM37Context &Context) {
  SMDiagnostic Err;
...
static void diagnosticHandler(const DiagnosticInfo &DI) {
  ...
  case DS_Remark:
  case DS_Note:
    llvm37_unreachable("Only expecting warnings and errors");
  }
...
static bool linkFiles(const char *argv0, LLVM37Context &Context, Linker &L,
...
int __cdecl main(int argc, char **argv) {
  ...
  cl::ParseCommandLineOptions(argc, argv, "llvm37 linker\n");

  auto Composite = make_unique<Module>("llvm37-link", Context);
