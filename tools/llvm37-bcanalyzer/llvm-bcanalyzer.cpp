//===-- llvm37-bcanalyzer.cpp - Bitcode Analyzer --------------------------===//
//
...
//  llvm37-bcanalyzer [options]      - Read LLVM37 bitcode from stdin
//  llvm37-bcanalyzer [options] x.bc - Read LLVM37 bitcode from the x.bc file
//
//  Options:
...
static const char *GetBlockName(unsigned BlockID,
  ...
  if (CurStreamType != LLVM37IRBitstream) return nullptr;
...
static bool openBitcodeFile(StringRef Path,
  ...
  if (Signature[0] == 'B' && Signature[1] == 'C' &&
    ...
    CurStreamType = LLVM37IRBitstream;
...
static int AnalyzeBitcode() {
  ...
  case LLVM37IRBitstream:  outs() << "LLVM37 IR\n"; break;
  }
...
int __cdecl main(int argc, char **argv) {
  ...
  cl::ParseCommandLineOptions(argc, argv, "llvm37-bcanalyzer file analyzer\n");
