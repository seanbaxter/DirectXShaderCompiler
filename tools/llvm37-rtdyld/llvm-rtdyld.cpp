//===-- llvm37-rtdyld.cpp - MCJIT Testing Tool ------------------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This is a testing tool for use with the MC-JIT LLVM37 components.
//
//===----------------------------------------------------------------------===//
...
int __cdecl main(int argc, char **argv) { // HLSL Change - __cdecl
  ...
  cl::ParseCommandLineOptions(argc, argv, "llvm37 MC-JIT tool\n");
