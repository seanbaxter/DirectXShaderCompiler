//===- CompilandDumper.h - llvm37-pdbdump compiland symbol dumper *- C++ --*-===//
//
...
#ifndef LLVM37_TOOLS_LLVM37PDBDUMP_COMPILANDDUMPER_H
#define LLVM37_TOOLS_LLVM37PDBDUMP_COMPILANDDUMPER_H
