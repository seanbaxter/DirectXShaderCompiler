...
///
/// \file
/// \brief This file implements the ELF-specific dumper for llvm37-readobj.
///
//===----------------------------------------------------------------------===//
...
#define LLVM37_READOBJ_ENUM_CASE(ns, enum) \
...
static const EnumEntry<unsigned> ElfMachineType[] = {
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_NONE         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_M32          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SPARC        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_386          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_68K          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_88K          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_IAMCU        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_860          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MIPS         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_S370         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MIPS_RS3_LE  ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_PARISC       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_VPP500       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SPARC32PLUS  ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_960          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_PPC          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_PPC64        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_S390         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SPU          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_V800         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_FR20         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_RH32         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_RCE          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ARM          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ALPHA        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SH           ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SPARCV9      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TRICORE      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ARC          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_H8_300       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_H8_300H      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_H8S          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_H8_500       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_IA_64        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MIPS_X       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_COLDFIRE     ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_68HC12       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MMA          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_PCP          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_NCPU         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_NDR1         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_STARCORE     ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ME16         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ST100        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TINYJ        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_X86_64       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_PDSP         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_PDP10        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_PDP11        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_FX66         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ST9PLUS      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ST7          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_68HC16       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_68HC11       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_68HC08       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_68HC05       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SVX          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ST19         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_VAX          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_CRIS         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_JAVELIN      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_FIREPATH     ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ZSP          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MMIX         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_HUANY        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_PRISM        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_AVR          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_FR30         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_D10V         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_D30V         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_V850         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_M32R         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MN10300      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MN10200      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_PJ           ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_OPENRISC     ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ARC_COMPACT  ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_XTENSA       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_VIDEOCORE    ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TMM_GPP      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_NS32K        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TPC          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SNP1K        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ST200        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_IP2K         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MAX          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_CR           ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_F2MC16       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MSP430       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_BLACKFIN     ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SE_C33       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SEP          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ARCA         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_UNICORE      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_EXCESS       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_DXP          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ALTERA_NIOS2 ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_CRX          ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_XGATE        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_C166         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_M16C         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_DSPIC30F     ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_CE           ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_M32C         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TSK3000      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_RS08         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SHARC        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ECOG2        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SCORE7       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_DSP24        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_VIDEOCORE3   ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_LATTICEMICO32),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SE_C17       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TI_C6000     ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TI_C2000     ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TI_C5500     ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MMDSP_PLUS   ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_CYPRESS_M8C  ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_R32C         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TRIMEDIA     ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_HEXAGON      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_8051         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_STXP7X       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_NDS32        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ECOG1        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ECOG1X       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MAXQ30       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_XIMO16       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MANIK        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_CRAYNV2      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_RX           ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_METAG        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_MCST_ELBRUS  ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ECOG16       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_CR16         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ETPU         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_SLE9X        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_L10M         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_K10M         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_AARCH64      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_AVR32        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_STM8         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TILE64       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TILEPRO      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_CUDA         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_TILEGX       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_CLOUDSHIELD  ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_COREA_1ST    ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_COREA_2ND    ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_ARC_COMPACT2 ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_OPEN8        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_RL78         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_VIDEOCORE5   ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_78KOR        ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_56800EX      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, EM_AMDGPU       )
};
...
static const char *getElfSectionType(unsigned Arch, unsigned Type) {
  ...
  case ELF::EM_ARM:
    switch (Type) {
    LLVM37_READOBJ_ENUM_CASE(ELF, SHT_ARM_EXIDX);
    LLVM37_READOBJ_ENUM_CASE(ELF, SHT_ARM_PREEMPTMAP);
    LLVM37_READOBJ_ENUM_CASE(ELF, SHT_ARM_ATTRIBUTES);
    LLVM37_READOBJ_ENUM_CASE(ELF, SHT_ARM_DEBUGOVERLAY);
    LLVM37_READOBJ_ENUM_CASE(ELF, SHT_ARM_OVERLAYSECTION);
    }
  case ELF::EM_HEXAGON:
    switch (Type) { LLVM37_READOBJ_ENUM_CASE(ELF, SHT_HEX_ORDERED); }
  case ELF::EM_X86_64:
    switch (Type) { LLVM37_READOBJ_ENUM_CASE(ELF, SHT_X86_64_UNWIND); }
  case ELF::EM_MIPS:
  case ELF::EM_MIPS_RS3_LE:
    switch (Type) {
    LLVM37_READOBJ_ENUM_CASE(ELF, SHT_MIPS_REGINFO);
    LLVM37_READOBJ_ENUM_CASE(ELF, SHT_MIPS_OPTIONS);
    LLVM37_READOBJ_ENUM_CASE(ELF, SHT_MIPS_ABIFLAGS);
    }
  }

  switch (Type) {
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_NULL              );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_PROGBITS          );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_SYMTAB            );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_STRTAB            );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_RELA              );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_HASH              );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_DYNAMIC           );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_NOTE              );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_NOBITS            );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_REL               );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_SHLIB             );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_DYNSYM            );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_INIT_ARRAY        );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_FINI_ARRAY        );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_PREINIT_ARRAY     );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_GROUP             );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_SYMTAB_SHNDX      );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_GNU_ATTRIBUTES    );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_GNU_HASH          );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_GNU_verdef        );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_GNU_verneed       );
  LLVM37_READOBJ_ENUM_CASE(ELF, SHT_GNU_versym        );
  default: return "";
  }
}

static const EnumEntry<unsigned> ElfSectionFlags[] = {
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_WRITE           ),
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_ALLOC           ),
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_EXCLUDE         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_EXECINSTR       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_MERGE           ),
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_STRINGS         ),
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_INFO_LINK       ),
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_LINK_ORDER      ),
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_OS_NONCONFORMING),
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_GROUP           ),
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_TLS             ),
  LLVM37_READOBJ_ENUM_ENT(ELF, XCORE_SHF_CP_SECTION),
  LLVM37_READOBJ_ENUM_ENT(ELF, XCORE_SHF_DP_SECTION),
  LLVM37_READOBJ_ENUM_ENT(ELF, SHF_MIPS_NOSTRIP    )
};
...
static const char *getElfSegmentType(unsigned Arch, unsigned Type) {
  ...
  case ELF::EM_ARM:
    switch (Type) {
    LLVM37_READOBJ_ENUM_CASE(ELF, PT_ARM_EXIDX);
    }
  case ELF::EM_MIPS:
  case ELF::EM_MIPS_RS3_LE:
    switch (Type) {
    LLVM37_READOBJ_ENUM_CASE(ELF, PT_MIPS_REGINFO);
    LLVM37_READOBJ_ENUM_CASE(ELF, PT_MIPS_RTPROC);
    LLVM37_READOBJ_ENUM_CASE(ELF, PT_MIPS_OPTIONS);
    LLVM37_READOBJ_ENUM_CASE(ELF, PT_MIPS_ABIFLAGS);
    }
  }

  switch (Type) {
  LLVM37_READOBJ_ENUM_CASE(ELF, PT_NULL   );
  LLVM37_READOBJ_ENUM_CASE(ELF, PT_LOAD   );
  LLVM37_READOBJ_ENUM_CASE(ELF, PT_DYNAMIC);
  LLVM37_READOBJ_ENUM_CASE(ELF, PT_INTERP );
  LLVM37_READOBJ_ENUM_CASE(ELF, PT_NOTE   );
  LLVM37_READOBJ_ENUM_CASE(ELF, PT_SHLIB  );
  LLVM37_READOBJ_ENUM_CASE(ELF, PT_PHDR   );
  LLVM37_READOBJ_ENUM_CASE(ELF, PT_TLS    );

  LLVM37_READOBJ_ENUM_CASE(ELF, PT_GNU_EH_FRAME);
  LLVM37_READOBJ_ENUM_CASE(ELF, PT_SUNW_UNWIND);

  LLVM37_READOBJ_ENUM_CASE(ELF, PT_GNU_STACK);
  LLVM37_READOBJ_ENUM_CASE(ELF, PT_GNU_RELRO);
  default: return "";
  }
}

static const EnumEntry<unsigned> ElfSegmentFlags[] = {
  LLVM37_READOBJ_ENUM_ENT(ELF, PF_X),
  LLVM37_READOBJ_ENUM_ENT(ELF, PF_W),
  LLVM37_READOBJ_ENUM_ENT(ELF, PF_R)
};

static const EnumEntry<unsigned> ElfHeaderMipsFlags[] = {
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_NOREORDER),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_PIC),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_CPIC),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ABI2),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_32BITMODE),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_FP64),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_NAN2008),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ABI_O32),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ABI_O64),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ABI_EABI32),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ABI_EABI64),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_3900),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_4010),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_4100),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_4650),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_4120),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_4111),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_SB1),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_OCTEON),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_XLR),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_OCTEON2),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_OCTEON3),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_5400),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_5900),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_5500),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_9000),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_LS2E),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_LS2F),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MACH_LS3A),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_MICROMIPS),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_ASE_M16),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_ASE_MDMX),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_1),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_2),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_3),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_4),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_5),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_32),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_64),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_32R2),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_64R2),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_32R6),
  LLVM37_READOBJ_ENUM_ENT(ELF, EF_MIPS_ARCH_64R6)
};
...
#define LLVM37_READOBJ_TYPE_CASE(name) \
  case DT_##name: return #name

static const char *getTypeString(uint64_t Type) {
  switch (Type) {
  LLVM37_READOBJ_TYPE_CASE(BIND_NOW);
  LLVM37_READOBJ_TYPE_CASE(DEBUG);
  LLVM37_READOBJ_TYPE_CASE(FINI);
  LLVM37_READOBJ_TYPE_CASE(FINI_ARRAY);
  LLVM37_READOBJ_TYPE_CASE(FINI_ARRAYSZ);
  LLVM37_READOBJ_TYPE_CASE(FLAGS);
  LLVM37_READOBJ_TYPE_CASE(FLAGS_1);
  LLVM37_READOBJ_TYPE_CASE(HASH);
  LLVM37_READOBJ_TYPE_CASE(INIT);
  LLVM37_READOBJ_TYPE_CASE(INIT_ARRAY);
  LLVM37_READOBJ_TYPE_CASE(INIT_ARRAYSZ);
  LLVM37_READOBJ_TYPE_CASE(PREINIT_ARRAY);
  LLVM37_READOBJ_TYPE_CASE(PREINIT_ARRAYSZ);
  LLVM37_READOBJ_TYPE_CASE(JMPREL);
  LLVM37_READOBJ_TYPE_CASE(NEEDED);
  LLVM37_READOBJ_TYPE_CASE(NULL);
  LLVM37_READOBJ_TYPE_CASE(PLTGOT);
  LLVM37_READOBJ_TYPE_CASE(PLTREL);
  LLVM37_READOBJ_TYPE_CASE(PLTRELSZ);
  LLVM37_READOBJ_TYPE_CASE(REL);
  LLVM37_READOBJ_TYPE_CASE(RELA);
  LLVM37_READOBJ_TYPE_CASE(RELENT);
  LLVM37_READOBJ_TYPE_CASE(RELSZ);
  LLVM37_READOBJ_TYPE_CASE(RELAENT);
  LLVM37_READOBJ_TYPE_CASE(RELASZ);
  LLVM37_READOBJ_TYPE_CASE(RPATH);
  LLVM37_READOBJ_TYPE_CASE(RUNPATH);
  LLVM37_READOBJ_TYPE_CASE(SONAME);
  LLVM37_READOBJ_TYPE_CASE(STRSZ);
  LLVM37_READOBJ_TYPE_CASE(STRTAB);
  LLVM37_READOBJ_TYPE_CASE(SYMBOLIC);
  LLVM37_READOBJ_TYPE_CASE(SYMENT);
  LLVM37_READOBJ_TYPE_CASE(SYMTAB);
  LLVM37_READOBJ_TYPE_CASE(TEXTREL);
  LLVM37_READOBJ_TYPE_CASE(VERNEED);
  LLVM37_READOBJ_TYPE_CASE(VERNEEDNUM);
  LLVM37_READOBJ_TYPE_CASE(VERSYM);
  LLVM37_READOBJ_TYPE_CASE(RELCOUNT);
  LLVM37_READOBJ_TYPE_CASE(GNU_HASH);
  LLVM37_READOBJ_TYPE_CASE(MIPS_RLD_VERSION);
  LLVM37_READOBJ_TYPE_CASE(MIPS_FLAGS);
  LLVM37_READOBJ_TYPE_CASE(MIPS_BASE_ADDRESS);
  LLVM37_READOBJ_TYPE_CASE(MIPS_LOCAL_GOTNO);
  LLVM37_READOBJ_TYPE_CASE(MIPS_SYMTABNO);
  LLVM37_READOBJ_TYPE_CASE(MIPS_UNREFEXTNO);
  LLVM37_READOBJ_TYPE_CASE(MIPS_GOTSYM);
  LLVM37_READOBJ_TYPE_CASE(MIPS_RLD_MAP);
  LLVM37_READOBJ_TYPE_CASE(MIPS_PLTGOT);
  LLVM37_READOBJ_TYPE_CASE(MIPS_OPTIONS);
  default: return "unknown";
  }
}

#undef LLVM37_READOBJ_TYPE_CASE

#define LLVM37_READOBJ_DT_FLAG_ENT(prefix, enum) \
  { #enum, prefix##_##enum }

static const EnumEntry<unsigned> ElfDynamicDTFlags[] = {
  LLVM37_READOBJ_DT_FLAG_ENT(DF, ORIGIN),
  LLVM37_READOBJ_DT_FLAG_ENT(DF, SYMBOLIC),
  LLVM37_READOBJ_DT_FLAG_ENT(DF, TEXTREL),
  LLVM37_READOBJ_DT_FLAG_ENT(DF, BIND_NOW),
  LLVM37_READOBJ_DT_FLAG_ENT(DF, STATIC_TLS)
};

static const EnumEntry<unsigned> ElfDynamicDTFlags1[] = {
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, NOW),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, GLOBAL),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, GROUP),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, NODELETE),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, LOADFLTR),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, INITFIRST),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, NOOPEN),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, ORIGIN),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, DIRECT),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, TRANS),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, INTERPOSE),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, NODEFLIB),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, NODUMP),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, CONFALT),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, ENDFILTEE),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, DISPRELDNE),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, NODIRECT),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, IGNMULDEF),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, NOKSYMS),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, NOHDR),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, EDITED),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, NORELOC),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, SYMINTPOSE),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, GLOBAUDIT),
  LLVM37_READOBJ_DT_FLAG_ENT(DF_1, SINGLETON)
};

static const EnumEntry<unsigned> ElfDynamicDTMipsFlags[] = {
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, NONE),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, QUICKSTART),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, NOTPOT),
  LLVM37_READOBJ_DT_FLAG_ENT(RHS, NO_LIBRARY_REPLACEMENT),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, NO_MOVE),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, SGI_ONLY),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, GUARANTEE_INIT),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, DELTA_C_PLUS_PLUS),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, GUARANTEE_START_INIT),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, PIXIE),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, DEFAULT_DELAY_LOAD),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, REQUICKSTART),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, REQUICKSTARTED),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, CORD),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, NO_UNRES_UNDEF),
  LLVM37_READOBJ_DT_FLAG_ENT(RHF, RLD_ORDER_SAFE)
};

#undef LLVM37_READOBJ_DT_FLAG_ENT
...
private:
  ...
  StreamWriter &W;
  llvm37::Optional<uint64_t> DtPltGot;
  llvm37::Optional<uint64_t> DtLocalGotNum;
  llvm37::Optional<uint64_t> DtGotSym;
  llvm37::Optional<uint64_t> DtMipsPltGot;
  llvm37::Optional<uint64_t> DtJmpRel;
