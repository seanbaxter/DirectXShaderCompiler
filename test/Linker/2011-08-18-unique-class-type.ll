; RUN: llvm37-link %s %p/2011-08-18-unique-class-type2.ll -S -o - | FileCheck %s
...
entry:
  ...
  call void @llvm37.dbg.declare(metadata %"class.N1::A"* %mya, metadata !9, metadata !DIExpression()), !dbg !13
  ret void, !dbg !14
}
