...
; RUN: llvm37-as < %p/2009-09-03-mdnode2.ll > %t2.bc
...
entry:
  ...
  call void @llvm37.dbg.func.start(metadata !0)
  store i32 0, i32* %retval
  call void @llvm37.dbg.stoppoint(i32 4, i32 5, metadata !1)
  call void @f()
  br label %return

return:                                           ; preds = %entry
  %0 = load i32, i32* %retval                          ; <i32> [#uses=1]
  call void @llvm37.dbg.stoppoint(i32 5, i32 1, metadata !1)
  call void @llvm37.dbg.region.end(metadata !0)
  ret i32 %0
}

declare void @llvm37.dbg.func.start(metadata) nounwind readnone

declare void @llvm37.dbg.stoppoint(i32, i32, metadata) nounwind readnone

declare void @llvm37.dbg.region.end(metadata) nounwind readnone
