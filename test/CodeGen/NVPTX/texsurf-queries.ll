...
declare i32 @llvm37.nvvm.txq.width(i64)
declare i32 @llvm37.nvvm.txq.height(i64)
declare i32 @llvm37.nvvm.suq.width(i64)
declare i32 @llvm37.nvvm.suq.height(i64)
...
; SM20: txq.width.b32
; SM30: txq.width.b32
  %width = tail call i32 @llvm37.nvvm.txq.width(i64 %texHandle)
  ret i32 %width
}
...
; SM20: txq.height.b32
; SM30: txq.height.b32
  %height = tail call i32 @llvm37.nvvm.txq.height(i64 %texHandle)
  ret i32 %height
}
...
; SM20: suq.width.b32
; SM30: suq.width.b32
  %width = tail call i32 @llvm37.nvvm.suq.width(i64 %surfHandle)
  ret i32 %width
}
...
; SM20: suq.height.b32
; SM30: suq.height.b32
  %height = tail call i32 @llvm37.nvvm.suq.height(i64 %surfHandle)
  ret i32 %height
}
