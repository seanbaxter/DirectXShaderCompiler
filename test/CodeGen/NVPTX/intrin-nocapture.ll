...
declare i32 addrspace(1)* @llvm37.nvvm.ptr.gen.to.global.p1i32.p0i32(i32*)

; CHECK: @bar
define void @bar() {
  %t1 = alloca i32
; CHECK: call i32 addrspace(1)* @llvm37.nvvm.ptr.gen.to.global.p1i32.p0i32(i32* nonnull %t1)
; CHECK-NEXT: store i32 10, i32* %t1
  %t2 = call i32 addrspace(1)* @llvm37.nvvm.ptr.gen.to.global.p1i32.p0i32(i32* %t1)
  store i32 10, i32* %t1
