...
declare { float, float, float, float } @llvm37.nvvm.tex.1d.v4f32.s32(i64, i64, i32)
...
; CHECK: tex.1d.v4.f32.s32 {%f[[RED:[0-9]+]], %f[[GREEN:[0-9]+]], %f[[BLUE:[0-9]+]], %f[[ALPHA:[0-9]+]]}, [foo_param_0, foo_param_1, {%r{{[0-9]+}}}]
  %val = tail call { float, float, float, float } @llvm37.nvvm.tex.1d.v4f32.s32(i64 %img, i64 %sampler, i32 %idx)
