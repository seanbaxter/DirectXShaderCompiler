...
declare float @llvm37.convert.from.fp16.f32(i16) nounwind readnone
declare double @llvm37.convert.from.fp16.f64(i16) nounwind readnone
declare i16 @llvm37.convert.to.fp16.f32(float) nounwind readnone
declare i16 @llvm37.convert.to.fp16.f64(double) nounwind readnone
...
define void @test_convert_fp16_to_fp32(float addrspace(1)* noalias %out, i16 addrspace(1)* noalias %in) nounwind {
  ...
  %cvt = call float @llvm37.convert.from.fp16.f32(i16 %val) nounwind readnone
...
define void @test_convert_fp16_to_fp64(double addrspace(1)* noalias %out, i16 addrspace(1)* noalias %in) nounwind {
  %val = load i16, i16 addrspace(1)* %in, align 2
  %cvt = call double @llvm37.convert.from.fp16.f64(i16 %val) nounwind readnone
...
define void @test_convert_fp32_to_fp16(i16 addrspace(1)* noalias %out, float addrspace(1)* noalias %in) nounwind {
  ...
  %cvt = call i16 @llvm37.convert.to.fp16.f32(float %val) nounwind readnone
...
define void @test_convert_fp64_to_fp16(i16 addrspace(1)* noalias %out, double addrspace(1)* noalias %in) nounwind {
  ...
  %cvt = call i16 @llvm37.convert.to.fp16.f64(double %val) nounwind readnone
  store i16 %cvt, i16 addrspace(1)* %out, align 4
  ret void
}
