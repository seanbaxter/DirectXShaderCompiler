...
_ZL11compute_vecRK6float3jb.exit:
  ...
  %0 = tail call i32 @llvm37.ptx.read.ctaid.x()
  %1 = tail call i32 @llvm37.ptx.read.ntid.x()
  %2 = mul nsw i32 %1, %0
  %3 = tail call i32 @llvm37.ptx.read.tid.x()
  %4 = add nsw i32 %2, %3
  %5 = zext i32 %4 to i64
  %6 = bitcast float* %ret_vec.sroa.8.i to i8*
  call void @llvm37.lifetime.start(i64 4, i8* %6)
  %7 = and i32 %4, 15
  %8 = icmp eq i32 %7, 0
...
; CHECK: setp.lt.f32     %p{{[0-9]+}}, %f{{[0-9]+}}, 0f00000000
  ...
  call void @llvm37.lifetime.end(i64 4, i8* %6)
...
declare i32 @llvm37.ptx.read.ctaid.x() #1

; Function Attrs: nounwind readnone
declare i32 @llvm37.ptx.read.ntid.x() #1

; Function Attrs: nounwind readnone
declare i32 @llvm37.ptx.read.tid.x() #1

; Function Attrs: nounwind
declare void @llvm37.lifetime.start(i64, i8* nocapture) #2

; Function Attrs: nounwind
declare void @llvm37.lifetime.end(i64, i8* nocapture) #2
