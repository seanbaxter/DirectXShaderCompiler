...
entry:
  ...
  call void @llvm37.dbg.value(metadata i32 %i, i64 0, metadata !3, metadata !{})
...
bb:                                               ; preds = %entry
  ...
  call void @llvm37.dbg.value(metadata i32 %1, i64 0, metadata !3, metadata !{}), !dbg !10
  br label %bb2, !dbg !10
...
!1 = !DICompileUnit(language: DW_LANG_C89, producer: "4.2.1 (Based on Apple Inc. build 5658) (LLVM37 build)", isOptimized: true, emissionKind: 0, file: !20, enums: !21, retainedTypes: !21)
