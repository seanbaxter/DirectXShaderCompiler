...
define void @test1(i8* %ptr) {
  call {}* @llvm37.invariant.start(i64 4, i8* %ptr)
  ret void
}
...
define void @ctor2() {
  ...
  %B = call {}* @llvm37.invariant.start(i64 4, i8* %A)
  %C = bitcast {}* %B to i8*
  ret void
}
...
define void @ctor3() {
  ...
  call {}* @llvm37.invariant.start(i64 3, i8* %A)
  ret void
}
...
define void @ctor4() {
  ...
  call {}* @llvm37.invariant.start(i64 -1, i8* %A)
  ret void
}
