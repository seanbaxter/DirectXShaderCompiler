...
entry:
  tail call void @llvm37.dbg.value(metadata i32 %argc, i64 0, metadata !13, metadata !DIExpression()), !dbg !27
  tail call void @llvm37.dbg.value(metadata i8** %argv, i64 0, metadata !14, metadata !DIExpression()), !dbg !27
...
if.end:                                           ; preds = %entry
  ...
  tail call void @llvm37.dbg.value(metadata i32 %call, i64 0, metadata !17, metadata !DIExpression()), !dbg !30
...
for.body:                                         ; preds = %if.end, %for.body
  ...
  tail call void @llvm37.dbg.value(metadata double %add4, i64 0, metadata !18, metadata !DIExpression()), !dbg !36
  ...
  tail call void @llvm37.dbg.value(metadata double %sub, i64 0, metadata !18, metadata !DIExpression()), !dbg !37
  %inc = add nsw i32 %u.016, 1, !dbg !38
  tail call void @llvm37.dbg.value(metadata i32 %inc, i64 0, metadata !21, metadata !DIExpression()), !dbg !38
...
declare void @llvm37.dbg.value(metadata, i64, metadata, metadata) #3
...
!llvm37.dbg.cu = !{!0}
!llvm37.module.flags = !{!25, !42}
!llvm37.ident = !{!26}

!0 = !DICompileUnit(language: DW_LANG_C_plus_plus, producer: "clang version 3.4 (trunk 192896) (llvm37/trunk 192895)", isOptimized: true, emissionKind: 0, file: !1, enums: !2, retainedTypes: !2, subprograms: !3, globals: !2, imports: !2)
...
!26 = !{!"clang version 3.4 (trunk 192896) (llvm37/trunk 192895)"}
