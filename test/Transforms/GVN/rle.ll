...
declare void @helper()
define void @crash1() {
  tail call void @llvm37.memcpy.p0i8.p0i8.i64(i8* undef, i8* undef, i64 undef, i32 1, i1 false) nounwind
...
entry:
  ...
  tail call void @llvm37.memset.p0i8.i64(i8* %conv, i8 1, i64 200, i32 1, i1 false)
...
entry:
  ...
  tail call void @llvm37.memset.p0i8.i64(i8* %conv, i8 %Val, i64 400, i32 1, i1 false)
...
define i16 @memset_to_i16_nonlocal0(i16* %P, i1 %cond) {
  ...
  br i1 %cond, label %T, label %F
T:
  tail call void @llvm37.memset.p0i8.i64(i8* %P3, i8 1, i64 400, i32 1, i1 false)
  br label %Cont
  
F:
  tail call void @llvm37.memset.p0i8.i64(i8* %P3, i8 2, i64 400, i32 1, i1 false)
  br label %Cont
...
entry:
  %conv = bitcast float* %A to i8*                ; <i8*> [#uses=1]
  tail call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %conv, i8* bitcast ({i32, float, i32 }* @GCst to i8*), i64 12, i32 1, i1 false)
...
entry:
  %conv = bitcast float* %A to i8*                ; <i8*> [#uses=1]
  tail call void @llvm37.memcpy.p0i8.p1i8.i64(i8* %conv, i8 addrspace(1)* bitcast ({i32, float, i32 } addrspace(1)* @GCst_as1 to i8 addrspace(1)*), i64 12, i32 1, i1 false)
  %arrayidx = getelementptr inbounds float, float* %A, i64 1 ; <float*> [#uses=1]
  %tmp2 = load float, float* %arrayidx                   ; <float> [#uses=1]
  ret float %tmp2
...
entry:
  ...
  call void @llvm37.memset.p0i8.i64(i8* %tmp, i8 0, i64 1024, i32 4, i1 false)
