...
; CHECK-NEXT: ret i32 60
  %1 = call i32 @llvm37.objectsize.i32.p0i8(i8* getelementptr inbounds ([60 x i8], [60 x i8]* @a, i32 0, i32 0), i1 false)
  ret i32 %1
}
...
entry:
  %retval = alloca i8*
  %0 = call i32 @llvm37.objectsize.i32.p0i8(i8* getelementptr inbounds ([60 x i8], [60 x i8]* @a, i32 0, i32 0), i1 false)
  %cmp = icmp ne i32 %0, -1
; CHECK: br i1 true
...
; CHECK-NEXT: ret i32 0
  %1 = call i32 @llvm37.objectsize.i32.p0i8(i8* getelementptr ([60 x i8], [60 x i8]* @a, i32 1, i32 0), i1 false)
  ret i32 %1
}
...
; CHECK-NEXT: objectsize
  %1 = tail call i32 @llvm37.objectsize.i32.p0i8(i8* getelementptr inbounds ([0 x i8], [0 x i8]* @window, i32 0, i32 0), i1 false)
  %2 = icmp eq i32 %1, -1
  ret i1 %2
}
...
entry:
  %0 = call i32 @llvm37.objectsize.i32.p0i8(i8* getelementptr inbounds ([0 x i8], [0 x i8]* @window, i32 0, i32 10), i1 false) ; <i64> [#uses=1]
...
; CHECK-NEXT: ret i32 34
  %1 = call i32 @llvm37.objectsize.i32.p0i8(i8* getelementptr (i8, i8* bitcast ([9 x i32]* @.str5 to i8*), i32 2), i1 false)
  ret i32 %1
}
...
declare i32 @llvm37.objectsize.i32.p0i8(i8*, i1) nounwind readonly
...
bb11:
  ...
  %2 = call i32 @llvm37.objectsize.i32.p0i8(i8* %1, i1 false) ; <i32> [#uses=1]
...
entry:
  ...
  %2 = call i32 @llvm37.objectsize.i32.p0i8(i8* %1, i1 false) nounwind
; CHECK-NOT: @llvm37.objectsize
; CHECK: @llvm37.memset.p0i8.i32(i8* %1, i8 0, i32 1824, i32 8, i1 false)
...
entry:
  ...
  %1 = tail call i32 @llvm37.objectsize.i32.p0i8(i8* %0, i1 false)
  %2 = load i8*, i8** @s, align 8
; CHECK-NOT: @llvm37.objectsize
; CHECK: @llvm37.memcpy.p0i8.p0i8.i32(i8* %0, i8* %1, i32 10, i32 1, i1 false)
...
; CHECK-LABEL: @test7(
  ...
  %objsize = call i32 @llvm37.objectsize.i32.p0i8(i8* %gep, i1 false) nounwind readonly
; CHECK: ret i32 32
  ret i32 %objsize
}
...
define i32 @test9(i8** %esc) {
  ...
  %1 = tail call i32 @llvm37.objectsize.i32.p0i8(i8* %call, i1 true)
; CHECK: ret i32 8
  ret i32 %1
}
...
define i32 @test18() {
  ...
  %1 = call i32 @llvm37.objectsize.i32.p0i8(i8* %bc, i1 false)
  ret i32 %1
}
