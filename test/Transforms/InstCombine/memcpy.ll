...
define void @test1(i8* %a) {
        tail call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %a, i8* %a, i32 100, i32 1, i1 false)
        ret void
...
define void @test2(i8* %a) {
        tail call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %a, i8* %a, i32 100, i32 1, i1 true)
        ret void
...
define void @test3(i8* %d, i8* %s) {
        tail call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %d, i8* %s, i64 17179869184, i32 4, i1 false)
        ret void
