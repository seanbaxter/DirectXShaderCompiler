...
; CHECK-NEXT: call void @llvm37.memcpy.p0i8.p0i8.i32(i8* getelementptr inbounds ([60 x i8], [60 x i8]* @a, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), i32 12, i32 1, i1 false)
...
; CHECK-NEXT: %len = call i32 @llvm37.objectsize.i32.p0i8(i8* getelementptr inbounds ([60 x i8], [60 x i8]* @a, i32 0, i32 0), i1 false)
...
; CHECK-NEXT: ret i8* %1
  %len = call i32 @llvm37.objectsize.i32.p0i8(i8* %dst, i1 false)
