...
declare <4 x double> @llvm37.ppc.qpx.qvlfs(i8*) #1

define <4 x double> @test1(<4 x float>* %h) #0 {
entry:
  %h1 = getelementptr <4 x float>, <4 x float>* %h, i64 1
  %hv = bitcast <4 x float>* %h1 to i8*
  %vl = call <4 x double> @llvm37.ppc.qpx.qvlfs(i8* %hv)

; CHECK-LABEL: @test1
; CHECK: @llvm37.ppc.qpx.qvlfs
...
; CHECK-LABEL: @test1a
; CHECK-NOT: @llvm37.ppc.qpx.qvlfs
...
declare void @llvm37.ppc.qpx.qvstfs(<4 x double>, i8*) #0

define <4 x float> @test2(<4 x float>* %h, <4 x double> %d) #0 {
entry:
  %h1 = getelementptr <4 x float>, <4 x float>* %h, i64 1
  %hv = bitcast <4 x float>* %h1 to i8*
  call void @llvm37.ppc.qpx.qvstfs(<4 x double> %d, i8* %hv)

  %v0 = load <4 x float>, <4 x float>* %h, align 8
  ret <4 x float> %v0

; CHECK-LABEL: @test2
; CHECK: @llvm37.ppc.qpx.qvstfs
; CHECK: ret <4 x float>
}
...
; CHECK-NOT: @llvm37.ppc.qpx.qvstfs
; CHECK-NOT: store <4 x double>
; CHECK: ret <4 x float>
}

declare <4 x double> @llvm37.ppc.qpx.qvlfd(i8*) #1

define <4 x double> @test1l(<4 x double>* %h) #0 {
entry:
  %h1 = getelementptr <4 x double>, <4 x double>* %h, i64 1
  %hv = bitcast <4 x double>* %h1 to i8*
  %vl = call <4 x double> @llvm37.ppc.qpx.qvlfd(i8* %hv)

; CHECK-LABEL: @test1l
; CHECK: @llvm37.ppc.qpx.qvlfd
; CHECK: ret <4 x double>
...
; CHECK-LABEL: @test1la
; CHECK-NOT: @llvm37.ppc.qpx.qvlfd
; CHECK: ret <4 x double>
...
declare void @llvm37.ppc.qpx.qvstfd(<4 x double>, i8*) #0

define <4 x double> @test2l(<4 x double>* %h, <4 x double> %d) #0 {
entry:
  %h1 = getelementptr <4 x double>, <4 x double>* %h, i64 1
  %hv = bitcast <4 x double>* %h1 to i8*
  call void @llvm37.ppc.qpx.qvstfd(<4 x double> %d, i8* %hv)

  %v0 = load <4 x double>, <4 x double>* %h, align 8
  ret <4 x double> %v0

; CHECK-LABEL: @test2l
; CHECK: @llvm37.ppc.qpx.qvstfd
; CHECK: ret <4 x double>
}
...
; CHECK-LABEL: @test2l
; CHECK-NOT: @llvm37.ppc.qpx.qvstfd
; CHECK: ret <4 x double>
}
