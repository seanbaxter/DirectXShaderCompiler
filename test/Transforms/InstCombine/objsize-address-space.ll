...
declare i32 @llvm37.objectsize.i32.p1i8(i8 addrspace(1)*, i1) nounwind readonly
declare i32 @llvm37.objectsize.i32.p2i8(i8 addrspace(2)*, i1) nounwind readonly
declare i32 @llvm37.objectsize.i32.p3i8(i8 addrspace(3)*, i1) nounwind readonly
declare i16 @llvm37.objectsize.i16.p3i8(i8 addrspace(3)*, i1) nounwind readonly
...
; CHECK-NEXT: ret i32 60
  %1 = call i32 @llvm37.objectsize.i32.p3i8(i8 addrspace(3)* getelementptr inbounds ([60 x i8], [60 x i8] addrspace(3)* @a_as3, i32 0, i32 0), i1 false)
  ret i32 %1
}
...
; CHECK-NEXT: ret i16 60
  %1 = call i16 @llvm37.objectsize.i16.p3i8(i8 addrspace(3)* getelementptr inbounds ([60 x i8], [60 x i8] addrspace(3)* @a_as3, i32 0, i32 0), i1 false)
  ret i16 %1
}

@a_alias = weak alias [60 x i8] addrspace(3)* @a_as3
define i32 @foo_alias() nounwind {
  %1 = call i32 @llvm37.objectsize.i32.p3i8(i8 addrspace(3)* getelementptr inbounds ([60 x i8], [60 x i8] addrspace(3)* @a_alias, i32 0, i32 0), i1 false)
  ret i32 %1
}
...
; CHECK-NEXT: ret i32 60
  ...
  %1 = call i32 @llvm37.objectsize.i32.p2i8(i8 addrspace(2)* %bc, i1 false)
  ret i32 %1
}
...
; CHECK-NEXT: ret i32 80
  ...
  %1 = call i32 @llvm37.objectsize.i32.p1i8(i8 addrspace(1)* %bc, i1 false)
  ret i32 %1
}
