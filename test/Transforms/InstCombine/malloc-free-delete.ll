...
declare i64 @llvm37.objectsize.i64(i8*, i1)
...
declare void @llvm37.memset.p0i8.i32(i8*, i8, i32, i32, i1) nounwind

define void @test3(i8* %src) {
; CHECK-LABEL: @test3(
; CHECK-NEXT: ret void
  %a = call noalias i8* @malloc(i32 10)
  call void @llvm37.lifetime.start(i64 10, i8* %a)
  call void @llvm37.lifetime.end(i64 10, i8* %a)
  %size = call i64 @llvm37.objectsize.i64(i8* %a, i1 true)
  store i8 42, i8* %a
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %a, i8* %src, i32 32, i32 1, i1 false)
  call void @llvm37.memmove.p0i8.p0i8.i32(i8* %a, i8* %src, i32 32, i32 1, i1 false)
  call void @llvm37.memset.p0i8.i32(i8* %a, i8 5, i32 32, i32 1, i1 false)
...
; CHECK-NEXT: call void @llvm37.memmove
; CHECK-NEXT: store
; CHECK-NEXT: call void @llvm37.memcpy
; CHECK-NEXT: call void @llvm37.memmove
...
; CHECK-NEXT: ret
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %ptr, i8* %a, i32 32, i32 1, i1 false)
  call void @llvm37.memmove.p0i8.p0i8.i32(i8* %ptr, i8* %b, i32 32, i32 1, i1 false)
  store i8* %c, i8** %esc
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %d, i8* %ptr, i32 32, i32 1, i1 true)
  call void @llvm37.memmove.p0i8.p0i8.i32(i8* %e, i8* %ptr, i32 32, i32 1, i1 true)
  call void @llvm37.memset.p0i8.i32(i8* %f, i8 5, i32 32, i32 1, i1 true)
