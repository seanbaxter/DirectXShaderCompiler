...
;; Test that llvm37.stackrestore is removed when possible.
define i32* @test1(i32 %P) {
	%tmp = call i8* @llvm37.stacksave( )
	call void @llvm37.stackrestore( i8* %tmp ) ;; not restoring anything
	%A = alloca i32, i32 %P		
	ret i32* %A
}

define void @test2(i8* %X) {
	call void @llvm37.stackrestore( i8* %X )  ;; no allocas before return.
	ret void
}
...
bb:		; preds = %bb, %bb.preheader
	...
	call void @llvm37.stackrestore( i8* %tmp78 )
	call void @llvm37.stackrestore( i8* %tmp53 )
	call void @llvm37.stackrestore( i8* %tmp28 )
	call void @llvm37.stackrestore( i8* %tmp )
