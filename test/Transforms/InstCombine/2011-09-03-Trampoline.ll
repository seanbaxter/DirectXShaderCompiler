...
declare i8* @llvm37.adjust.trampoline(i8*)
...
define i32 @test0(i32 %n) {
  ...
  call void @llvm37.init.trampoline(i8* %gep, i8* bitcast (i32 (i8*, i32)* @f to i8*),
                                  i8* null)
  %tramp = call i8* @llvm37.adjust.trampoline(i8* %gep)
...
define i32 @test1(i32 %n, i8* %trampmem) {
  call void @llvm37.init.trampoline(i8* %trampmem,
                                  i8* bitcast (i32 (i8*, i32)* @f to i8*),
                                  i8* null)
  %tramp = call i8* @llvm37.adjust.trampoline(i8* %trampmem)
  %function = bitcast i8* %tramp to i32(i32)*
  %ret = call i32 %function(i32 %n)
  ret i32 %ret
...
define i32 @test4(i32 %n) {
  ...
  %tramp0 = call i8* @llvm37.adjust.trampoline(i8* %gep)
  %function0 = bitcast i8* %tramp0 to i32(i32)*
  %ret0 = call i32 %function0(i32 %n)

  %tramp1 = call i8* @llvm37.adjust.trampoline(i8* %gep)
  %function1 = bitcast i8* %tramp0 to i32(i32)*
  %ret1 = call i32 %function1(i32 %n)

  %tramp2 = call i8* @llvm37.adjust.trampoline(i8* %gep)
