...
define void @test() nounwind ssp {
  %tmp1 = call %struct.__neon_int32x2x4_t @llvm37.arm.neon.vld4.v2i32(i8* bitcast ([8 x i32]* @x to i8*), i32 1)
  ...
  call void @llvm37.arm.neon.vst4.v2i32(i8* bitcast ([8 x i32]* @y to i8*), <2 x i32> %tmp2, <2 x i32> %tmp3, <2 x i32> %tmp4, <2 x i32> %tmp5, i32 1)
  ret void
}

declare %struct.__neon_int32x2x4_t @llvm37.arm.neon.vld4.v2i32(i8*, i32) nounwind readonly
declare void @llvm37.arm.neon.vst4.v2i32(i8*, <2 x i32>, <2 x i32>, <2 x i32>, <2 x i32>, i32) nounwind
