...
; llvm37.cttz, ValueTracking correctly intersects the range specified by the
...
; CHECK-LABEL: @add_cttz(
  ; llvm37.cttz.i16(..., /*is_zero_undefined=*/true) implies the value returned
  ...
  %cttz = call i16 @llvm37.cttz.i16(i16 %a, i1 true), !range !0
  %b = add i16 %cttz, -8
; CHECK: or i16 %cttz, -8
  ret i16 %b
}
...
; CHECK-LABEL: @add_cttz_2(
  ...
  %cttz = call i16 @llvm37.cttz.i16(i16 %a, i1 true), !range !1
  %b = add i16 %cttz, -16
