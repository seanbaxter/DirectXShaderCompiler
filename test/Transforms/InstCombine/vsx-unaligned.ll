...
declare <4 x i32> @llvm37.ppc.vsx.lxvw4x(i8*)
declare void @llvm37.ppc.vsx.stxvw4x(<4 x i32>, i8*)
declare <2 x double> @llvm37.ppc.vsx.lxvd2x(i8*)
declare void @llvm37.ppc.vsx.stxvd2x(<2 x double>, i8*)
