...
; CHECK-DAG: call void @llvm37.assume
; CHECK: ret i32
...
entry:
  %and1 = and i1 %a, %b
  %and  = and i1 %and1, %c
  tail call void @llvm37.assume(i1 %and)

; CHECK-LABEL: @can1
; CHECK: call void @llvm37.assume(i1 %a)
; CHECK: call void @llvm37.assume(i1 %b)
; CHECK: call void @llvm37.assume(i1 %c)
; CHECK: ret i32
...
entry:
  %v = or i1 %a, %b
  %w = xor i1 %v, 1
  tail call void @llvm37.assume(i1 %w)

; CHECK-LABEL: @can2
; CHECK: %[[V1:[^ ]+]] = xor i1 %a, true
; CHECK: call void @llvm37.assume(i1 %[[V1]])
; CHECK: %[[V2:[^ ]+]] = xor i1 %b, true
; CHECK: call void @llvm37.assume(i1 %[[V2]])
; CHECK: ret i32
...
; CHECK: ret i32 1
  ...
  tail call void @llvm37.assume(i1 %x)

  %and = and i32 %a, 7
  %cmp = icmp eq i32 %and, 1
  tail call void @llvm37.assume(i1 %cmp)

  tail call void @llvm37.assume(i1 %y)
...
; CHECK: ret i32 1
  ...
  tail call void @llvm37.assume(i1 %cmp2)
