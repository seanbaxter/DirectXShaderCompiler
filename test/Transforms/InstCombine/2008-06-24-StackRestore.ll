; RUN: opt < %s -instcombine -S | grep "call.*llvm37.stackrestore"
; PR2488
...
entry:
	%tmp248 = call i8* @llvm37.stacksave( )		; <i8*> [#uses=1]
...
bb44:		; preds = %bb44, %entry
	...
	call void @llvm37.stackrestore( i8* %tmp249 )
	%tmp2 = call i8* @llvm37.stacksave( )		; <i8*> [#uses=1]
...
declare i8* @llvm37.stacksave() nounwind 

declare void @llvm37.stackrestore(i8*) nounwind 
