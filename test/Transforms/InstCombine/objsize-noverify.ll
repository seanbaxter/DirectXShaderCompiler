...
xpto:
  ...
  %0 = tail call i32 @llvm37.objectsize.i32.p0i8(i8* %select, i1 true)
  %1 = tail call i32 @llvm37.objectsize.i32.p0i8(i8* %select2, i1 true)
  %2 = add i32 %0, %1
; CHECK: ret i32 undef
  ret i32 %2
...
xpto:
  ...
  %o = call i32 @llvm37.objectsize.i32.p0i8(i8* %gep, i1 true)
; CHECK: ret i32 undef
  ret i32 %o
