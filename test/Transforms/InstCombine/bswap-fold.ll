...
; CHECK-NEXT:  ret i1 %tmp
        %tmp10 = call i16 @llvm37.bswap.i16( i16 %tmp2 )
...
; CHECK-NEXT:  ret i1 %tmp.upgrd.1
        %tmp34 = tail call i32 @llvm37.bswap.i32( i32 %tmp )
...
; CHECK-NEXT:  ret i1 %tmp.upgrd.2
        %tmp34 = tail call i64 @llvm37.bswap.i64( i64 %tmp )
...
; CHECK-NEXT:  ret i32 %tmp2
	%tmp2 = tail call i32 @llvm37.bswap.i32( i32 %a )
...
; CHECK-NEXT:  ret i32 %a
	%tmp2 = tail call i32 @llvm37.bswap.i32( i32 %a )
	%tmp4 = tail call i32 @llvm37.bswap.i32( i32 %tmp2 )
	ret i32 %tmp4
}
...
; CHECK-NEXT   ret i16 %D
  %B = tail call i32 @llvm37.bswap.i32(i32 %A) nounwind
  %C = trunc i32 %B to i16
  %D = tail call i16 @llvm37.bswap.i16(i16 %C) nounwind
  ret i16 %D
}
...
; CHECK-NEXT   ret i16 %D
  %B = tail call i64 @llvm37.bswap.i64(i64 %A) nounwind 
...
; CHECK-NEXT: ret i64 undef
  %a = call i64 @llvm37.bswap.i64(i64 undef)
  ret i64 %a
}
...
; CHECK-NEXT:  %2 = call i16 @llvm37.bswap.i16(i16 %1)
; CHECK-NEXT:  ret i16 %2
  %1 = tail call i16 @llvm37.bswap.i16(i16 %a)
  %2 = and i16 %1, 10001
  ret i16 %2
}
...
; CHECK-NEXT:  %2 = call i16 @llvm37.bswap.i16(i16 %1)
; CHECK-NEXT:  ret i16 %2
  %tmp1 = tail call i16 @llvm37.bswap.i16(i16 %a)
  %tmp2 = tail call i16 @llvm37.bswap.i16(i16 %b)
...
; CHECK-NEXT:  %2 = call i32 @llvm37.bswap.i32(i32 %1)
; CHECK-NEXT:  ret i32 %2
  %tmp1 = tail call i32 @llvm37.bswap.i32(i32 %a)
...
; CHECK-NEXT:  ret i32 %2
  %tmp1 = tail call i32 @llvm37.bswap.i32(i32 %a)
  %tmp2 = tail call i32 @llvm37.bswap.i32(i32 %b)
...
; CHECK-NEXT:  %2 = call i64 @llvm37.bswap.i64(i64 %1)
; CHECK-NEXT:  ret i64 %2
  %tmp1 = tail call i64 @llvm37.bswap.i64(i64 %a)
...
; CHECK-NEXT:  ret i64 %2
  %tmp1 = tail call i64 @llvm37.bswap.i64(i64 %a)
  %tmp2 = tail call i64 @llvm37.bswap.i64(i64 %b)
...
declare i16 @llvm37.bswap.i16(i16)
declare i32 @llvm37.bswap.i32(i32)
