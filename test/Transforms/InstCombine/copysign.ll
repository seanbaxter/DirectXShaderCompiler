...
declare float @llvm37.copysign.f32(float, float) #0
declare double @llvm37.copysign.f64(double, double) #0

; CHECK-LABEL: @constant_fold_copysign_f32_01
; CHECK-NEXT: ret float -1.000000e+00
define float @constant_fold_copysign_f32_01() #0 {
  %x = call float @llvm37.copysign.f32(float 1.0, float -2.0) #0
  ret float %x
}
...
define float @constant_fold_copysign_f32_02() #0 {
  %x = call float @llvm37.copysign.f32(float -2.0, float 1.0) #0
  ret float %x
}
...
define double @constant_fold_copysign_f64_01() #0 {
  %x = call double @llvm37.copysign.f64(double 1.0, double -2.0) #0
  ret double %x
}
