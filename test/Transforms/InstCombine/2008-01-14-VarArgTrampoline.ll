...
declare void @llvm37.init.trampoline(i8*, i8*, i8*) nounwind 
declare i8* @llvm37.adjust.trampoline(i8*) nounwind
...
entry:
	...
	call void @llvm37.init.trampoline( i8* %TRAMP.216.sub, i8* bitcast (i32 (%struct.FRAME.nest*, ...)* @f to i8*), i8* %FRAME.06 )		; <i8*> [#uses=1]
        %tramp = call i8* @llvm37.adjust.trampoline( i8* %TRAMP.216.sub)
