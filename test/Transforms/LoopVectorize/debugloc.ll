...
entry:
  tail call void @llvm37.dbg.value(metadata i32* %a, i64 0, metadata !13, metadata !DIExpression()), !dbg !19
  tail call void @llvm37.dbg.value(metadata i32 %size, i64 0, metadata !14, metadata !DIExpression()), !dbg !19
  tail call void @llvm37.dbg.value(metadata i32 0, i64 0, metadata !15, metadata !DIExpression()), !dbg !20
  tail call void @llvm37.dbg.value(metadata i32 0, i64 0, metadata !16, metadata !DIExpression()), !dbg !21
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  tail call void @llvm37.dbg.value(metadata i32 %add.lcssa, i64 0, metadata !15, metadata !DIExpression()), !dbg !22
  %indvars.iv.next = add i64 %indvars.iv, 1, !dbg !21
  tail call void @llvm37.dbg.value(metadata !{null}, i64 0, metadata !16, metadata !DIExpression()), !dbg !21
...
!llvm37.dbg.cu = !{!0}
!llvm37.module.flags = !{!18, !27}

!0 = !DICompileUnit(language: DW_LANG_C99, producer: "clang version 3.4 (trunk 185038) (llvm37/trunk 185097)", isOptimized: true, emissionKind: 0, file: !1, enums: !2, retainedTypes: !2, subprograms: !3, globals: !2, imports: !2)
!1 = !DIFile(filename: "-", directory: "/Volumes/Data/backedup/dev/os/llvm37/debug")
!2 = !{}
!3 = !{!4}
...
!5 = !DIFile(filename: "<stdin>", directory: "/Volumes/Data/backedup/dev/os/llvm37/debug")
!6 = !DIFile(filename: "<stdin>", directory: "/Volumes/Data/backedup/dev/os/llvm37/debug")
