...
define i32 @test() #0 {
entry:
  tail call void @llvm37.dbg.value(metadata i32 0, i64 0, metadata !9, metadata !DIExpression()), !dbg !18
...
for.body:
  ...
  tail call void @llvm37.dbg.value(metadata !{null}, i64 0, metadata !9, metadata !DIExpression()), !dbg !18
