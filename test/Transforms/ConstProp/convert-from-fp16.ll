...
entry:
  %0 = call float @llvm37.convert.from.fp16.f32(i16 0)
  ret float %0
}
...
entry:
  %0 = call double @llvm37.convert.from.fp16.f64(i16 0)
  ret double %0
}
...
entry:
  %0 = call x86_fp80 @llvm37.convert.from.fp16.f80(i16 0)
  ret x86_fp80 %0
}
...
entry:
  %0 = call fp128 @llvm37.convert.from.fp16.f128(i16 0)
  ret fp128 %0
}
...
entry:
  %0 = call ppc_fp128 @llvm37.convert.from.fp16.ppcf128(i16 0)
  ret ppc_fp128 %0
}
...
entry:
  %0 = call i16 @llvm37.convert.to.fp16.f64(double 4.0)
  %1 = call float @llvm37.convert.from.fp16.f32(i16 %0)
  ret float %1
}
...
entry:
  %0 = call i16 @llvm37.convert.to.fp16.f64(double 4.0)
  %1 = call double @llvm37.convert.from.fp16.f64(i16 %0)
  ret double %1
}
...
entry:
  %0 = call i16 @llvm37.convert.to.fp16.f64(double 4.0)
  %1 = call x86_fp80 @llvm37.convert.from.fp16.f80(i16 %0)
  ret x86_fp80 %1
}
...
entry:
  %0 = call i16 @llvm37.convert.to.fp16.f64(double 4.0)
  %1 = call fp128 @llvm37.convert.from.fp16.f128(i16 %0)
  ret fp128 %1
}
...
entry:
  %0 = call i16 @llvm37.convert.to.fp16.f64(double 4.0)
  %1 = call ppc_fp128 @llvm37.convert.from.fp16.ppcf128(i16 %0)
  ret ppc_fp128 %1
}


declare i16 @llvm37.convert.to.fp16.f64(double)
declare float @llvm37.convert.from.fp16.f32(i16)
declare double @llvm37.convert.from.fp16.f64(i16)
declare x86_fp80 @llvm37.convert.from.fp16.f80(i16)
declare fp128 @llvm37.convert.from.fp16.f128(i16)
declare ppc_fp128 @llvm37.convert.from.fp16.ppcf128(i16)
