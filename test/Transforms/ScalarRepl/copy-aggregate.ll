...
; CHECK-NOT: i128
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %vari8, i8* %pi8, i32 16, i32 4, i1 false)
  %qi8 = bitcast [4 x %padded]* %q to i8*
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %qi8, i8* %vari8, i32 16, i32 4, i1 false)
  ret void
}
...
; CHECK: store <8 x i16>
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %tmp1, i8* %tmp2, i32 48, i32 16, i1 false)
  ret void
}
