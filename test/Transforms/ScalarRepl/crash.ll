...
cond_next:              ; preds = %cond_true
        ...
        call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %SB19, i8* null, i32 12, i32 0, i1 false)
...
entry:
        ...
        call void @llvm37.memset.p0i8.i64(i8* %tmp229, i8 0, i64 0, i32 2, i1 false)
        unreachable
}

declare void @llvm37.memset.i64(i8* nocapture, i8, i64, i32) nounwind
