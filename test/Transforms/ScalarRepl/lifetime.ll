...
; CHECK-LABEL: @test1(
  ...
  store i32 0, i32* %A1
  call void @llvm37.lifetime.start(i64 -1, i8* %B)
  ret void
; CHECK-NEXT: ret void
}
...
; CHECK-LABEL: @test3(
  ...
  %B = bitcast i32* %A2 to i8*
  store i32 0, i32* %A2
  call void @llvm37.lifetime.start(i64 6, i8* %B)
  %C = load i32, i32* %A2
  ret void
; CHECK-NEXT: ret void
}
...
; CHECK-NOT: store i8 1
  ...
  store i8 0, i8* %A2
  call void @llvm37.lifetime.start(i64 5, i8* %A2)
; CHECK: llvm37.lifetime{{.*}}i64 1
; CHECK: llvm37.lifetime{{.*}}i64 1
; CHECK: llvm37.lifetime{{.*}}i64 1
  %C = load i8, i8* %A2
  ret void
...
; CHECK-NOT: store i8 24
  ...
  call void @llvm37.lifetime.start(i64 7, i8* %B)
