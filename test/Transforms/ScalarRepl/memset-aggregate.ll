...
entry:
	...
	%tmp13 = bitcast %struct.foo* %P to i8*		; <i8*> [#uses=1]
        call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %L2, i8* %tmp13, i32 8, i32 4, i1 false)
...
entry:
	...
	%L12 = bitcast [4 x %struct.foo]* %L to i8*		; <i8*> [#uses=1]
        call void @llvm37.memset.p0i8.i32(i8* %L12, i8 0, i32 32, i32 16, i1 false)
...
entry:
	...
	call void @llvm37.memset.p0i8.i32(i8* %B1, i8 1, i32 24, i32 16, i1 false)
...
entry:
	...
	call void @llvm37.memset.p0i8.i32(i8* %2, i8 2, i32 12, i32 4, i1 false)
