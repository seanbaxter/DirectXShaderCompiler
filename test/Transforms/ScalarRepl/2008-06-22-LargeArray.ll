...
entry:
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %temp1, i8* %src, i32 200, i32 1, i1 false)
  %temp3 = bitcast [200 x i8]* %temp to i8*
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %dst, i8* %temp3, i32 200, i32 1, i1 false)
  ret void
}
