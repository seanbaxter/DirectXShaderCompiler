...
entry:
  ...
  call void @llvm37.memset.p0i8.i32(i8* %tmp, i8 0, i32 4, i32 4, i1 false)
  %tmp1 = bitcast %struct.anon* %x0 to i8*        ; <i8*> [#uses=1]
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* getelementptr inbounds (%0, %0* @c, i32
...
declare void @llvm37.memcpy.p0i8.p0i8.i32(i8* nocapture, i8* nocapture, i32, i32,
i1) nounwind
