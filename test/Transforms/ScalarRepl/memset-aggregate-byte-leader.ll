...
; RUN:   not grep "call void @llvm37.memcpy.p0i8.p0i8.i32"
...
entry:
	...
	call void @llvm37.memcpy.p0i8.p0i8.i32( i8* %L2, i8* %tmp13, i32 2, i32 1, i1 false)
	%tmp5 = load i8, i8* %L2		; <i8> [#uses=1]
	%tmp56 = sext i8 %tmp5 to i32		; <i32> [#uses=1]
	ret i32 %tmp56
}

declare void @llvm37.memcpy.p0i8.p0i8.i32(i8* nocapture, i8* nocapture, i32, i32, i1)
