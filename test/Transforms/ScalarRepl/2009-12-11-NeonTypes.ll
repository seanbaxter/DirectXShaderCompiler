...
entry:
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %19, i8* %20, i32 32, i32 16, i1 false)
  %tmp21 = bitcast %struct.int16x8x2_t* %tmp2 to i8*
  %21 = bitcast %struct.int16x8x2_t* %0 to i8*
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %tmp21, i8* %21, i32 32, i32 16, i1 false)
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %23, i8* %tmp22, i32 32, i32 16, i1 false)
  br label %return
...
cond.true:                                        ; preds = %entry
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %tmp3, i8* %tmp4, i32 8, i32 8, i1 false)
  ret void
