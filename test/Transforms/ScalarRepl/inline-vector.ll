...
entry:
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %tmp, i8* bitcast (%struct.Vector4* @f.vector to i8*), i32 16, i32 16, i1 false)
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %tmp2, i8* %tmp3, i32 16, i32 16, i1 false)
