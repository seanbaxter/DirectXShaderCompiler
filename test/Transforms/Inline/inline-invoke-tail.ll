; RUN: opt < %s -inline -S | not grep "tail call void @llvm37.memcpy.i32"
; PR3550

define internal void @foo(i32* %p, i32* %q) {
	%pp = bitcast i32* %p to i8*
	%qq = bitcast i32* %q to i8*
	tail call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %pp, i8* %qq, i32 4, i32 1, i1 false)
	ret void
}

declare void @llvm37.memcpy.i32(i8* nocapture, i8* nocapture, i32, i32) nounwind
