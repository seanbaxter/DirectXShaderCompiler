...
entry:
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %0, i8* %src, i64 %size, i32 1, i1 false)
  call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %dst, i8* %0, i64 %size, i32 1, i1 false)
  ret void
}
...
!0 = !{!"clang version 3.5.0 (trunk 205695) (llvm37/trunk 205706)"}
