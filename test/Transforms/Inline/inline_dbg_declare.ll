...
;; clang.exe -S -O0 -emit-llvm37 -g foo.c
;;
;; foo.c
;; ==========================
;; float foo(float x)
...
entry:
  ...
  call void @llvm37.dbg.declare(metadata float* %x.addr, metadata !16, metadata !17), !dbg !18
...
; CHECK: [[x_addr_i:%[a-zA-Z0-9.]+]] = alloca float, align 4
  ...
  call void @llvm37.dbg.declare(metadata float** %dst.addr, metadata !20, metadata !17), !dbg !21
...
; CHECK: void @llvm37.dbg.declare(metadata float* [[x_addr_i]], metadata [[m23:![0-9]+]], metadata !{{[0-9]+}}), !dbg [[m24:![0-9]+]]
