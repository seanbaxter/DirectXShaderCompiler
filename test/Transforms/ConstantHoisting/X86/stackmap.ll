...
; CHECK:        tail call void (i64, i32, ...) @llvm37.experimental.stackmap(i64 1, i32 24, i128 %const)
entry:
  %0 = add i128 %a, 134646182756734033220
  tail call void (i64, i32, ...) @llvm37.experimental.stackmap(i64 1, i32 24, i128 134646182756734033220)
  ret i128 %0
}
