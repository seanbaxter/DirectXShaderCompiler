...
define void @_ZNK5clang6driver7ArgList20AddAllArgsTranslatedERN4llvm3711SmallVectorIPKcLj16EEENS0_12OptSpecifierES5_b(i1 zeroext %Joined) nounwind align 2 {
entry:
...
if.then:                                          ; preds = %for.body
  br i1 undef, label %cond.false.i.i, label %_ZN4llvm379StringRefC1EPKc.exit

cond.false.i.i:                                   ; preds = %if.then
  unreachable

_ZN4llvm379StringRefC1EPKc.exit:                    ; preds = %if.then
  br i1 undef, label %_ZNK5clang6driver3Arg8getValueERKNS0_7ArgListEj.exit, label %cond.false.i.i91

cond.false.i.i91:                                 ; preds = %_ZN4llvm379StringRefC1EPKc.exit
  unreachable

_ZNK5clang6driver3Arg8getValueERKNS0_7ArgListEj.exit: ; preds = %_ZN4llvm379StringRefC1EPKc.exit
...
land.lhs.true16.i.i.i.i:                          ; preds = %if.end13.i.i.i.i
  br i1 undef, label %cond.false.i.i.i, label %_ZNK4llvm375Twine8isBinaryEv.exit8.i.i.i.i

_ZNK4llvm375Twine8isBinaryEv.exit8.i.i.i.i:         ; preds = %land.lhs.true16.i.i.i.i
  br i1 undef, label %cond.false.i.i.i, label %if.end19.i.i.i.i

if.end19.i.i.i.i:                                 ; preds = %_ZNK4llvm375Twine8isBinaryEv.exit8.i.i.i.i, %if.end13.i.i.i.i
  br i1 undef, label %land.lhs.true22.i.i.i.i, label %_ZN4llvm37plERKNS_9StringRefEPKc.exit

land.lhs.true22.i.i.i.i:                          ; preds = %if.end19.i.i.i.i
  br i1 undef, label %cond.false.i.i.i, label %_ZNK4llvm375Twine8isBinaryEv.exit.i.i.i.i

_ZNK4llvm375Twine8isBinaryEv.exit.i.i.i.i:          ; preds = %land.lhs.true22.i.i.i.i
  br i1 undef, label %cond.false.i.i.i, label %_ZN4llvm37plERKNS_9StringRefEPKc.exit

cond.false.i.i.i:                                 ; preds = %_ZNK4llvm375Twine8isBinaryEv.exit.i.i.i.i, %land.lhs.true22.i.i.i.i, %_ZNK4llvm375Twine8isBinaryEv.exit8.i.i.i.i, %land.lhs.true16.i.i.i.i, %_ZNK5clang6driver3Arg8getValueERKNS0_7ArgListEj.exit
  unreachable

_ZN4llvm37plERKNS_9StringRefEPKc.exit:              ; preds = %_ZNK4llvm375Twine8isBinaryEv.exit.i.i.i.i, %if.end19.i.i.i.i
  br i1 undef, label %Retry.i, label %if.end.i99

Retry.i:                                          ; preds = %if.end.i99, %_ZN4llvm37plERKNS_9StringRefEPKc.exit
  br i1 undef, label %_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit, label %new.notnull.i

new.notnull.i:                                    ; preds = %Retry.i
  br label %_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit

if.end.i99:                                       ; preds = %_ZN4llvm37plERKNS_9StringRefEPKc.exit
  br label %Retry.i

_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit: ; preds = %new.notnull.i, %Retry.i
...
Retry.i108:                                       ; preds = %if.end.i113, %if.else
  br i1 undef, label %_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit114, label %new.notnull.i110

new.notnull.i110:                                 ; preds = %Retry.i108
  br label %_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit114

if.end.i113:                                      ; preds = %if.else
  br label %Retry.i108

_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit114: ; preds = %new.notnull.i110, %Retry.i108
  br i1 undef, label %_ZNK5clang6driver3Arg8getValueERKNS0_7ArgListEj.exit125, label %cond.false.i.i123

cond.false.i.i123:                                ; preds = %_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit114
  unreachable

_ZNK5clang6driver3Arg8getValueERKNS0_7ArgListEj.exit125: ; preds = %_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit114
...
Retry.i134:                                       ; preds = %if.end.i139, %_ZNK5clang6driver3Arg8getValueERKNS0_7ArgListEj.exit125
  br i1 undef, label %_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit140, label %new.notnull.i136

new.notnull.i136:                                 ; preds = %Retry.i134
  br label %_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit140

if.end.i139:                                      ; preds = %_ZNK5clang6driver3Arg8getValueERKNS0_7ArgListEj.exit125
  br label %Retry.i134

_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit140: ; preds = %new.notnull.i136, %Retry.i134
  br label %for.cond.i.preheader

for.cond.i.preheader:                             ; preds = %_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit140, %_ZN4llvm3715SmallVectorImplIPKcE9push_backERKS2_.exit
