...
if.end:                                           ; preds = %entry
  tail call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %call4, i8* %name, i64 %call, i32 1, i1 false)
...
; CHECK: store i8 46
  ...
  tail call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %add.ptr5, i8* %domain, i64 %call1, i32 1, i1 false)
