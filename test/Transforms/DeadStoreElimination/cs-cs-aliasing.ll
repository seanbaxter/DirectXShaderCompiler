...
declare void @llvm37.memset.p0i8.i64(i8* nocapture, i8, i64, i32, i1) #0
...
; CHECK: store i8 0, i8* %tmp14, align 1
  ...
  call void @llvm37.memset.p0i8.i64(i8* %tmp11, i8 -51, i64 16, i32 8, i1 false) #0
  call void @llvm37.memset.p0i8.i64(i8* %tmp15, i8 -51, i64 32, i32 8, i1 false) #0
  call void @llvm37.memset.p0i8.i64(i8* %tmp4, i8 -51, i64 16, i32 8, i1 false) #0
  call void @llvm37.memset.p0i8.i64(i8* %tmp8, i8 -51, i64 32, i32 8, i1 false) #0
  ret i1 %tmp17
}
