...
define void @memcpy_fp80_padding() {
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %x_i8, i8* bitcast (%union.Foo* @foo_copy_source to i8*), i32 32, i32 16, i1 false)
...
define void @memset_fp80_padding() {
  ...
  ; Set to all ones.
  %x_i8 = bitcast %union.Foo* %x to i8*
  call void @llvm37.memset.p0i8.i32(i8* %x_i8, i8 -1, i32 32, i32 16, i1 false)
...
; CHECK: alloca x86_fp80
; CHECK: call void @llvm37.memset.p0i8.i32(i8* %{{.*}}, i8 -1, i32 16, i32 16, i1 false)
...
entry:
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %0, i8* %1, i32 12, i32 4, i1 false)
...
; CHECK-NOT: store <4 x float>
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %2, i8* %3, i32 12, i32 4, i1 false)
