...
define zeroext i8 @_Z3fooPN4llvm5ValueE(%"struct.llvm37::Value"* %V) ssp {
entry:
...
bb:                                               ; preds = %_ZN4llvm8dyn_castINS_11InstructionEPNS_5ValueEEENS_10cast_rettyIT_T0_E8ret_typeERKS6_.exit
  tail call void @_ZNK4llvm5Value4dumpEv(%"struct.llvm37::Value"* %V)
; CHECK: ret
  ret i8 1
...
declare void @_ZNK4llvm5Value4dumpEv(%"struct.llvm37::Value"*)
