...
declare void @llvm37.memcpy.p0i8.p0i8.i64(i8* nocapture, i8* nocapture readonly, i64, i32, i1) unnamed_addr nounwind
...
; CHECK-NOT: call void @llvm37.memcpy.p0i8.p0i8.i64
  %src = alloca [4096 x i8], align 1
  %p = getelementptr inbounds [4096 x i8], [4096 x i8]* %src, i64 0, i64 0
  call void @llvm37.memset.p0i8.i64(i8* %p, i8 0, i64 4096, i32 1, i1 false)
  call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %dst, i8* %p, i64 4096, i32 1, i1 false) #2
  ret void
}
