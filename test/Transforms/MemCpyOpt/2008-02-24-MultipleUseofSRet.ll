...
entry:
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %tmp1, i8* %memtmp2, i32 24, i32 8, i1 false)
  %z3 = bitcast %0* %z to i8*
  %tmp4 = bitcast %0* %tmp to i8*
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %z3, i8* %tmp4, i32 24, i32 8, i1 false)
