...
; CHECK: call void @llvm37.memcpy
  ...
  tail call void @llvm37.memmove.p0i8.p0i8.i64(i8* %call3.sub, i8* %src, i64 13, i32 1, i1 false)
  ret i8* %call3.sub
}
...
; CHECK: call void @llvm37.memcpy
  ...
  tail call void @llvm37.memmove.p0i8.p0i8.i64(i8* %P, i8* %add.ptr, i64 16, i32 1, i1 false)
  ret void
}
...
entry:
; CHECK-LABEL: @test3(
; CHECK: call void @llvm37.memmove
  %add.ptr = getelementptr i8, i8* %P, i64 16
  tail call void @llvm37.memmove.p0i8.p0i8.i64(i8* %P, i8* %add.ptr, i64 17, i32 1, i1 false)
  ret void
}
