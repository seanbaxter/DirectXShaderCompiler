...
define i32 @test1(%struct.foo* nocapture %foobie) nounwind noinline ssp uwtable {
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %2, i8* %3, i64 7, i32 1, i1 false)
...
define void @test2(i8* sret noalias nocapture %out, i8* %in) nounwind noinline ssp uwtable {
  call void @llvm37.lifetime.start(i64 8, i8* %in)
  call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %out, i8* %in, i64 8, i32 1, i1 false)
  ret void
...
define void @test3(i8* sret noalias nocapture %out, i8* %in) nounwind noinline ssp uwtable {
  call void @llvm37.lifetime.start(i64 4, i8* %in)
  call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %out, i8* %in, i64 8, i32 1, i1 false)
  ret void
