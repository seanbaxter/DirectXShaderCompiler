...
; CHECK-LABEL: @foo(
; CHECK: call void @llvm37.memset.p0i8.i64(i8* {{.*}}, i8 0, i64 16, i32 4, i1 false)
...
; CHECK-NOT: memcpy
  ...
  call void @llvm37.memset.p0i8.i64(i8* %a8.cast, i8 0, i64 4, i32 8, i1 false)
  call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %a4.cast, i8* %a8.cast, i64 4, i32 4, i1 false)
  ret void
}
