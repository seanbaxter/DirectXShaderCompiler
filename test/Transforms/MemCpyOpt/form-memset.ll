...
; CHECK-LABEL: @test1(
; CHECK-NOT: store
; CHECK: call void @llvm37.memset.p0i8.i64
; CHECK-NOT: store
; CHECK: ret
}
...
; CHECK-LABEL: @test2(
; CHECK-NOT: store
; CHECK: call void @llvm37.memset.p0i8.i64(i8* %tmp41, i8 -1, i64 8, i32 1, i1 false)
; CHECK-NOT: store
; CHECK: call void @llvm37.memset.p0i8.i64(i8* %0, i8 0, i64 32, i32 8, i1 false)
; CHECK-NOT: store
; CHECK: call void @llvm37.memset.p0i8.i64(i8* %1, i8 0, i64 32, i32 8, i1 false)
; CHECK-NOT: store
; CHECK: ret
}
...
entry:
  ...
  tail call void @llvm37.memset.p0i8.i64(i8* %0, i8 0, i64 11, i32 1, i1 false)
  ret void
; CHECK-LABEL: @test3(
; CHECK-NOT: store
; CHECK: call void @llvm37.memset.p0i8.i64(i8* %1, i8 0, i64 15, i32 4, i1 false)
}
...
entry:
  ...
  tail call void @llvm37.memset.p0i8.i64(i8* %0, i8 0, i64 12, i32 1, i1 false)
  %add.ptr = getelementptr inbounds i32, i32* %P, i64 3
  %1 = bitcast i32* %add.ptr to i8*
  tail call void @llvm37.memset.p0i8.i64(i8* %1, i8 0, i64 12, i32 1, i1 false)
  ret void
; CHECK-LABEL: @test6(
; CHECK: call void @llvm37.memset.p0i8.i64(i8* %2, i8 0, i64 24, i32 1, i1 false)
}
...
; CHECK-LABEL: @test7(
; CHECK: call void @llvm37.memset.p0i8.i64(i8* %5, i8 -1, i64 20, i32 4, i1 false)
  ret void
}
...
define void @test9() nounwind {
  ...
  ret void
; CHECK-LABEL: @test9(
; CHECK: call void @llvm37.memset.p0i8.i64(i8* bitcast ([16 x i64]* @test9buf to i8*), i8 -1, i64 16, i32 16, i1 false)
}

; PR19092
define void @test10(i8* nocapture %P) nounwind {
  tail call void @llvm37.memset.p0i8.i64(i8* %P, i8 0, i64 42, i32 1, i1 false)
  tail call void @llvm37.memset.p0i8.i64(i8* %P, i8 0, i64 23, i32 1, i1 false)
  ret void
; CHECK-LABEL: @test10(
; CHECK-NOT: memset
; CHECK: call void @llvm37.memset.p0i8.i64(i8* %P, i8 0, i64 42, i32 1, i1 false)
; CHECK-NOT: memset
; CHECK: ret void
}
...
entry:
  %add.ptr = getelementptr inbounds i32, i32* %P, i64 3
  %0 = bitcast i32* %add.ptr to i8*
  tail call void @llvm37.memset.p0i8.i64(i8* %0, i8 1, i64 11, i32 1, i1 false)
...
; CHECK-LABEL: @test11(
; CHECK-NOT: store
; CHECK: call void @llvm37.memset.p0i8.i64(i8* %1, i8 1, i64 23, i32 4, i1 false)
}
