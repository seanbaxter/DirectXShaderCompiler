...
;CHECK: load <2 x double>
;CHECK: call <2 x double> @llvm37.fabs.v2f64
...
entry:
  ...
  %call = tail call double @llvm37.fabs.f64(double %mul) nounwind readnone
  %arrayidx3 = getelementptr inbounds double, double* %a, i64 1
  %i3 = load double, double* %arrayidx3, align 8
  %arrayidx4 = getelementptr inbounds double, double* %b, i64 1
  %i4 = load double, double* %arrayidx4, align 8
  %mul5 = fmul double %i3, %i4
  %call5 = tail call double @llvm37.fabs.f64(double %mul5) nounwind readnone
...
;CHECK: load <4 x float>
;CHECK: call <4 x float> @llvm37.copysign.v4f32
...
entry:
  ...
  %call0 = tail call float @llvm37.copysign.f32(float %0, float %1) nounwind readnone
  ...
  %call1 = tail call float @llvm37.copysign.f32(float %2, float %3) nounwind readnone
  ...
  %call2 = tail call float @llvm37.copysign.f32(float %4, float %5) nounwind readnone
  ...
  %call3 = tail call float @llvm37.copysign.f32(float %6, float %7) nounwind readnone
...
declare i32 @llvm37.bswap.i32(i32) nounwind readnone
...
entry:
  ...
  %add1 = add i32 %i0, %i1
  %call1 = tail call i32 @llvm37.bswap.i32(i32 %add1) nounwind readnone
  ...
  %add2 = add i32 %i2, %i3
  %call2 = tail call i32 @llvm37.bswap.i32(i32 %add2) nounwind readnone
  ...
  %add3 = add i32 %i4, %i5
  %call3 = tail call i32 @llvm37.bswap.i32(i32 %add3) nounwind readnone
  ...
  %add4 = add i32 %i6, %i7
  %call4 = tail call i32 @llvm37.bswap.i32(i32 %add4) nounwind readnone
...
; CHECK: load <4 x i32>
; CHECK: load <4 x i32>
; CHECK: call <4 x i32> @llvm37.bswap.v4i32
; CHECK: store <4 x i32>
; CHECK: ret
}
...
entry:
  ...
  %i1 = load i32, i32* %b, align 4
  %add1 = add i32 %i0, %i1
  %call1 = tail call i32 @llvm37.ctlz.i32(i32 %add1,i1 true) nounwind readnone
  ...
  %i3 = load i32, i32* %arrayidx3, align 4
  %add2 = add i32 %i2, %i3
  %call2 = tail call i32 @llvm37.ctlz.i32(i32 %add2,i1 true) nounwind readnone
  ...
  %i5 = load i32, i32* %arrayidx5, align 4
  %add3 = add i32 %i4, %i5
  %call3 = tail call i32 @llvm37.ctlz.i32(i32 %add3,i1 true) nounwind readnone
  ...
  %i7 = load i32, i32* %arrayidx7, align 4
  %add4 = add i32 %i6, %i7
  %call4 = tail call i32 @llvm37.ctlz.i32(i32 %add4,i1 true) nounwind readnone
...
; CHECK: load <4 x i32>
; CHECK: load <4 x i32>
; CHECK: call <4 x i32> @llvm37.ctlz.v4i32
; CHECK: store <4 x i32>
; CHECK: ret
}
...
entry:
  ...
  %i3 = load i32, i32* %arrayidx3, align 4
  %add2 = add i32 %i2, %i3
  %call2 = tail call i32 @llvm37.ctlz.i32(i32 %add2,i1 false) nounwind readnone
  ...
  %i7 = load i32, i32* %arrayidx7, align 4
  %add4 = add i32 %i6, %i7
  %call4 = tail call i32 @llvm37.ctlz.i32(i32 %add4,i1 false) nounwind readnone
...
; CHECK-NOT: call <4 x i32> @llvm37.ctlz.v4i32
...
entry:
  ...
  %i1 = load i32, i32* %b, align 4
  %add1 = add i32 %i0, %i1
  %call1 = tail call i32 @llvm37.cttz.i32(i32 %add1,i1 true) nounwind readnone
  ...
  %i3 = load i32, i32* %arrayidx3, align 4
  %add2 = add i32 %i2, %i3
  %call2 = tail call i32 @llvm37.cttz.i32(i32 %add2,i1 true) nounwind readnone
  ...
  %i5 = load i32, i32* %arrayidx5, align 4
  %add3 = add i32 %i4, %i5
  %call3 = tail call i32 @llvm37.cttz.i32(i32 %add3,i1 true) nounwind readnone
  ...
  %i7 = load i32, i32* %arrayidx7, align 4
  %add4 = add i32 %i6, %i7
  %call4 = tail call i32 @llvm37.cttz.i32(i32 %add4,i1 true) nounwind readnone
...
; CHECK: load <4 x i32>
; CHECK: load <4 x i32>
; CHECK: call <4 x i32> @llvm37.cttz.v4i32
; CHECK: store <4 x i32>
; CHECK: ret
}
...
entry:
  ...
  %i3 = load i32, i32* %arrayidx3, align 4
  %add2 = add i32 %i2, %i3
  %call2 = tail call i32 @llvm37.cttz.i32(i32 %add2,i1 false) nounwind readnone
  ...
  %i7 = load i32, i32* %arrayidx7, align 4
  %add4 = add i32 %i6, %i7
  %call4 = tail call i32 @llvm37.cttz.i32(i32 %add4,i1 false) nounwind readnone
...
; CHECK-NOT: call <4 x i32> @llvm37.cttz.v4i32
}
...
entry:
  ...
  %call1 = tail call float @llvm37.powi.f32(float %add1,i32 %P) nounwind readnone
  ...
  %call2 = tail call float @llvm37.powi.f32(float %add2,i32 %P) nounwind readnone
  ...
  %call3 = tail call float @llvm37.powi.f32(float %add3,i32 %P) nounwind readnone
  ...
  %call4 = tail call float @llvm37.powi.f32(float %add4,i32 %P) nounwind readnone
...
; CHECK: load <4 x float>
; CHECK: load <4 x float>
; CHECK: call <4 x float> @llvm37.powi.v4f32
; CHECK: store <4 x float>
; CHECK: ret
}
...
entry:
  ...
  %i3 = load float, float* %arrayidx3, align 4
  %add2 = fadd float %i2, %i3
  %call2 = tail call float @llvm37.powi.f32(float %add2,i32 %Q) nounwind readnone
  ...
  %i7 = load float, float* %arrayidx7, align 4
  %add4 = fadd float %i6, %i7
  %call4 = tail call float @llvm37.powi.f32(float %add4,i32 %Q) nounwind readnone
...
; CHECK-NOT: call <4 x float> @llvm37.powi.v4f32
}
