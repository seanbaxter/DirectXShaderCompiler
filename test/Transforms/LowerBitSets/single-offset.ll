...
define i1 @foo(i8* %p) {
  ...
  %x = call i1 @llvm37.bitset.test(i8* %p, metadata !"bitset2")
  ; CHECK: ret i1 [[R1]]
  ret i1 %x
}
...
define i1 @bar(i8* %p) {
  ...
  %x = call i1 @llvm37.bitset.test(i8* %p, metadata !"bitset3")
  ; CHECK: ret i1 [[S1]]
  ret i1 %x
}
...
; CHECK: @x(
define i1 @x(i8* %p) {
  %x = call i1 @llvm37.bitset.test(i8* %p, metadata !"bitset1")
  ret i1 %x
}
