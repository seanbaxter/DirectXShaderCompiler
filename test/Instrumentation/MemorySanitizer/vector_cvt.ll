...
declare <2 x double> @llvm37.x86.sse2.cvtsi2sd(<2 x double>, i32) nounwind readnone
declare x86_mmx @llvm37.x86.sse.cvtps2pi(<4 x float>) nounwind readnone

; Single argument vector conversion.

define i32 @test_cvtsd2si(<2 x double> %value) sanitize_memory {
entry:
  %0 = tail call i32 @llvm37.x86.sse2.cvtsd2si(<2 x double> %value)
  ret i32 %0
}
...
; CHECK: call i32 @llvm37.x86.sse2.cvtsd2si
...
entry:
  ...
  %0 = tail call <2 x double> @llvm37.x86.sse2.cvtsi2sd(<2 x double> %vec, i32 %a)
  ret <2 x double> %0
}
...
; CHECK: br
; CHECK: call void @__msan_warning_noreturn
; CHECK: call <2 x double> @llvm37.x86.sse2.cvtsi2sd
...
entry:
  %0 = tail call x86_mmx @llvm37.x86.sse.cvtps2pi(<4 x float> %value)
  ret x86_mmx %0
}
...
; CHECK: br
; CHECK: call void @__msan_warning_noreturn
; CHECK: call x86_mmx @llvm37.x86.sse.cvtps2pi
