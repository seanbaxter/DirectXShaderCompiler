...
declare <4 x i32> @llvm37.x86.sse2.pmadd.wd(<8 x i16>, <8 x i16>) nounwind readnone
declare x86_mmx @llvm37.x86.ssse3.pmadd.ub.sw(x86_mmx, x86_mmx) nounwind readnone
declare <2 x i64> @llvm37.x86.sse2.psad.bw(<16 x i8>, <16 x i8>) nounwind readnone
declare x86_mmx @llvm37.x86.mmx.psad.bw(x86_mmx, x86_mmx) nounwind readnone

define <4 x i32> @Test_sse2_pmadd_wd(<8 x i16> %a, <8 x i16> %b) sanitize_memory {
entry:
  %c = tail call <4 x i32> @llvm37.x86.sse2.pmadd.wd(<8 x i16> %a, <8 x i16> %b) nounwind
  ret <4 x i32> %c
}
...
entry:
  %c = tail call x86_mmx @llvm37.x86.ssse3.pmadd.ub.sw(x86_mmx %a, x86_mmx %b) nounwind
  ret x86_mmx %c
}
...
define <2 x i64> @Test_x86_sse2_psad_bw(<16 x i8> %a, <16 x i8> %b) sanitize_memory {
  %c = tail call <2 x i64> @llvm37.x86.sse2.psad.bw(<16 x i8> %a, <16 x i8> %b)
  ret <2 x i64> %c
}
...
entry:
  %c = tail call x86_mmx @llvm37.x86.mmx.psad.bw(x86_mmx %a, x86_mmx %b) nounwind
  ret x86_mmx %c
}
