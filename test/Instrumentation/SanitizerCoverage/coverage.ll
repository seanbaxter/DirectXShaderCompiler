...
; CHECK0-NOT: @llvm37.global_ctors = {{.*}}{ i32 2, void ()* @sancov.module_ctor }
; CHECK1: @llvm37.global_ctors = {{.*}}{ i32 2, void ()* @sancov.module_ctor }
; CHECK2: @llvm37.global_ctors = {{.*}}{ i32 2, void ()* @sancov.module_ctor }
