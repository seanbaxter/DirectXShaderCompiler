...
; CHECK: @llvm37.global_ctors = {{.*}}@tsan.module_ctor
...
declare void @llvm37.memcpy.p0i8.p0i8.i64(i8* nocapture, i8* nocapture, i64, i32, i1)
declare void @llvm37.memmove.p0i8.p0i8.i64(i8* nocapture, i8* nocapture, i64, i32, i1)
...
entry:
    tail call void @llvm37.memcpy.p0i8.p0i8.i64(i8* %x, i8* %y, i64 16, i32 4, i1 false)
    ret void
...
entry:
    tail call void @llvm37.memmove.p0i8.p0i8.i64(i8* %x, i8* %y, i64 16, i32 4, i1 false)
    ret void
...
entry:
    tail call void @llvm37.memset.p0i8.i64(i8* %x, i8 77, i64 16, i32 4, i1 false)
    ret void
