...
; Checks that llvm37.dbg.declare instructions are updated 
...
entry:
  ...
  call void @llvm37.dbg.declare(metadata i32* %p.addr, metadata !10, metadata !DIExpression()), !dbg !11
  call void @llvm37.dbg.declare(metadata i32* %r, metadata !12, metadata !DIExpression()), !dbg !14
...
;   CHECK: entry:
; Verify that llvm37.dbg.declare calls are in the entry basic block.
;   CHECK-NOT: %entry
;   CHECK: call void @llvm37.dbg.declare(metadata {{.*}}, metadata ![[ARG_ID:[0-9]+]], metadata ![[OPDEREF:[0-9]+]])
;   CHECK-NOT: %entry
;   CHECK: call void @llvm37.dbg.declare(metadata {{.*}}, metadata ![[VAR_ID:[0-9]+]], metadata ![[OPDEREF:[0-9]+]])

declare void @llvm37.dbg.declare(metadata, metadata, metadata) nounwind readnone

!llvm37.dbg.cu = !{!0}
!llvm37.module.flags = !{!17}
...
!6 = !DIFile(filename: "a.cc", directory: "/usr/local/google/llvm37_cmake_clang/tmp/debuginfo")
...
!16 = !DIFile(filename: "a.cc", directory: "/usr/local/google/llvm37_cmake_clang/tmp/debuginfo")
