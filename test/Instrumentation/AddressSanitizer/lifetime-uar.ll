; Test handling of llvm37.lifetime intrinsics in UAR mode.
...
entry:
  ...
  call void @llvm37.lifetime.start(i64 1, i8* %c)
  ...
  call void @llvm37.lifetime.end(i64 1, i8* %c)
  ; Memory is poisoned at llvm37.lifetime.end
