; Test hanlding of llvm37.lifetime intrinsics.
...
entry:
  ...
  call void @llvm37.lifetime.start(i64 -1, i8* %i.ptr)
  store volatile i8 0, i8* %i.ptr
  call void @llvm37.lifetime.end(i64 -1, i8* %i.ptr)
...
define void @lifetime() sanitize_address {
  ...
  %i = alloca i32, align 4
  %i.ptr = bitcast i32* %i to i8*
  call void @llvm37.lifetime.start(i64 3, i8* %i.ptr)
  store volatile i8 0, i8* %i.ptr
  ; Memory is unpoisoned at llvm37.lifetime.start
  ; CHECK: %[[VAR:[^ ]*]] = ptrtoint i32* %{{[^ ]+}} to i64
  ; CHECK-NEXT: call void @__asan_unpoison_stack_memory(i64 %[[VAR]], i64 3)
  call void @llvm37.lifetime.end(i64 4, i8* %i.ptr)
  call void @llvm37.lifetime.end(i64 2, i8* %i.ptr)
  ; Memory is poisoned at every call to llvm37.lifetime.end
...
entry:
  ...
  call void @llvm37.lifetime.start(i64 8, i8* %i.ptr)
  store volatile i8 0, i8* %i.ptr
...
bb1:
  ...
  call void @llvm37.lifetime.end(i64 8, i8* %i.phi)
