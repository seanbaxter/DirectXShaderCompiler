; RUN: llvm37-as -disable-output < %s
...
declare {}* @llvm37.invariant.start(i64, i8* nocapture) readonly nounwind
declare void @llvm37.invariant.end({}*, i64, i8* nocapture) nounwind
...
entry:
  ...
  call void @llvm37.lifetime.start(i64 8, i8* %y)
  ...
  %inv = call {}* @llvm37.invariant.start(i64 8, i8* %y)
  call void @_Z3barRKi(i32* %0) nounwind
  %2 = load i32, i32* %0, align 8

  ;; Destructor is run here.
  call void @llvm37.invariant.end({}* %inv, i64 8, i8* %y)
  ;; Destructor is done here.
  call void @llvm37.lifetime.end(i64 8, i8* %y)
  ret i32 %2
}
