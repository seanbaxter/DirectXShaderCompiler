...
; Check that llvm37.x86.avx2.gather.d.ps.256 intrinsic is not eliminated as gather and store memory accesses are based on arr.ptr
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind readonly
declare <8 x float> @llvm37.x86.avx2.gather.d.ps.256(<8 x float>, i8*, <8 x i32>, <8 x float>, i8) #0
...
; CHECK: llvm37.x86.avx2.gather.d.ps.256
; CHECK: store
; CHECK-NOT: llvm37.x86.avx2.gather.d.ps.256
