...
define i32 @test0(i8* %P) {
  ...
  call void @llvm37.memset.p0i8.i32(i8* %P, i8 0, i32 42, i32 1, i1 false)
...
; CHECK-LABEL: @test1
  ...
  call void @llvm37.memcpy.p0i8.p0i8.i8(i8* %A, i8* %B, i8 -1, i32 0, i1 false)
...
; CHECK-LABEL: @test2
  ...
  call void @llvm37.memset.p0i8.i8(i8* %P, i8 2, i8 127, i32 0, i1 false)
  %A = load i8, i8* %P2
  ret i8 %A
; CHECK: ret i8 1
}
...
; CHECK: store i8 2, i8* %P2
  call void @llvm37.lifetime.end(i64 1, i8* %P)
  store i8 2, i8* %P2
; CHECK-NOT: store
  ret void
; CHECK: ret void
...
; CHECK-NEXT: call void @llvm37.lifetime.end
  call void @llvm37.lifetime.end(i64 10, i8* %P)
  ret void
; CHECK-NEXT: ret void
}
...
define i32 @test4(i8* %P) {
  %tmp = load i32, i32* @G1
  call void @llvm37.memset.p0i8.i32(i8* bitcast ([4000 x i32]* @G2 to i8*), i8 0, i32 4000, i32 1, i1 false)
...
define i32 @test5(i8* %P, i32 %Len) {
  %tmp = load i32, i32* @G1
  call void @llvm37.memcpy.p0i8.p0i8.i32(i8* bitcast ([4000 x i32]* @G2 to i8*), i8* bitcast (i32* @G1 to i8*), i32 %Len, i32 1, i1 false)
  %tmp2 = load i32, i32* @G1
  %sub = sub i32 %tmp2, %tmp
  ret i32 %sub
; CHECK: @test5
...
declare void @llvm37.memset.p0i8.i8(i8* nocapture, i8, i8, i32, i1) nounwind
declare void @llvm37.memcpy.p0i8.p0i8.i8(i8* nocapture, i8* nocapture, i8, i32, i1) nounwind
