...
entry:
    ...
    %tok = tail call i32 (i64, i32, i1 ()*, i32, i32, ...) @llvm37.experimental.gc.statepoint.p0f_i1f(i64 0, i32 0, i1 ()* @return_i1, i32 0, i32 0, i32 0, i32 0, i32 addrspace(1)* %dparam)
    %relocate = call i32 addrspace(1)* @llvm37.experimental.gc.relocate.p1i32(i32 %tok, i32 7, i32 7)
...
declare i32 addrspace(1)* @llvm37.experimental.gc.relocate.p1i32(i32, i32, i32)
