...
bb23:		; preds = %bb24, %bb.nph
	...
	tail call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %56, i8* %54, i32 %w, i32 1, i1 false)
...
bb26:		; preds = %bb24.bb26_crit_edge, %bb22
	...
	tail call void @llvm37.memset.p0i8.i32(i8* %60, i8 -128, i32 %62, i32 1, i1 false)
	ret void
...
bb30:		; preds = %bb31, %bb.nph11
	...
	tail call void @llvm37.memcpy.p0i8.p0i8.i32(i8* %69, i8* %67, i32 %w, i32 1, i1 false)
...
bb33:		; preds = %bb31.bb33_crit_edge, %bb29
	...
	tail call void @llvm37.memset.p0i8.i32(i8* %73, i8 -128, i32 %75, i32 1, i1 false)
	ret void
