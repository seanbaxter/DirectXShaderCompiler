...
; CHECK: Undefined behavior: Null pointer dereference
  call void @llvm37.stackrestore(i8* null)
; CHECK: Undefined behavior: Null pointer dereference
...
; CHECK: Write to read-only memory
  call void @llvm37.memcpy.p0i8.p0i8.i64(i8* bitcast (i32* @CG to i8*), i8* bitcast (i32* @CG to i8*), i64 1, i32 1, i1 0)
...
define void @not_vararg(i8* %p) nounwind {
  call void @llvm37.va_start(i8* %p)
  ret void
}
