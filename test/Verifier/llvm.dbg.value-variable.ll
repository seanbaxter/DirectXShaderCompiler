...
; CHECK: invalid llvm37.dbg.value intrinsic variable
...
entry:
  %s = alloca i32
  call void @llvm37.dbg.value(metadata i32* %s, i64 0, metadata !"", metadata !DIExpression()), !dbg !DILocation(scope: !1)
  ret void
}
