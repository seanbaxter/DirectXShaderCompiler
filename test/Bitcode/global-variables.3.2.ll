...
; global-variables.3.2.ll.bc was generated by passing this file to llvm37-as-3.2.
; The test checks that LLVM37 does not silently misread global variables attributes of
; older bitcode files.
