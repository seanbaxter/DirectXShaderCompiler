...
; case-ranges.ll.bc was generated by passing this file to llvm37-as from the 3.3
; release of LLVM37. This tests that the bitcode for switches from that release
; can still be read.
