...
; CHECK: entry:
entry:
; CHECK-NEXT: call void @llvm37.bar(metadata i32 %v)
  call void @llvm37.bar(metadata !{i32 %v})

; Note: these supposedly legal instructions fired an assertion in llvm37-as:
;
...
; So, I didn't test them; it looks like bitcode compatability is irrelevant.
  ; call void @llvm37.bar(metadata !{i32 0, i32 %v})
  ; call void @llvm37.bar(metadata !{i32 %v, i32 0})
  ; call void @llvm37.bar(metadata !{metadata !{}, i32 %v})
  ; call void @llvm37.bar(metadata !{i32 %v, metadata !{}})

; CHECK-NEXT: call void @llvm37.bar(metadata !0)
; CHECK-NEXT: call void @llvm37.bar(metadata !0)
  call void @llvm37.bar(metadata !{i32 %v, i32 %v})
  call void @llvm37.bar(metadata !{metadata !{i32 %v}})
