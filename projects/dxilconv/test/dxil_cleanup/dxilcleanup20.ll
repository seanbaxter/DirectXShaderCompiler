...
entry:
  ...
  %2 = call half @dx.op.tempRegLoad.f16(i32 0, i32 0)
  call void @dx.op.tempRegStore.f16(i32 1, i32 1, half %2)
  %3 = call i16 @dx.op.tempRegLoad.i16(i32 0, i32 1)
  call void @dx.op.storeOutput.i16(i32 5, i32 0, i32 0, i8 0, i16 %3)
  ret void
}
