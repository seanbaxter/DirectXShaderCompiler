...
//===----------------------------------------------------------------------===//
//
// The transformation requires the following LLVM37 passes:
// -simplifycfg -loop-simplify -reg2mem_hlsl to be run on each function.
// This is to rely on LLVM37 standard loop analysis info and to be able to clone 
