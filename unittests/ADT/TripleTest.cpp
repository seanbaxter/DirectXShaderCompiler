...
TEST(TripleTest, getARMCPUForArch) {
  ...
  {
    llvm37::Triple Triple("armv4-unknown-eabi");
    EXPECT_STREQ("strongarm", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv4t-unknown-eabi");
    EXPECT_STREQ("arm7tdmi", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv5-unknown-eabi");
    EXPECT_STREQ("arm10tdmi", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv5t-unknown-eabi");
    EXPECT_STREQ("arm10tdmi", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv5e-unknown-eabi");
    EXPECT_STREQ("arm1022e", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv5tej-unknown-eabi");
    EXPECT_STREQ("arm926ej-s", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv6-unknown-eabi");
    EXPECT_STREQ("arm1136jf-s", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv6j-unknown-eabi");
    EXPECT_STREQ("arm1136j-s", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv6k-unknown-eabi");
    EXPECT_STREQ("arm1176jzf-s", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv6zk-unknown-eabi");
    EXPECT_STREQ("arm1176jzf-s", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv6t2-unknown-eabi");
    EXPECT_STREQ("arm1156t2-s", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv6m-unknown-eabi");
    EXPECT_STREQ("cortex-m0", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv7-unknown-eabi");
    EXPECT_STREQ("cortex-a8", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv7a-unknown-eabi");
    EXPECT_STREQ("cortex-a8", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv7m-unknown-eabi");
    EXPECT_STREQ("cortex-m3", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv7r-unknown-eabi");
  ...
  {
    llvm37::Triple Triple("arm--nacl");
    EXPECT_STREQ("cortex-a8", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv6-unknown-freebsd");
    EXPECT_STREQ("arm1176jzf-s", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("thumbv6-unknown-freebsd");
    EXPECT_STREQ("arm1176jzf-s", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armebv6-unknown-freebsd");
    EXPECT_STREQ("arm1176jzf-s", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("arm--win32");
    EXPECT_STREQ("cortex-a9", Triple.getARMCPUForArch());
  }
  // Some alternative architectures
  {
    llvm37::Triple Triple("xscale-unknown-eabi");
    EXPECT_STREQ("xscale", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("iwmmxt-unknown-eabi");
    EXPECT_STREQ("iwmmxt", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv7s-apple-ios7");
    EXPECT_STREQ("swift", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv7em-apple-ios7");
    EXPECT_STREQ("cortex-m4", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv7l-linux-gnueabihf");
    EXPECT_STREQ("cortex-a8", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv6sm-apple-ios7");
    EXPECT_STREQ("cortex-m0", Triple.getARMCPUForArch());
  }
  // armeb is permitted, but armebeb is not
  {
    llvm37::Triple Triple("armeb-none-eabi");
    EXPECT_STREQ("arm7tdmi", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armebeb-none-eabi");
    EXPECT_EQ(nullptr, Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armebv6eb-none-eabi");
    EXPECT_EQ(nullptr, Triple.getARMCPUForArch());
  }
  // armebv6 and armv6eb are permitted, but armebv6eb is not
  {
    llvm37::Triple Triple("armebv6-non-eabi");
    EXPECT_STREQ("arm1136jf-s", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armv6eb-none-eabi");
    EXPECT_STREQ("arm1136jf-s", Triple.getARMCPUForArch());
  }
  // xscaleeb is permitted, but armebxscale is not
  {
    llvm37::Triple Triple("xscaleeb-none-eabi");
    EXPECT_STREQ("xscale", Triple.getARMCPUForArch());
  }
  {
    llvm37::Triple Triple("armebxscale-none-eabi");
    EXPECT_EQ(nullptr, Triple.getARMCPUForArch());
  }
}
