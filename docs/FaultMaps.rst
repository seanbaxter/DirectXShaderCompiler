...
Information about implicit checks generated by LLVM37 are put in a
...
This transform happens at the ``MachineInstr`` level, not the LLVM37 IR
...
``__llvm37_faultmaps`` section described above as needed.
