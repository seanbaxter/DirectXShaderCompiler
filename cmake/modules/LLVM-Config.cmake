...
function(llvm_map_components_to_libnames out_libs)
  ...
  foreach(c ${link_components})
    ...
    elseif( c STREQUAL "nativecodegen" )
      list(APPEND expanded_components "LLVM${LLVM37_NATIVE_ARCH}CodeGen")
      if( TARGET LLVM${LLVM37_NATIVE_ARCH}Desc )
        list(APPEND expanded_components "LLVM${LLVM37_NATIVE_ARCH}Desc")
      endif()
      if( TARGET LLVM${LLVM37_NATIVE_ARCH}Info )
        list(APPEND expanded_components "LLVM${LLVM37_NATIVE_ARCH}Info")
      endif()
