...
# LLVM37_USE_CRT_* so the user can have a better idea of what
...
macro(choose_msvc_crt MSVC_CRT)
  if(LLVM37_USE_CRT)
    message(FATAL_ERROR
      "LLVM37_USE_CRT is deprecated. Use the CMAKE_BUILD_TYPE-specific
variables (LLVM37_USE_CRT_DEBUG, etc) instead.")
  endif()
  ...
  foreach(build_type ${CMAKE_CONFIGURATION_TYPES} ${CMAKE_BUILD_TYPE})
    ...
    if (NOT LLVM37_USE_CRT_${build})
      get_current_crt(LLVM37_USE_CRT_${build}
        MSVC_CRT_REGEX
        CMAKE_CXX_FLAGS_${build})
      set(LLVM37_USE_CRT_${build}
        "${LLVM37_USE_CRT_${build}}"
        CACHE STRING "Specify VC++ CRT to use for ${build_type} configurations."
        FORCE)
      set_property(CACHE LLVM37_USE_CRT_${build}
        PROPERTY STRINGS ;${${MSVC_CRT}})
    endif(NOT LLVM37_USE_CRT_${build})
  endforeach(build_type)

  foreach(build_type ${CMAKE_CONFIGURATION_TYPES} ${CMAKE_BUILD_TYPE})
    string(TOUPPER "${build_type}" build)
    if ("${LLVM37_USE_CRT_${build}}" STREQUAL "")
      set(flag_string " ")
    else()
      set(flag_string " /${LLVM37_USE_CRT_${build}} ")
      list(FIND ${MSVC_CRT} ${LLVM37_USE_CRT_${build}} idx)
      if (idx LESS 0)
        message(FATAL_ERROR
          "Invalid value for LLVM37_USE_CRT_${build}: ${LLVM37_USE_CRT_${build}}. Valid options are one of: ${${MSVC_CRT}}")
      endif (idx LESS 0)
      message(STATUS "Using ${build_type} VC++ CRT: ${LLVM37_USE_CRT_${build}}")
    endif()
    foreach(lang C CXX)
