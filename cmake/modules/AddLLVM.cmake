...
function(llvm_add_library name)
  ...
  if(ARG_MODULE OR ARG_SHARED)
    ...
    if (LLVM37_EXPORTED_SYMBOL_FILE)
      add_llvm_symbol_exports( ${name} ${LLVM37_EXPORTED_SYMBOL_FILE} )
    endif()
  endif()
...
macro(add_llvm_executable name)
  ...
  set_output_directory(${name} ${LLVM37_RUNTIME_OUTPUT_INTDIR} ${LLVM37_LIBRARY_OUTPUT_INTDIR})
  llvm_config( ${name} ${LLVM37_LINK_COMPONENTS} )
  if( LLVM37_COMMON_DEPENDS )
    add_dependencies( ${name} ${LLVM37_COMMON_DEPENDS} )
...
macro(add_llvm_target target_name)
  ...
  set( CURRENT_LLVM37_TARGET LLVM${target_name} )
...
macro(add_llvm_external_project name)
  ...
  list(APPEND LLVM37_IMPLICIT_PROJECT_IGNORE "${CMAKE_CURRENT_SOURCE_DIR}/${add_llvm_external_dir}")
  ...
  if("${LLVM37_EXTERNAL_${nameUPPER}_SOURCE_DIR}" STREQUAL "${CMAKE_CURRENT_SOURCE_DIR}/${add_llvm_external_dir}")
    unset(LLVM37_EXTERNAL_${nameUPPER}_SOURCE_DIR CACHE)
  endif()
  if(NOT LLVM37_EXTERNAL_${nameUPPER}_SOURCE_DIR)
    set(LLVM37_EXTERNAL_${nameUPPER}_SOURCE_DIR "${CMAKE_CURRENT_SOURCE_DIR}/${add_llvm_external_dir}")
  else()
  ...
  if (EXISTS ${LLVM37_EXTERNAL_${nameUPPER}_SOURCE_DIR}/CMakeLists.txt)
    ...
    if (LLVM37_EXTERNAL_${nameUPPER}_BUILD)
      add_subdirectory(${LLVM37_EXTERNAL_${nameUPPER}_SOURCE_DIR} ${add_llvm_external_dir})
    endif()
  endif()
...
function(llvm_add_go_executable binary pkgpath)
  ...
  if(LLVM37_BINDINGS MATCHES "go")
    ...
    get_property(llvmlibs GLOBAL PROPERTY LLVM37_LIBS)
