...
#ifndef LLVM37_IR_LEGACYPASSMANAGER_H
#define LLVM37_IR_LEGACYPASSMANAGER_H
...
DEFINE_STDCXX_CONVERSION_FUNCTIONS(legacy::PassManagerBase, LLVM37PassManagerRef)
