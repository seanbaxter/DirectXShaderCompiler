...
#ifndef LLVM37_IR_GVMATERIALIZER_H
#define LLVM37_IR_GVMATERIALIZER_H
...
public:
  ...
  virtual std::error_code materializeSelectNamedMetadata(llvm37::ArrayRef<llvm37::StringRef>) = 0; // HLSL Change
