...
// information entries in LLVM37 IR form.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_IR_DIBUILDER_H
#define LLVM37_IR_DIBUILDER_H

#include "llvm37/ADT/ArrayRef.h"
#include "llvm37/ADT/StringRef.h"
#include "llvm37/IR/DebugInfo.h"
#include "llvm37/IR/TrackingMDRef.h"
...
namespace llvm37 {
  ...
  class DIBuilder {
    Module &M;
    LLVM37Context &VMContext;

    DICompileUnit *CUNode;   ///< The one compile unit created by this DIBuiler.
    Function *DeclareFn;     ///< llvm37.dbg.declare
    Function *ValueFn;       ///< llvm37.dbg.value
  ...
  public:
    ...
    /// \param Val         llvm37::Value of the variable.
    ...
    DIGlobalVariable *createTempGlobalVariableFwdDecl(
        ...
        unsigned LineNo, DIType *Ty, bool isLocalToUnit, llvm37::Constant *Val,
        MDNode *Decl = nullptr);
    ...
    /// \param Fn            llvm37::Function pointer.
    ...
    /// Insert a new llvm37.dbg.declare intrinsic call.
    /// \param Storage     llvm37::Value of the variable
    /// \param VarInfo     Variable's debug info descriptor.
    /// \param Expr        A complex location expression.
    /// \param DL          Debug info location.
    /// \param InsertAtEnd Location for the new intrinsic.
    Instruction *insertDeclare(llvm37::Value *Storage, DILocalVariable *VarInfo,
    ...
    /// Insert a new llvm37.dbg.value intrinsic call.
    /// \param Val          llvm37::Value of the variable
    /// \param Offset       Offset
    /// \param VarInfo      Variable's debug info descriptor.
    /// \param Expr         A complex location expression.
    /// \param DL           Debug info location.
    /// \param InsertAtEnd Location for the new intrinsic.
    Instruction *insertDbgValueIntrinsic(llvm37::Value *Val, uint64_t Offset,
