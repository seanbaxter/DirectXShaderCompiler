//===-- llvm37/DerivedTypes.h - Classes for handling data types ---*- C++ -*-===//
//
...
#ifndef LLVM37_IR_DERIVEDTYPES_H
#define LLVM37_IR_DERIVEDTYPES_H
...
protected:
  explicit IntegerType(LLVM37Context &C, unsigned NumBits) : Type(C, IntegerTyID){
...
public:
  ...
  static IntegerType *get(LLVM37Context &C, unsigned NumBits);
...
protected:
  explicit CompositeType(LLVM37Context &C, TypeID tid) : Type(C, tid) { }
public:
...
/// uniqued.  The names for identified structs are managed at the LLVM37Context
/// level, so there can only be a single identified struct with a given name in
/// a particular LLVM37Context.  Identified structs may also optionally be opaque
...
class StructType : public CompositeType {
  ...
  /// pointer to the symbol table entry (maintained by LLVM37Context) for the
...
public:
  ...
  static StructType *create(LLVM37Context &Context, StringRef Name);
  static StructType *create(LLVM37Context &Context);
  ...
  static StructType *create(LLVM37Context &Context,
                            ...
                            StringRef Name,
                            bool isPacked = false);
  static StructType *create(LLVM37Context &Context, ArrayRef<Type*> Elements);
  static StructType *create(StringRef Name, Type *elt1, ...) LLVM37_END_WITH_NULL;

  /// StructType::get - This static method is the primary way to create a
  /// literal StructType.
  static StructType *get(LLVM37Context &Context, ArrayRef<Type*> Elements,
                         bool isPacked = false);

  /// StructType::get - Create an empty structure type.
  ///
  static StructType *get(LLVM37Context &Context, bool isPacked = false);
  
  /// StructType::get - This static method is a convenience method for creating
  /// structure types by specifying the elements as arguments.  Note that this
  /// method always returns a non-packed struct, and requires at least one
  /// element type.
  static StructType *get(Type *elt1, ...) LLVM37_END_WITH_NULL;
  ...
  void setBody(Type *elt1, ...) LLVM37_END_WITH_NULL;
