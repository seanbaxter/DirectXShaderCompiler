//===-- llvm37/Constants.h - Constant class subclass definitions --*- C++ -*-===//
//
...
/// which represent the different flavors of constant values that live in LLVM37.
...
#ifndef LLVM37_IR_CONSTANTS_H
#define LLVM37_IR_CONSTANTS_H
...
public:
  static ConstantInt *getTrue(LLVM37Context &Context);
  static ConstantInt *getFalse(LLVM37Context &Context);
  ...
  static ConstantInt *get(LLVM37Context &Context, const APInt &V);
...
public:
  ...
  static ConstantFP *get(LLVM37Context &Context, const APFloat &V);
...
public:
  ...
  static Constant *get(StructType *T, ...) LLVM37_END_WITH_NULL;
  ...
  static Constant *getAnon(LLVM37Context &Ctx,
  ...
  static StructType *getTypeForElements(LLVM37Context &Ctx,
                                        ArrayRef<Constant*> V,
                                        bool Packed = false);
...
public:
  ...
  static Constant *get(LLVM37Context &Context, ArrayRef<uint8_t> Elts);
  static Constant *get(LLVM37Context &Context, ArrayRef<uint16_t> Elts);
  static Constant *get(LLVM37Context &Context, ArrayRef<uint32_t> Elts);
  static Constant *get(LLVM37Context &Context, ArrayRef<uint64_t> Elts);
  static Constant *get(LLVM37Context &Context, ArrayRef<float> Elts);
  static Constant *get(LLVM37Context &Context, ArrayRef<double> Elts);
  ...
  /// object.
  static Constant *getFP(LLVM37Context &Context, ArrayRef<uint16_t> Elts);
  static Constant *getFP(LLVM37Context &Context, ArrayRef<uint32_t> Elts);
  static Constant *getFP(LLVM37Context &Context, ArrayRef<uint64_t> Elts);
  ...
  static Constant *getString(LLVM37Context &Context, StringRef Initializer,
                             bool AddNull = true);
