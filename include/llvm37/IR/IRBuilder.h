//===---- llvm37/IRBuilder.h - Builder for LLVM37 Instructions ------*- C++ -*-===//
//
...
#ifndef LLVM37_IR_IRBUILDER_H
#define LLVM37_IR_IRBUILDER_H

#include "llvm37/ADT/ArrayRef.h"
#include "llvm37/ADT/StringRef.h"
#include "llvm37/ADT/Twine.h"
#include "llvm37/IR/BasicBlock.h"
#include "llvm37/IR/ConstantFolder.h"
...
public:
  ...
  IRBuilderBase(LLVM37Context &context, MDNode *FPMathTag = nullptr)
  ...
  public:
    ...
    llvm37::BasicBlock::iterator getPoint() const { return Point; }
  };
...
///
/// Note that the builder does not expose the full generality of LLVM37
...
public:
  ...
  IRBuilder(LLVM37Context &C, const T &F, const Inserter &I = Inserter(),
            MDNode *FPMathTag = nullptr)
    : IRBuilderBase(C, FPMathTag), Inserter(I), Folder(F) {
  }

  explicit IRBuilder(LLVM37Context &C, MDNode *FPMathTag = nullptr)
...
private:
  ...
  InstTy *addBranchWeights(InstTy *I, MDNode *Weights) {
    if (Weights)
      I->setMetadata(LLVM37Context::MD_prof, Weights);
    return I;
  }
...
private:
  ...
  Instruction *AddFPMathAttributes(Instruction *I,
    ...
    if (FPMathTag)
      I->setMetadata(LLVM37Context::MD_fpmath, FPMathTag);
...
public:
  ...
  Value *CreateBinOp(Instruction::BinaryOps Opc,
    ...
    llvm37::Instruction *BinOp = BinaryOperator::Create(Opc, LHS, RHS);
...
public:
  ...
  CallInst *CreateCall(llvm37::FunctionType *FTy, Value *Callee,
