//===-- llvm37/GlobalValue.h - Class to represent a global value --*- C++ -*-===//
//
...
#ifndef LLVM37_IR_GLOBALVALUE_H
#define LLVM37_IR_GLOBALVALUE_H
...
public:
  ...
  /// If special LLVM37 prefix that is used to inform the asm printer to not emit
  /// usual symbol prefix before the symbol name is used then return linkage
  /// name after skipping this special LLVM37 prefix.
...
/// is useful to reduce memory usage in LLVM37 or parsing work done by the
