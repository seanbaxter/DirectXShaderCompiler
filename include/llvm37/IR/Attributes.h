//===-- llvm37/Attributes.h - Container for Attributes ------------*- C++ -*-===//
//
...
#ifndef LLVM37_IR_ATTRIBUTES_H
#define LLVM37_IR_ATTRIBUTES_H
...
public:
  ...
  static Attribute get(LLVM37Context &Context, AttrKind Kind, uint64_t Val = 0);
  static Attribute get(LLVM37Context &Context, StringRef Kind,
                       StringRef Val = StringRef());

  /// \brief Return a uniquified Attribute object that has the specific
  /// alignment set.
  static Attribute getWithAlignment(LLVM37Context &Context, uint64_t Align);
  static Attribute getWithStackAlignment(LLVM37Context &Context, uint64_t Align);
  static Attribute getWithDereferenceableBytes(LLVM37Context &Context,
                                              uint64_t Bytes);
  static Attribute getWithDereferenceableOrNullBytes(LLVM37Context &Context,
                                                     uint64_t Bytes);
...
private:
  ...
  static AttributeSet get(LLVM37Context &C,
                          ArrayRef<std::pair<unsigned, Attribute> > Attrs);
  static AttributeSet get(LLVM37Context &C,
                          ArrayRef<std::pair<unsigned,
                                             AttributeSetNode*> > Attrs);

  static AttributeSet getImpl(LLVM37Context &C,
                              ArrayRef<std::pair<unsigned,
                                                 AttributeSetNode*> > Attrs);
...
public:
  ...
  static AttributeSet get(LLVM37Context &C, ArrayRef<AttributeSet> Attrs);
  static AttributeSet get(LLVM37Context &C, unsigned Index,
                          ArrayRef<Attribute::AttrKind> Kind);
  static AttributeSet get(LLVM37Context &C, unsigned Index, const AttrBuilder &B);

  /// \brief Add an attribute to the attribute set at the given index. Because
  /// attribute sets are immutable, this returns a new set.
  AttributeSet addAttribute(LLVM37Context &C, unsigned Index,
  ...
  /// attribute sets are immutable, this returns a new set.
  AttributeSet addAttributes(LLVM37Context &C, unsigned Index,
                             AttributeSet Attrs) const;

  /// \brief Remove the specified attribute at the specified index from this
  /// attribute list. Because attribute lists are immutable, this returns the
  /// new list.
  AttributeSet removeAttribute(LLVM37Context &C, unsigned Index, 
                               Attribute::AttrKind Attr) const;

  /// \brief Remove the specified attributes at the specified index from this
  /// attribute list. Because attribute lists are immutable, this returns the
  /// new list.
  AttributeSet removeAttributes(LLVM37Context &C, unsigned Index, 
                                AttributeSet Attrs) const;
  ...
  AttributeSet addDereferenceableAttr(LLVM37Context &C, unsigned Index,
  ...
  /// set.
  AttributeSet addDereferenceableOrNullAttr(LLVM37Context &C, unsigned Index,
                                            uint64_t Bytes) const;
  ...
  /// \brief Retrieve the LLVM37 context.
...
public:
  ...
  typedef llvm37::iterator_range<td_iterator>                  td_range;
  typedef llvm37::iterator_range<td_const_iterator>            td_const_range;
