//===---- llvm37/TypeBuilder.h - Builder for LLVM37 types -----------*- C++ -*-===//
//
...
// create LLVM37 types with a consistent and simplified interface.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_IR_TYPEBUILDER_H
#define LLVM37_IR_TYPEBUILDER_H
...
/// series of tag types in the llvm37::types namespace, like i<N>,
...
// exactly with an LLVM37-native type.
namespace types {
/// i<N> corresponds to the LLVM37 IntegerType with N bits.
template<uint32_t num_bits> class i {};

// The following classes represent the LLVM37 floating types.
class ieee_float {};
class ieee_double {};
class x86_fp80 {};
class fp128 {};
...
// LLVM37 doesn't have const or volatile types.
...
public:
  static PointerType *get(LLVM37Context &Context) {
...
public:
  static ArrayType *get(LLVM37Context &Context) {
    return ArrayType::get(TypeBuilder<T, cross>::get(Context), N);
  }
};
/// LLVM37 uses an array of length 0 to represent an unknown-length array.
template<typename T, bool cross> class TypeBuilder<T[], cross> {
public:
  static ArrayType *get(LLVM37Context &Context) {
...
public: \
  static IntegerType *get(LLVM37Context &Context) { \
...
public:
  static IntegerType *get(LLVM37Context &C) {
...
public:
  static Type *get(LLVM37Context& C) {
...
public:
  static Type *get(LLVM37Context& C) { return Type::getFloatTy(C); }
};
template<bool cross> class TypeBuilder<types::ieee_double, cross> {
public:
  static Type *get(LLVM37Context& C) { return Type::getDoubleTy(C); }
};
template<bool cross> class TypeBuilder<types::x86_fp80, cross> {
public:
  static Type *get(LLVM37Context& C) { return Type::getX86_FP80Ty(C); }
};
template<bool cross> class TypeBuilder<types::fp128, cross> {
public:
  static Type *get(LLVM37Context& C) { return Type::getFP128Ty(C); }
};
template<bool cross> class TypeBuilder<types::ppc_fp128, cross> {
public:
  static Type *get(LLVM37Context& C) { return Type::getPPC_FP128Ty(C); }
};
template<bool cross> class TypeBuilder<types::x86_mmx, cross> {
public:
  static Type *get(LLVM37Context& C) { return Type::getX86_MMXTy(C); }
};
...
/// void* is disallowed in LLVM37 types, but it occurs often enough in C code that
/// we special case it.
...
public:
  static FunctionType *get(LLVM37Context &Context) {
