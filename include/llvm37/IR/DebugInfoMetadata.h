//===- llvm37/IR/DebugInfoMetadata.h - Debug info metadata --------*- C++ -*-===//
//
...
#ifndef LLVM37_IR_DEBUGINFOMETADATA_H
#define LLVM37_IR_DEBUGINFOMETADATA_H
...
#define DEFINE_MDNODE_GET(CLASS, FORMAL, ARGS)                                 \
  static CLASS *get(LLVM37Context &Context, DEFINE_MDNODE_GET_UNPACK(FORMAL)) {  \
    return getImpl(Context, DEFINE_MDNODE_GET_UNPACK(ARGS), Uniqued);          \
  }                                                                            \
  static CLASS *getIfExists(LLVM37Context &Context,                              \
                            DEFINE_MDNODE_GET_UNPACK(FORMAL)) {                \
    return getImpl(Context, DEFINE_MDNODE_GET_UNPACK(ARGS), Uniqued,           \
                   /* ShouldCreate */ false);                                  \
  }                                                                            \
  static CLASS *getDistinct(LLVM37Context &Context,                              \
                            DEFINE_MDNODE_GET_UNPACK(FORMAL)) {                \
    return getImpl(Context, DEFINE_MDNODE_GET_UNPACK(ARGS), Distinct);         \
  }                                                                            \
  static Temp##CLASS getTemporary(LLVM37Context &Context,                        \
                                  DEFINE_MDNODE_GET_UNPACK(FORMAL)) {          \
    return Temp##CLASS(                                                        \
...
/// defined in llvm37/Support/Dwarf.h).  Called \a DINode because it's
/// potentially used for non-DWARF output.
class DINode : public MDNode {
  friend class LLVM37ContextImpl;
  friend class MDNode;

protected:
  DINode(LLVM37Context &C, unsigned ID, StorageType Storage, unsigned Tag,
  ...
  static MDString *getCanonicalMDString(LLVM37Context &Context, StringRef S) {
    if (S.empty())
      return nullptr;
...
class GenericDINode : public DINode {
  ...
  GenericDINode(LLVM37Context &C, StorageType Storage, unsigned Hash,
  ...
  static GenericDINode *getImpl(LLVM37Context &Context, unsigned Tag,
...
class DISubrange : public DINode {
  ...
  DISubrange(LLVM37Context &C, StorageType Storage, int64_t Count,
             int64_t LowerBound)
      : DINode(C, DISubrangeKind, Storage, dwarf::DW_TAG_subrange_type, None),
        Count(Count), LowerBound(LowerBound) {}
  ~DISubrange() = default;

  static DISubrange *getImpl(LLVM37Context &Context, int64_t Count,
...
class DIEnumerator : public DINode {
  ...
  DIEnumerator(LLVM37Context &C, StorageType Storage, int64_t Value,
               ArrayRef<Metadata *> Ops)
      : DINode(C, DIEnumeratorKind, Storage, dwarf::DW_TAG_enumerator, Ops),
        Value(Value) {}
  ~DIEnumerator() = default;

  static DIEnumerator *getImpl(LLVM37Context &Context, int64_t Value,
...
protected:
  DIScope(LLVM37Context &C, unsigned ID, StorageType Storage, unsigned Tag,
          ArrayRef<Metadata *> Ops)
...
class DIFile : public DIScope {
  ...
  DIFile(LLVM37Context &C, StorageType Storage, ArrayRef<Metadata *> Ops)
      : DIScope(C, DIFileKind, Storage, dwarf::DW_TAG_file_type, Ops) {}
  ~DIFile() = default;

  static DIFile *getImpl(LLVM37Context &Context, StringRef Filename,
  ...
  static DIFile *getImpl(LLVM37Context &Context, MDString *Filename,
...
protected:
  DIType(LLVM37Context &C, unsigned ID, StorageType Storage, unsigned Tag,
...
class DIBasicType : public DIType {
  ...
  DIBasicType(LLVM37Context &C, StorageType Storage, unsigned Tag,
  ...
  static DIBasicType *getImpl(LLVM37Context &Context, unsigned Tag,
...
protected:
  DIDerivedTypeBase(LLVM37Context &C, unsigned ID, StorageType Storage,
...
class DIDerivedType : public DIDerivedTypeBase {
  ...
  DIDerivedType(LLVM37Context &C, StorageType Storage, unsigned Tag,
                unsigned Line, uint64_t SizeInBits, uint64_t AlignInBits,
                uint64_t OffsetInBits, unsigned Flags, ArrayRef<Metadata *> Ops)
  ...
  static DIDerivedType *getImpl(LLVM37Context &Context, unsigned Tag,
...
protected:
  DICompositeTypeBase(LLVM37Context &C, unsigned ID, StorageType Storage,
...
class DICompositeType : public DICompositeTypeBase {
  ...
  DICompositeType(LLVM37Context &C, StorageType Storage, unsigned Tag,
  ...
  getImpl(LLVM37Context &Context, unsigned Tag, StringRef Name, Metadata *File,
  ...
  static DICompositeType *
  getImpl(LLVM37Context &Context, unsigned Tag, MDString *Name, Metadata *File,
          unsigned Line, Metadata *Scope, Metadata *BaseType,
          uint64_t SizeInBits, uint64_t AlignInBits, uint64_t OffsetInBits,
...
class DISubroutineType : public DICompositeTypeBase {
  ...
  DISubroutineType(LLVM37Context &C, StorageType Storage, unsigned Flags,
                   ArrayRef<Metadata *> Ops)
  ...
  static DISubroutineType *getImpl(LLVM37Context &Context, unsigned Flags,
...
class DICompileUnit : public DIScope {
  ...
  DICompileUnit(LLVM37Context &C, StorageType Storage, unsigned SourceLanguage,
  ...
  getImpl(LLVM37Context &Context, unsigned SourceLanguage, DIFile *File,
  ...
  static DICompileUnit *
  getImpl(LLVM37Context &Context, unsigned SourceLanguage, Metadata *File,
...
protected:
  DILocalScope(LLVM37Context &C, unsigned ID, StorageType Storage, unsigned Tag,
               ArrayRef<Metadata *> Ops)
...
class DILocation : public MDNode {
  ...
  DILocation(LLVM37Context &C, StorageType Storage, unsigned Line,
             unsigned Column, ArrayRef<Metadata *> MDs);
  ~DILocation() { dropAllReferences(); }

  static DILocation *getImpl(LLVM37Context &Context, unsigned Line,
...
public:
  ...
  ///
  /// This modifies the \a LLVM37Context that \c this is in to increment the next
...
class DISubprogram : public DILocalScope {
  ...
  DISubprogram(LLVM37Context &C, StorageType Storage, unsigned Line,
  ...
  static DISubprogram *
  getImpl(LLVM37Context &Context, DIScopeRef Scope, StringRef Name,
  ...
  static DISubprogram *
  getImpl(LLVM37Context &Context, Metadata *Scope, MDString *Name,
...
protected:
  DILexicalBlockBase(LLVM37Context &C, unsigned ID, StorageType Storage,
                     ArrayRef<Metadata *> Ops)
...
class DILexicalBlock : public DILexicalBlockBase {
  ...
  DILexicalBlock(LLVM37Context &C, StorageType Storage, unsigned Line,
                 unsigned Column, ArrayRef<Metadata *> Ops)
      : DILexicalBlockBase(C, DILexicalBlockKind, Storage, Ops), Line(Line),
        Column(Column) {}
  ~DILexicalBlock() = default;

  static DILexicalBlock *getImpl(LLVM37Context &Context, DILocalScope *Scope,
  ...
  static DILexicalBlock *getImpl(LLVM37Context &Context, Metadata *Scope,
...
class DILexicalBlockFile : public DILexicalBlockBase {
  ...
  DILexicalBlockFile(LLVM37Context &C, StorageType Storage,
                     unsigned Discriminator, ArrayRef<Metadata *> Ops)
      : DILexicalBlockBase(C, DILexicalBlockFileKind, Storage, Ops),
        Discriminator(Discriminator) {}
  ~DILexicalBlockFile() = default;

  static DILexicalBlockFile *getImpl(LLVM37Context &Context, DILocalScope *Scope,
  ...
  static DILexicalBlockFile *getImpl(LLVM37Context &Context, Metadata *Scope,
...
class DINamespace : public DIScope {
  ...
  DINamespace(LLVM37Context &Context, StorageType Storage, unsigned Line,
              ArrayRef<Metadata *> Ops)
  ...
  static DINamespace *getImpl(LLVM37Context &Context, DIScope *Scope,
                              DIFile *File, StringRef Name, unsigned Line,
                              StorageType Storage, bool ShouldCreate = true) {
    return getImpl(Context, Scope, File, getCanonicalMDString(Context, Name),
                   Line, Storage, ShouldCreate);
  }
  static DINamespace *getImpl(LLVM37Context &Context, Metadata *Scope,
...
class DIModule : public DIScope {
  ...
  DIModule(LLVM37Context &Context, StorageType Storage, ArrayRef<Metadata *> Ops)
      : DIScope(Context, DIModuleKind, Storage, dwarf::DW_TAG_module, Ops) {}
  ~DIModule() {}

  static DIModule *getImpl(LLVM37Context &Context, DIScope *Scope,
  ...
  static DIModule *getImpl(LLVM37Context &Context, Metadata *Scope,
...
protected:
  DITemplateParameter(LLVM37Context &Context, unsigned ID, StorageType Storage,
...
class DITemplateTypeParameter : public DITemplateParameter {
  ...
  DITemplateTypeParameter(LLVM37Context &Context, StorageType Storage,
                          ArrayRef<Metadata *> Ops)
      : DITemplateParameter(Context, DITemplateTypeParameterKind, Storage,
                            dwarf::DW_TAG_template_type_parameter, Ops) {}
  ~DITemplateTypeParameter() = default;

  static DITemplateTypeParameter *getImpl(LLVM37Context &Context, StringRef Name,
                                          DITypeRef Type, StorageType Storage,
                                          bool ShouldCreate = true) {
    return getImpl(Context, getCanonicalMDString(Context, Name), Type, Storage,
                   ShouldCreate);
  }
  static DITemplateTypeParameter *getImpl(LLVM37Context &Context, MDString *Name,
...
class DITemplateValueParameter : public DITemplateParameter {
  ...
  DITemplateValueParameter(LLVM37Context &Context, StorageType Storage,
                           unsigned Tag, ArrayRef<Metadata *> Ops)
      : DITemplateParameter(Context, DITemplateValueParameterKind, Storage, Tag,
                            Ops) {}
  ~DITemplateValueParameter() = default;

  static DITemplateValueParameter *getImpl(LLVM37Context &Context, unsigned Tag,
...
protected:
  DIVariable(LLVM37Context &C, unsigned ID, StorageType Storage, unsigned Tag,
...
class DIGlobalVariable : public DIVariable {
  ...
  DIGlobalVariable(LLVM37Context &C, StorageType Storage, unsigned Line,
  ...
  getImpl(LLVM37Context &Context, DIScope *Scope, StringRef Name,
...
class DILocalVariable : public DIVariable {
  ...
  DILocalVariable(LLVM37Context &C, StorageType Storage, unsigned Tag,
  ...
  static DILocalVariable *getImpl(LLVM37Context &Context, unsigned Tag,
  ...
  getImpl(LLVM37Context &Context, unsigned Tag, Metadata *Scope, MDString *Name,
...
class DIExpression : public MDNode {
  ...
  DIExpression(LLVM37Context &C, StorageType Storage, ArrayRef<uint64_t> Elements)
      : MDNode(C, DIExpressionKind, Storage, None),
        Elements(Elements.begin(), Elements.end()) {}
  ~DIExpression() = default;

  static DIExpression *getImpl(LLVM37Context &Context,
...
class DIObjCProperty : public DINode {
  ...
  DIObjCProperty(LLVM37Context &C, StorageType Storage, unsigned Line,
  ...
  getImpl(LLVM37Context &Context, StringRef Name, DIFile *File, unsigned Line,
  ...
  static DIObjCProperty *getImpl(LLVM37Context &Context, MDString *Name,
...
class DIImportedEntity : public DINode {
  ...
  DIImportedEntity(LLVM37Context &C, StorageType Storage, unsigned Tag,
                   unsigned Line, ArrayRef<Metadata *> Ops)
      : DINode(C, DIImportedEntityKind, Storage, Tag, Ops), Line(Line) {}
  ~DIImportedEntity() = default;

  static DIImportedEntity *getImpl(LLVM37Context &Context, unsigned Tag,
