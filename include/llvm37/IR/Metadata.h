//===- llvm37/IR/Metadata.h - Metadata definitions ----------------*- C++ -*-===//
//
...
/// They represent the different flavors of metadata that live in LLVM37.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_IR_METADATA_H
#define LLVM37_IR_METADATA_H
...
protected:
  ...
  void handleChangedOperand(void *, Metadata *) {
    llvm37_unreachable("Unimplemented in Metadata subclass");
  }
...
public:
  static MetadataAsValue *get(LLVM37Context &Context, Metadata *MD);
  static MetadataAsValue *getIfExists(LLVM37Context &Context, Metadata *MD);
...
public:
  ReplaceableMetadataImpl(LLVM37Context &Context)
...
public:
  ...
  LLVM37Context &getContext() const { return V->getContext(); }
...
public:
  static MDString *get(LLVM37Context &Context, StringRef Str);
  static MDString *get(LLVM37Context &Context, const char *Str) {
...
///
/// Either a raw (non-null) pointer to the \a LLVM37Context, or an owned pointer
/// to \a ReplaceableMetadataImpl (which has a reference to \a LLVM37Context).
class ContextAndReplaceableUses {
  PointerUnion<LLVM37Context *, ReplaceableMetadataImpl *> Ptr;
...
public:
  ContextAndReplaceableUses(LLVM37Context &Context) : Ptr(&Context) {}
  ContextAndReplaceableUses(
  ...
  operator LLVM37Context &() { return getContext(); }

  /// \brief Whether this contains RAUW support.
  bool hasReplaceableUses() const {
    return Ptr.is<ReplaceableMetadataImpl *>();
  }
  LLVM37Context &getContext() const {
    if (hasReplaceableUses())
      return getReplaceableUses()->getContext();
    return *Ptr.get<LLVM37Context *>();
  }
...
protected:
  ...
  void operator delete(void *Mem, unsigned) {
    //llvm37_unreachable("Constructor throws?"); // HLSL Change - why, yes; yes it does (under OOM)
    MDNode::operator delete(Mem);
  }

  /// \brief Required by std, but never called.
  void operator delete(void *, unsigned, bool) {
    llvm37_unreachable("Constructor throws?");
  }

  MDNode(LLVM37Context &Context, unsigned ID, StorageType Storage,
...
public:
  static inline MDTuple *get(LLVM37Context &Context, ArrayRef<Metadata *> MDs);
  static inline MDTuple *getIfExists(LLVM37Context &Context,
                                     ArrayRef<Metadata *> MDs);
  static inline MDTuple *getDistinct(LLVM37Context &Context,
                                     ArrayRef<Metadata *> MDs);
  static inline TempMDTuple getTemporary(LLVM37Context &Context,
                                         ArrayRef<Metadata *> MDs);
  ...
  LLVM37Context &getContext() const { return Context.getContext(); }
...
class MDTuple : public MDNode {
  ...
  MDTuple(LLVM37Context &C, StorageType Storage, unsigned Hash,
  ...
  static MDTuple *getImpl(LLVM37Context &Context, ArrayRef<Metadata *> MDs,
...
public:
  ...
  static MDTuple *get(LLVM37Context &Context, ArrayRef<Metadata *> MDs) {
    return getImpl(Context, MDs, Uniqued);
  }
  static MDTuple *getIfExists(LLVM37Context &Context, ArrayRef<Metadata *> MDs) {
  ...
  static MDTuple *getDistinct(LLVM37Context &Context, ArrayRef<Metadata *> MDs) {
  ...
  /// deleteTemporary.
  static TempMDTuple getTemporary(LLVM37Context &Context,
                                  ArrayRef<Metadata *> MDs) {
...
MDTuple *MDNode::get(LLVM37Context &Context, ArrayRef<Metadata *> MDs) {
  return MDTuple::get(Context, MDs);
}
MDTuple *MDNode::getIfExists(LLVM37Context &Context, ArrayRef<Metadata *> MDs) {
  return MDTuple::getIfExists(Context, MDs);
}
MDTuple *MDNode::getDistinct(LLVM37Context &Context, ArrayRef<Metadata *> MDs) {
  return MDTuple::getDistinct(Context, MDs);
}
TempMDTuple MDNode::getTemporary(LLVM37Context &Context,
                                 ArrayRef<Metadata *> MDs) {
