//===- CFG.h - Process LLVM37 structures as graphs ----------------*- C++ -*-===//
//
...
#ifndef LLVM37_IR_CFG_H
#define LLVM37_IR_CFG_H
...
typedef llvm37::iterator_range<pred_iterator> pred_range;
typedef llvm37::iterator_range<const_pred_iterator> pred_const_range;
...
typedef llvm37::iterator_range<succ_iterator> succ_range;
typedef llvm37::iterator_range<succ_const_iterator> succ_const_range;
