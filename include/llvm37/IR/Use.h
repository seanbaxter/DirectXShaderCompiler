//===-- llvm37/Use.h - Definition of the Use class ----------------*- C++ -*-===//
//
...
///
///   http://www.llvm37.org/docs/ProgrammersManual.html#UserLayout
///
//===----------------------------------------------------------------------===//

#ifndef LLVM37_IR_USE_H
#define LLVM37_IR_USE_H
...
///
/// This is essentially the single most memory intensive object in LLVM37 because
...
DEFINE_SIMPLE_CONVERSION_FUNCTIONS(Use, LLVM37UseRef)
