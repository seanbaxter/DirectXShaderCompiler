...
//===----------------------------------------------------------------------===//
//
// This file declares the LLVM37 Pass Manager infrastructure.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_IR_LEGACYPASSMANAGERS_H
#define LLVM37_IR_LEGACYPASSMANAGERS_H
...
class PMStack {
public:
  typedef llvm37::SmallVector<PMDataManager *, 2>::const_reverse_iterator iterator; // HLSL Change - SmallVector rather than vector
...
private:
  llvm37::SmallVector<PMDataManager *, 2> S; // HLSL Change - SmallVector rather than vector
};
