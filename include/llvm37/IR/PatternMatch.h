//===- PatternMatch.h - Match on the LLVM37 IR --------------------*- C++ -*-===//
//
...
// tree-based pattern matches on the LLVM37 IR.  The power of these routines is
...
#ifndef LLVM37_IR_PATTERNMATCH_H
#define LLVM37_IR_PATTERNMATCH_H
