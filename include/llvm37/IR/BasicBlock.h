//===-- llvm37/BasicBlock.h - Represent a basic block in the VM ---*- C++ -*-===//
//
...
#ifndef LLVM37_IR_BASICBLOCK_H
#define LLVM37_IR_BASICBLOCK_H
...
/// \brief LLVM37 Basic Block Representation
///
/// This represents a single basic block in LLVM37. A basic block is simply a
...
private:
  ...
  explicit BasicBlock(LLVM37Context &C, const Twine &Name = "",
...
public:
  ...
  /// before the specified basic block.
  static BasicBlock *Create(LLVM37Context &Context, const Twine &Name = "",
                            Function *Parent = nullptr,
                            BasicBlock *InsertBefore = nullptr) {
...
DEFINE_SIMPLE_CONVERSION_FUNCTIONS(BasicBlock, LLVM37BasicBlockRef)
