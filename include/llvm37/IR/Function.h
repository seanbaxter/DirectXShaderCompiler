//===-- llvm37/Function.h - Class to represent a single function --*- C++ -*-===//
//
...
// single function/procedure in LLVM37.
//
...
#ifndef LLVM37_IR_FUNCTION_H
#define LLVM37_IR_FUNCTION_H
...
#include "llvm37/IR/GlobalObject.h"
...
public:
  ...
  /// getContext - Return a reference to the LLVM37Context associated with this
  /// function.
  ...
  /// defined in llvm37/Intrinsics.h.
  Intrinsic::ID getIntrinsicID() const LLVM37_READONLY { return IntID; }
  bool isIntrinsic() const { return getName().startswith("llvm."); }

  /// \brief Recalculate the ID for this function if it is an Intrinsic defined
  /// in llvm37/Intrinsics.h.  Sets the intrinsic ID to Intrinsic::not_intrinsic
