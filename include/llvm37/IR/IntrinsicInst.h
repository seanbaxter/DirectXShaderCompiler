//===-- llvm37/IntrinsicInst.h - Intrinsic Instruction Wrappers ---*- C++ -*-===//
//
...
#ifndef LLVM37_IR_INTRINSICINST_H
#define LLVM37_IR_INTRINSICINST_H
...
namespace llvm37 {
  ...
  /// MemSetInst - This class wraps the llvm37.memset intrinsic.
  ///
  ...
  /// MemTransferInst - This class wraps the llvm37.memcpy/memmove intrinsics.
  ///
  ...
  /// MemCpyInst - This class wraps the llvm37.memcpy intrinsic.
  ///
  ...
  /// MemMoveInst - This class wraps the llvm37.memmove intrinsic.
  ///
  ...
  /// VAStartInst - This represents the llvm37.va_start intrinsic.
  ///
  ...
  /// VAEndInst - This represents the llvm37.va_end intrinsic.
  ///
  ...
  /// VACopyInst - This represents the llvm37.va_copy intrinsic.
  ///
  ...
  /// This represents the llvm37.instrprof_increment intrinsic.
