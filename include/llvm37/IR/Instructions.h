//===-- llvm37/Instructions.h - Instruction subclass definitions --*- C++ -*-===//
//
...
#ifndef LLVM37_IR_INSTRUCTIONS_H
#define LLVM37_IR_INSTRUCTIONS_H
...
public:
  ...
  FenceInst(LLVM37Context &C, AtomicOrdering Ordering,
            SynchronizationScope SynchScope = CrossThread,
            Instruction *InsertBefore = nullptr);
  FenceInst(LLVM37Context &C, AtomicOrdering Ordering,
            SynchronizationScope SynchScope,
...
public:
  ...
  getStrongestFailureOrdering(AtomicOrdering SuccessOrdering) {
    ...
    default: llvm37_unreachable("invalid cmpxchg success ordering");
    case Release:
    case Monotonic:
      return Monotonic;
    case AcquireRelease:
...
/// SelectInst - This class represents the LLVM37 'select' instruction.
///
...
/// VAArgInst - This class represents the va_arg llvm37 instruction, which returns
...
private:
  ...
  explicit ReturnInst(LLVM37Context &C, Value *retVal = nullptr,
                      Instruction *InsertBefore = nullptr);
  ReturnInst(LLVM37Context &C, Value *retVal, BasicBlock *InsertAtEnd);
  explicit ReturnInst(LLVM37Context &C, BasicBlock *InsertAtEnd);
protected:
  // Note: Instruction needs to be a friend here to call cloneImpl.
  friend class Instruction;
...
public:
  static ReturnInst* Create(LLVM37Context &C, Value *retVal = nullptr,
                            Instruction *InsertBefore = nullptr) {
    return new(!!retVal) ReturnInst(C, retVal, InsertBefore);
  }
  static ReturnInst* Create(LLVM37Context &C, Value *retVal,
                            BasicBlock *InsertAtEnd) {
    return new(!!retVal) ReturnInst(C, retVal, InsertAtEnd);
  }
  static ReturnInst* Create(LLVM37Context &C, BasicBlock *InsertAtEnd) {
...
public:
  ...
  explicit UnreachableInst(LLVM37Context &C, Instruction *InsertBefore = nullptr);
  explicit UnreachableInst(LLVM37Context &C, BasicBlock *InsertAtEnd);
