//===-- llvm37/Constant.h - Constant class definition -------------*- C++ -*-===//
//
...
#ifndef LLVM37_IR_CONSTANT_H
#define LLVM37_IR_CONSTANT_H
...
/// This is an important base class in LLVM37. It provides the common facilities
/// of all constant values in an LLVM37 program. A constant is a value that is
...
/// @brief LLVM37 Constant Representation
