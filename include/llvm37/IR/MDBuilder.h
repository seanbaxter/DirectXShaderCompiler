//===---- llvm37/MDBuilder.h - Builder for LLVM37 metadata ----------*- C++ -*-===//
//
...
#ifndef LLVM37_IR_MDBUILDER_H
#define LLVM37_IR_MDBUILDER_H
...
public:
  MDBuilder(LLVM37Context &context) : Context(context) {}
