//===-- llvm37/CallingConv.h - LLVM37 Calling Conventions -----------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines LLVM37's set of calling conventions.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_IR_CALLINGCONV_H
#define LLVM37_IR_CALLINGCONV_H
...
namespace CallingConv {
  /// LLVM37 IR allows to use arbitrary numbers as calling convention identifiers.
  typedef unsigned ID;

  /// A set of enums which specify the assigned numeric values for known llvm37
  /// calling conventions.
  /// @brief LLVM37 Calling Convention Representation
  enum {
    /// C - The default llvm37 calling convention, compatible with C.  This
    /// convention is the only calling convention that supports varargs calls.
    /// As with typical C calling conventions, the callee/caller have to
    /// tolerate certain amounts of prototype mismatch.
    C = 0,

    // Generic LLVM37 calling conventions.  None of these calling conventions
