...
/// \file
///
/// This header defines various interfaces for pass management in LLVM37. There
/// is no "pass" interface in LLVM37 per se. Instead, an instance of any class
...
#ifndef LLVM37_IR_PASSMANAGER_H
#define LLVM37_IR_PASSMANAGER_H
...
#include "llvm37/IR/PassManagerInternal.h"
...
public:
  ...
  PreservedAnalyses run(IRUnitT &IR, AnalysisManager<IRUnitT> *AM = nullptr) {
    ...
    for (unsigned Idx = 0, Size = Passes.size(); Idx != Size; ++Idx) {
      ...
      // FIXME: Historically, the pass managers all called the LLVM37 context's
...
/// FIXME: Make the above true for all of LLVM37's actual passes, some still
