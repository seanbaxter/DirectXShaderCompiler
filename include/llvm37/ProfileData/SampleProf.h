...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM37_PROFILEDATA_SAMPLEPROF_H_
#define LLVM37_PROFILEDATA_SAMPLEPROF_H_
...
namespace std {
template <>
struct is_error_code_enum<llvm37::sampleprof_error> : std::true_type {};
}
...
#endif // LLVM37_PROFILEDATA_SAMPLEPROF_H_
