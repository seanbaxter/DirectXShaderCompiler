//===- SampleProfReader.h - Read LLVM37 sample profile data -----------------===//
//
...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM37_PROFILEDATA_SAMPLEPROFREADER_H
#define LLVM37_PROFILEDATA_SAMPLEPROFREADER_H
...
public:
  SampleProfileReader(std::unique_ptr<MemoryBuffer> B, LLVM37Context &C)
  ...
  create(StringRef Filename, LLVM37Context &C);
...
protected:
  ...
  /// \brief LLVM37 context used to emit diagnostics.
  LLVM37Context &Ctx;
...
public:
  SampleProfileReaderText(std::unique_ptr<MemoryBuffer> B, LLVM37Context &C)
...
public:
  SampleProfileReaderBinary(std::unique_ptr<MemoryBuffer> B, LLVM37Context &C)
...
#endif // LLVM37_PROFILEDATA_SAMPLEPROFREADER_H
