...
// llvm37-cov to show code coverage statistics for a file.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_PROFILEDATA_COVERAGEMAPPING_H_
#define LLVM37_PROFILEDATA_COVERAGEMAPPING_H_
...
class CounterExpressionBuilder {
  ...
  llvm37::DenseMap<CounterExpression, unsigned> ExpressionIndices;
...
public:
  ...
  void dump(const Counter &C, llvm37::raw_ostream &OS) const;
...
namespace std {
template <>
struct is_error_code_enum<llvm37::coveragemap_error> : std::true_type {};
}

#endif // LLVM37_PROFILEDATA_COVERAGEMAPPING_H_
