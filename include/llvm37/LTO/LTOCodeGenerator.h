//===-LTOCodeGenerator.h - LLVM37 Link Time Optimizer -----------------------===//
//
...
#ifndef LLVM37_LTO_LTOCODEGENERATOR_H
#define LLVM37_LTO_LTOCODEGENERATOR_H
...
struct LTOCodeGenerator {
  ...
  LTOCodeGenerator();
  LTOCodeGenerator(std::unique_ptr<LLVM37Context> Context);
  ~LTOCodeGenerator();
