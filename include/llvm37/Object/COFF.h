...
#ifndef LLVM37_OBJECT_COFF_H
#define LLVM37_OBJECT_COFF_H
...
public:
  ...
  bool isBigObj() const {
    ...
    if (CS32)
      return true;
    llvm37_unreachable("COFFSymbolRef points to nothing!");
  }
...
public:
  ...
  uint16_t getMachine() const {
    ...
    llvm37_unreachable("no COFF header!");
  }
...
public:
  ...
  size_t getSymbolTableEntrySize() const {
    ...
    llvm37_unreachable("null symbol table pointer!");
  }
