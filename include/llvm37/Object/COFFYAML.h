...
#ifndef LLVM37_OBJECT_COFFYAML_H
#define LLVM37_OBJECT_COFFYAML_H
...
namespace COFFYAML {
  LLVM37_YAML_STRONG_TYPEDEF(uint8_t, COMDATType)
  LLVM37_YAML_STRONG_TYPEDEF(uint32_t, WeakExternalCharacteristics)
  LLVM37_YAML_STRONG_TYPEDEF(uint8_t, AuxSymbolType)
...
LLVM37_YAML_IS_SEQUENCE_VECTOR(COFFYAML::Section)
LLVM37_YAML_IS_SEQUENCE_VECTOR(COFFYAML::Symbol)
LLVM37_YAML_IS_SEQUENCE_VECTOR(COFFYAML::Relocation)
