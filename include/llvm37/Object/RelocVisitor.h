...
#ifndef LLVM37_OBJECT_RELOCVISITOR_H
#define LLVM37_OBJECT_RELOCVISITOR_H
...
private:
  ...
  RelocToApply visitELF(uint32_t RelocType, RelocationRef R, uint64_t Value) {
    if (ObjToVisit.getBytesInAddress() == 8) { // 64-bit object file
      ...
      case Triple::x86_64:
        switch (RelocType) {
        case llvm37::ELF::R_X86_64_NONE:
          return visitELF_X86_64_NONE(R);
        case llvm37::ELF::R_X86_64_64:
          return visitELF_X86_64_64(R, Value);
        case llvm37::ELF::R_X86_64_PC32:
          return visitELF_X86_64_PC32(R, Value);
        case llvm37::ELF::R_X86_64_32:
          return visitELF_X86_64_32(R, Value);
        case llvm37::ELF::R_X86_64_32S:
      ...
      case Triple::aarch64:
        switch (RelocType) {
        case llvm37::ELF::R_AARCH64_ABS32:
          return visitELF_AARCH64_ABS32(R, Value);
        case llvm37::ELF::R_AARCH64_ABS64:
      ...
      case Triple::mips64:
        switch (RelocType) {
        case llvm37::ELF::R_MIPS_32:
          return visitELF_MIPS64_32(R, Value);
        case llvm37::ELF::R_MIPS_64:
      ...
      case Triple::ppc64:
        switch (RelocType) {
        case llvm37::ELF::R_PPC64_ADDR32:
          return visitELF_PPC64_ADDR32(R, Value);
        case llvm37::ELF::R_PPC64_ADDR64:
      ...
      case Triple::systemz:
        switch (RelocType) {
        case llvm37::ELF::R_390_32:
          return visitELF_390_32(R, Value);
        case llvm37::ELF::R_390_64:
      ...
      case Triple::sparcv9:
        switch (RelocType) {
        case llvm37::ELF::R_SPARC_32:
        case llvm37::ELF::R_SPARC_UA32:
          return visitELF_SPARCV9_32(R, Value);
        case llvm37::ELF::R_SPARC_64:
        case llvm37::ELF::R_SPARC_UA64:
      ...
      case Triple::x86:
        switch (RelocType) {
        case llvm37::ELF::R_386_NONE:
          return visitELF_386_NONE(R);
        case llvm37::ELF::R_386_32:
          return visitELF_386_32(R, Value);
        case llvm37::ELF::R_386_PC32:
