...
#ifndef LLVM37_OBJECT_ELFYAML_H
#define LLVM37_OBJECT_ELFYAML_H
...
LLVM37_YAML_STRONG_TYPEDEF(uint16_t, ELF_ET)
LLVM37_YAML_STRONG_TYPEDEF(uint32_t, ELF_EM)
LLVM37_YAML_STRONG_TYPEDEF(uint8_t, ELF_ELFCLASS)
LLVM37_YAML_STRONG_TYPEDEF(uint8_t, ELF_ELFDATA)
LLVM37_YAML_STRONG_TYPEDEF(uint8_t, ELF_ELFOSABI)
// Just use 64, since it can hold 32-bit values too.
LLVM37_YAML_STRONG_TYPEDEF(uint64_t, ELF_EF)
LLVM37_YAML_STRONG_TYPEDEF(uint32_t, ELF_SHT)
LLVM37_YAML_STRONG_TYPEDEF(uint32_t, ELF_REL)
LLVM37_YAML_STRONG_TYPEDEF(uint8_t, ELF_RSS)
// Just use 64, since it can hold 32-bit values too.
LLVM37_YAML_STRONG_TYPEDEF(uint64_t, ELF_SHF)
LLVM37_YAML_STRONG_TYPEDEF(uint8_t, ELF_STT)
LLVM37_YAML_STRONG_TYPEDEF(uint8_t, ELF_STV)
LLVM37_YAML_STRONG_TYPEDEF(uint8_t, ELF_STO)
...
LLVM37_YAML_STRONG_TYPEDEF(uint32_t, MIPS_ISA)
...
struct FileHeader {
  ...
  ELF_EM Machine;
  ELF_EF Flags;
  llvm37::yaml::Hex64 Entry;
};
struct Symbol {
  StringRef Name;
  ELF_STT Type;
  StringRef Section;
  llvm37::yaml::Hex64 Value;
  llvm37::yaml::Hex64 Size;
  uint8_t Other;
};
...
struct Section {
  ...
  ELF_SHT Type;
  ELF_SHF Flags;
  llvm37::yaml::Hex64 Address;
  StringRef Link;
  StringRef Info;
  llvm37::yaml::Hex64 AddressAlign;
...
struct MipsABIFlags : Section {
  llvm37::yaml::Hex16 Version;
  MIPS_ISA ISALevel;
  llvm37::yaml::Hex8 ISARevision;
...
LLVM37_YAML_IS_SEQUENCE_VECTOR(std::unique_ptr<llvm37::ELFYAML::Section>)
LLVM37_YAML_IS_SEQUENCE_VECTOR(llvm37::ELFYAML::Symbol)
LLVM37_YAML_IS_SEQUENCE_VECTOR(llvm37::ELFYAML::Relocation)
LLVM37_YAML_IS_SEQUENCE_VECTOR(llvm37::ELFYAML::SectionOrType)
