//===- llvm37/Transforms/IPO.h - Interprocedural Transformations --*- C++ -*-===//
//
...
#ifndef LLVM37_TRANSFORMS_IPO_H
#define LLVM37_TRANSFORMS_IPO_H
...
//===----------------------------------------------------------------------===//
//
// These pass removes llvm37.dbg.declare intrinsics.
...
/// \brief This pass lowers bitset metadata and the llvm37.bitset.test intrinsic
/// to bitsets.
