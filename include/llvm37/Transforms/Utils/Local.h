...
#ifndef LLVM37_TRANSFORMS_UTILS_LOCAL_H
#define LLVM37_TRANSFORMS_UTILS_LOCAL_H
...
/// \brief Replaces llvm37.dbg.declare instruction when an alloca is replaced with
