//===- LLVMBitCodes.h - Enum values for the LLVM37 bitcode format -*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This header defines Bitcode enum values for LLVM37 IR bitcode files.
//
...
#ifndef LLVM37_BITCODE_LLVM37BITCODES_H
#define LLVM37_BITCODE_LLVM37BITCODES_H
...
namespace bitc {
  ...
  /// have no fixed relation to the LLVM37 IR enum values.  Changing these will
  ...
  /// The values of these enums have no fixed relation to the LLVM37 IR enum
