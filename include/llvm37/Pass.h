//===- llvm37/Pass.h - Base class for Passes ----------------------*- C++ -*-===//
//
...
#ifndef LLVM37_PASS_H
#define LLVM37_PASS_H

#include "llvm37/Support/Compiler.h"
#include <string>
#include "llvm37/ADT/ArrayRef.h" // HLSL Change
#include "llvm37/ADT/StringRef.h" // HLSL Change
...
// HLSL Change Starts
//
// LLVM37 passes typically support an empty constructor, but often they will
...
//
typedef std::pair<llvm37::StringRef, llvm37::StringRef> PassOption;
typedef llvm37::ArrayRef<PassOption> PassOptions;
struct PassOptionsCompare {
  bool operator()(const PassOption &a, const PassOption &b) {
    return a.first < b.first;
  }
};
bool GetPassOption(PassOptions &O, llvm37::StringRef name, llvm37::StringRef *pValue);
bool GetPassOptionBool(PassOptions &O, llvm37::StringRef name, bool *pValue, bool defaultValue);
bool GetPassOptionUnsigned(PassOptions &O, llvm37::StringRef name, unsigned *pValue, unsigned defaultValue);
bool GetPassOptionInt(PassOptions &O, llvm37::StringRef name, int *pValue, int defaultValue);
bool GetPassOptionUInt32(PassOptions &O, llvm37::StringRef name, uint32_t *pValue, uint32_t defaultValue);
bool GetPassOptionUInt64(PassOptions &O, llvm37::StringRef name, uint64_t *pValue, uint64_t defaultValue);
bool GetPassOptionFloat(PassOptions &O, llvm37::StringRef name, float *pValue, float defaultValue);
// HLSL Change Ends
...
/// If the user specifies the -time-passes argument on an LLVM37 tool command line
