//===- llvm37/Analysis/AssumptionCache.h - Track @llvm37.assume ---*- C++ -*-===//
//
...
#ifndef LLVM37_ANALYSIS_ASSUMPTIONCACHE_H
#define LLVM37_ANALYSIS_ASSUMPTIONCACHE_H
...
/// \brief A cache of @llvm37.assume calls within a function.
///
...
class AssumptionCache {
  ...
  /// \brief Vector of weak value handles to calls of the @llvm37.assume
  /// intrinsic.
...
public:
  ...
  /// \brief Add an @llvm37.assume intrinsic to this function's cache.
  ///
  /// The call passed in must be an instruction within this fuction and must
  /// not already be in the cache.
  void registerAssumption(CallInst *CI);

  /// \brief Clear the cache of @llvm37.assume intrinsics for a function.
  ///
