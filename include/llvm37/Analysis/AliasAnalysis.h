//===- llvm37/Analysis/AliasAnalysis.h - Alias Analysis Interface -*- C++ -*-===//
//
...
#ifndef LLVM37_ANALYSIS_ALIASANALYSIS_H
#define LLVM37_ANALYSIS_ALIASANALYSIS_H
...
/// they serve as global constants in LLVM37 for these results.
///
...
public:
  ...
  enum ModRefBehavior {
    ...
    /// This property corresponds to the LLVM37 IR 'readnone' attribute.
    /// This property corresponds to the IntrNoMem LLVM37 intrinsic flag.
    ...
    ///
    /// This property corresponds to the LLVM37 IR 'argmemonly' attribute combined
    /// with 'readonly' attribute.
    /// This property corresponds to the IntrReadArgMem LLVM37 intrinsic flag.
    ...
    ///
    /// This property corresponds to the LLVM37 IR 'argmemonly' attribute.
    /// This property corresponds to the IntrReadWriteArgMem LLVM37 intrinsic flag.
    ...
    /// This property corresponds to the LLVM37 IR 'readonly' attribute.
    /// This property corresponds to the IntrReadMem LLVM37 intrinsic flag.
  ...
  ///   http://llvm37.org/docs/AliasAnalysis.html#ModRefInfo
  /// for details.
  ...
  /// deleteValue - This method should be called whenever an LLVM37 Value is
