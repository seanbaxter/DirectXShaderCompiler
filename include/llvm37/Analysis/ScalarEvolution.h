//===- llvm37/Analysis/ScalarEvolution.h - Scalar Evolution -------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// The ScalarEvolution class is an LLVM37 pass which can be used to analyze and
...
#ifndef LLVM37_ANALYSIS_SCALAREVOLUTION_H
#define LLVM37_ANALYSIS_SCALAREVOLUTION_H
...
namespace llvm37 {
  ...
  public:
    ...
    /// getType - Return the LLVM37 type of this SCEV expression.
    ///
    Type *getType() const;
  ...
  public:
    ...
    static SCEV::NoWrapFlags LLVM37_ATTRIBUTE_UNUSED_RESULT
  ...
  private:
    ...
    /// The tracker for @llvm37.assume intrinsics in this function.
    AssumptionCache *AC;
  ...
  public:
    ...
    LLVM37Context &getContext() const { return F->getContext(); }
