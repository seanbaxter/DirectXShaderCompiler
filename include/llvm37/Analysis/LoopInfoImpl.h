//===- llvm37/Analysis/LoopInfoImpl.h - Natural Loop Calculator ---*- C++ -*-===//
//
...
#ifndef LLVM37_ANALYSIS_LOOPINFOIMPL_H
#define LLVM37_ANALYSIS_LOOPINFOIMPL_H
...
void LoopBase<BlockT, LoopT>::verifyLoop() const {
  ...
  llvm37::SmallPtrSet<BlockT*, 8> VisitSet;
  VisitSet.insert(ExitBBs.begin(), ExitBBs.end());
  df_ext_iterator<BlockT*, llvm37::SmallPtrSet<BlockT*, 8> >
