//===- llvm37/Analysis/MemoryBuiltins.h- Calls to memory builtins -*- C++ -*-===//
//
...
#ifndef LLVM37_ANALYSIS_MEMORYBUILTINS_H
#define LLVM37_ANALYSIS_MEMORYBUILTINS_H
...
public:
  ObjectSizeOffsetVisitor(const DataLayout &DL, const TargetLibraryInfo *TLI,
                          LLVM37Context &Context, bool RoundToAlign = false);
