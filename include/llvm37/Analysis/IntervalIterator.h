...
#ifndef LLVM37_ANALYSIS_INTERVALITERATOR_H
#define LLVM37_ANALYSIS_INTERVALITERATOR_H
...
public:
  ...
  IntervalIterator(Function *M, bool OwnMemory) : IOwnMem(OwnMemory) {
    ...
    if (!ProcessInterval(&M->front())) {
      llvm37_unreachable("ProcessInterval should never fail for first interval!");
    }
  }
