//===- llvm37/Analysis/LoopInfo.h - Natural Loop Calculator -------*- C++ -*-===//
//
...
#ifndef LLVM37_ANALYSIS_LOOPINFO_H
#define LLVM37_ANALYSIS_LOOPINFO_H
...
public:
  ...
  /// Return the llvm37.loop loop id metadata node for this loop if it is present.
  ///
  /// If this loop contains the same llvm37.loop metadata on each branch to the
  /// header then the node is returned. If any latch instruction does not
  /// contain llvm37.loop or or if multiple latches contain different nodes then
  /// 0 is returned.
  MDNode *getLoopID() const;
  /// Set the llvm37.loop loop id metadata for this loop.
  ///
