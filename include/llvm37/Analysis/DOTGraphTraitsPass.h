...
#ifndef LLVM37_ANALYSIS_DOTGRAPHTRAITSPASS_H
#define LLVM37_ANALYSIS_DOTGRAPHTRAITSPASS_H
...
public:
  ...
  bool runOnFunction(Function &F) override {
    ...
    if (OSOverride != nullptr) {
      *OSOverride << "\ngraph: " << GraphName << ".dot\n";
      llvm37::WriteGraph(*OSOverride, Graph, false, Title);
      return false;
    }
    // HLSL Change Ends
  ...
  bool runOnFunction(Function &F) override {
    ...
    if (OSOverride != nullptr) {
      *OSOverride << "\ngraph: " << Name + "." + F.getName().str() + ".dot\n";
      llvm37::WriteGraph(*OSOverride, Graph, false, DOTGraphTraits<GraphT>::getGraphName(Graph));
      return false;
    }
    // HLSL Change Ends
