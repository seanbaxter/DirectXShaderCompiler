...
#ifndef LLVM37_ANALYSIS_MEMORYLOCATION_H
#define LLVM37_ANALYSIS_MEMORYLOCATION_H
...
///
/// The primary user of this interface is LLVM37's Alias Analysis, but other
...
public:
  ...
  static MemoryLocation get(const Instruction *Inst) {
    if (auto *I = dyn_cast<LoadInst>(Inst))
      ...
      return get(I);
    llvm37_unreachable("unsupported memory instruction");
  }
