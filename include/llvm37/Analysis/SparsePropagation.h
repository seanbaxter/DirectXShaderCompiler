...
#ifndef LLVM37_ANALYSIS_SPARSEPROPAGATION_H
#define LLVM37_ANALYSIS_SPARSEPROPAGATION_H
...
public:
  ...
  /// GetConstant - If the specified lattice value is representable as an LLVM37
  /// constant value, return it.  Otherwise return null.  The returned value
  /// must be in the same LLVM37 type as Val.
...
#endif // LLVM37_ANALYSIS_SPARSEPROPAGATION_H
