//===- llvm37/Analysis/ScalarEvolutionExpressions.h - SCEV Exprs --*- C++ -*-===//
//
...
#ifndef LLVM37_ANALYSIS_SCALAREVOLUTIONEXPRESSIONS_H
#define LLVM37_ANALYSIS_SCALAREVOLUTIONEXPRESSIONS_H
...
namespace llvm37 {
  ...
  /// value, and only represent it as its LLVM37 Value.  This is the "bottom"
  ...
  struct SCEVVisitor {
    ...
    RetVal visitCouldNotCompute(const SCEVCouldNotCompute *S) {
      llvm37_unreachable("Invalid use of SCEVCouldNotCompute!");
    }
  };
