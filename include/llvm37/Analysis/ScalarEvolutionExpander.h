//===---- llvm37/Analysis/ScalarEvolutionExpander.h - SCEV Exprs --*- C++ -*-===//
//
...
#ifndef LLVM37_ANALYSIS_SCALAREVOLUTIONEXPANDER_H
#define LLVM37_ANALYSIS_SCALAREVOLUTIONEXPANDER_H
...
namespace llvm37 {
  ...
  private:
    LLVM37Context &getContext() const { return SE.getContext(); }
