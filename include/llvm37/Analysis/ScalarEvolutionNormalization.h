//===- llvm37/Analysis/ScalarEvolutionNormalization.h - See below -*- C++ -*-===//
//
...
#ifndef LLVM37_ANALYSIS_SCALAREVOLUTIONNORMALIZATION_H
#define LLVM37_ANALYSIS_SCALAREVOLUTIONNORMALIZATION_H
