//===- llvm37/Analysis/MemoryDependenceAnalysis.h - Memory Deps  --*- C++ -*-===//
//
...
#ifndef LLVM37_ANALYSIS_MEMORYDEPENDENCEANALYSIS_H
#define LLVM37_ANALYSIS_MEMORYDEPENDENCEANALYSIS_H
