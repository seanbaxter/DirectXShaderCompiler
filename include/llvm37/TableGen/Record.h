//===- llvm37/TableGen/Record.h - Classes for Table Records -------*- C++ -*-===//
//
...
#ifndef LLVM37_TABLEGEN_RECORD_H
#define LLVM37_TABLEGEN_RECORD_H
...
protected:
  ...
  /// the recommendation in docs/HowToSetUpLLVM37StyleRTTI.rst.
  ///
...
public:
  ...
  Init *resolveListElementReference(Record &R, const RecordVal *RV,
    ...
    llvm37_unreachable("Illegal element reference off bits<n>");
  }
...
public:
  ...
  Init *resolveListElementReference(Record &R, const RecordVal *RV,
                                    unsigned Elt) const override {
    llvm37_unreachable("Illegal element reference off int");
  }
...
public:
  ...
  Init *resolveListElementReference(Record &R, const RecordVal *RV,
                                    unsigned Elt) const override {
    llvm37_unreachable("Illegal element reference off string");
  }

  Init *getBit(unsigned Bit) const override {
    llvm37_unreachable("Illegal bit reference off string");
  }
};
...
public:
  ...
  Init *getBit(unsigned Bit) const override {
    llvm37_unreachable("Illegal bit reference off list");
  }
};
...
public:
  ...
  Init *getOperand(unsigned i) const override {
    switch (i) {
    default: llvm37_unreachable("Invalid operand id for binary operator");
...
public:
  ...
  Init *getOperand(unsigned i) const override {
    switch (i) {
    default: llvm37_unreachable("Invalid operand id for ternary operator");
    case 0: return getLHS();
...
public:
  ...
  Init *getBit(unsigned Bit) const override {
    llvm37_unreachable("Illegal bit reference off def");
  }
  ...
  Init *resolveListElementReference(Record &R, const RecordVal *RV,
                                    unsigned Elt) const override {
    llvm37_unreachable("Illegal element reference off def");
  }
};
...
public:
  ...
  Init *getBit(unsigned Bit) const override {
    llvm37_unreachable("Illegal bit reference off dag");
  }

  Init *resolveListElementReference(Record &R, const RecordVal *RV,
                                    unsigned Elt) const override {
    llvm37_unreachable("Illegal element reference off dag");
  }
};
...
public:
  ...
  void removeValue(Init *Name) {
    ...
    llvm37_unreachable("Cannot remove an entry that does not exist!");
  }
