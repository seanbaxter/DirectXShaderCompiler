//===-- llvm37/LineEditor/LineEditor.h - line editor --------------*- C++ -*-===//
//
...
#ifndef LLVM37_LINEEDITOR_LINEEDITOR_H
#define LLVM37_LINEEDITOR_LINEEDITOR_H
...
public:
  ...
  /// Reads a line.
  ///
  /// \return The line, or llvm37::Optional<std::string>() on EOF.
  llvm37::Optional<std::string> readLine() const;
