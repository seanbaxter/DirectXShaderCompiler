//===-- llvm37/Support/GraphWriter.h - Write graph to a .dot file -*- C++ -*-===//
//
...
// LLVM37 graphs to ".dot" files.  "dot" is a tool that is part of the AT&T
...
#ifndef LLVM37_SUPPORT_GRAPHWRITER_H
#define LLVM37_SUPPORT_GRAPHWRITER_H

#include "llvm37/ADT/GraphTraits.h"
#include "llvm37/ADT/Twine.h"
#include "llvm37/Support/DOTGraphTraits.h"
...
std::string WriteGraph(const GraphType &G, const Twine &Name,
  ...
  llvm37::WriteGraph(O, G, ShortNames, Title);
  errs() << " done. \n";
...
void ViewGraph(const GraphType &G, const Twine &Name,
               bool ShortNames = false, const Twine &Title = "",
               GraphProgram::Name Program = GraphProgram::DOT) {
  std::string Filename = llvm37::WriteGraph(G, Name, ShortNames, Title);
