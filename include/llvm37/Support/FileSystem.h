//===- llvm37/Support/FileSystem.h - File System OS Concept -------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the llvm37::sys::fs namespace. It is designed after
...
#ifndef LLVM37_SUPPORT_FILESYSTEM_H
#define LLVM37_SUPPORT_FILESYSTEM_H
...
{
private:
  ::llvm37::sys::fs::MSFileSystem* m_pOrigValue;
  std::error_code ec;
public:
  AutoPerThreadSystem(_In_ ::llvm37::sys::fs::MSFileSystem *value)
      : m_pOrigValue(::llvm37::sys::fs::GetCurrentThreadFileSystem()) {
    SetCurrentThreadFileSystem(nullptr);
    ec = ::llvm37::sys::fs::SetCurrentThreadFileSystem(value);
  }

  ~AutoPerThreadSystem()
  {
    if (m_pOrigValue) {
      ::llvm37::sys::fs::SetCurrentThreadFileSystem(nullptr);
      ::llvm37::sys::fs::SetCurrentThreadFileSystem(m_pOrigValue);
    } else if (!ec) {
      ::llvm37::sys::fs::SetCurrentThreadFileSystem(nullptr);
    }
  }
