//==- llvm37/Support/RandomNumberGenerator.h - RNG for diversity ---*- C++ -*-==//
//
...
#ifndef LLVM37_SUPPORT_RANDOMNUMBERGENERATOR_H_
#define LLVM37_SUPPORT_RANDOMNUMBERGENERATOR_H_

#include "llvm37/ADT/StringRef.h"
#include "llvm37/Support/Compiler.h"
#include "llvm37/Support/DataTypes.h" // Needed for uint64_t on Windows.
#include <random>
