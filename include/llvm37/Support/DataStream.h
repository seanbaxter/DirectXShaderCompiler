//===---- llvm37/Support/DataStream.h - Lazy bitcode streaming ----*- C++ -*-===//
//
...
#ifndef LLVM37_SUPPORT_DATASTREAM_H
#define LLVM37_SUPPORT_DATASTREAM_H
...
#endif  // LLVM37_SUPPORT_DATASTREAM_H_
