...
/// of these conform to an LLVM37 "Allocator" concept which consists of an
/// Allocate method accepting a size and alignment, and a Deallocate accepting
/// a pointer and size. Further, the LLVM37 "Allocator" concept has overloads of
...
#ifndef LLVM37_SUPPORT_ALLOCATOR_H
#define LLVM37_SUPPORT_ALLOCATOR_H
...
/// Allocate() methods of LLVM37-style allocators.
///
/// This base class both documents the full public interface exposed by all
/// LLVM37-style allocators, and redirects all of the overloads to a single core
...
public:
  ...
  LLVM37_ATTRIBUTE_RETURNS_NONNULL void *Allocate(size_t Size,
                                                size_t /*Alignment*/) {
...
public:
  ...
  LLVM37_ATTRIBUTE_RETURNS_NONNULL LLVM37_ATTRIBUTE_RETURNS_NOALIAS void *
...
void *operator new(size_t Size,
                   llvm37::BumpPtrAllocatorImpl<AllocatorT, SlabSize,
  ...
  return Allocator.Allocate(
      Size, std::min((size_t)llvm37::NextPowerOf2(Size), offsetof(S, x)));
}

template <typename AllocatorT, size_t SlabSize, size_t SizeThreshold>
void operator delete(
    void *, llvm37::BumpPtrAllocatorImpl<AllocatorT, SlabSize, SizeThreshold> &) {
}

#endif // LLVM37_SUPPORT_ALLOCATOR_H
