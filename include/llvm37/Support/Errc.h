//===- llvm37/Support/Errc.h - Defines the llvm37::errc enum --------*- C++ -*-===//
//
...
#ifndef LLVM37_SUPPORT_ERRC_H
#define LLVM37_SUPPORT_ERRC_H
...
namespace std {
template <> struct is_error_code_enum<llvm37::errc> : std::true_type {};
}
#endif
