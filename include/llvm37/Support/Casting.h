//===-- llvm37/Support/Casting.h - Allow flexible, checked, casts -*- C++ -*-===//
//
...
#ifndef LLVM37_SUPPORT_CASTING_H
#define LLVM37_SUPPORT_CASTING_H
...
LLVM37_ATTRIBUTE_UNUSED_RESULT inline bool isa(const Y &Val) {
...
//
template <class X, class Y>
LLVM37_ATTRIBUTE_UNUSED_RESULT inline typename std::enable_if<
...
template <class X, class Y>
LLVM37_ATTRIBUTE_UNUSED_RESULT inline typename cast_retty<X, Y *>::ret_type
cast_or_null(Y *Val) {
