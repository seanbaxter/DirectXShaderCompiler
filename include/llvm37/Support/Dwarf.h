//===-- llvm37/Support/Dwarf.h ---Dwarf Constants------------------*- C++ -*-===//
//
...
#ifndef LLVM37_SUPPORT_DWARF_H
#define LLVM37_SUPPORT_DWARF_H
...
enum LLVM37Constants : uint32_t {
  // LLVM37 mock tags (see also llvm37/Support/Dwarf.def).
...
enum Attribute : uint16_t {
  ...
  // LLVM37 project extensions.
  DW_AT_LLVM37_include_path = 0x3e00,
  DW_AT_LLVM37_config_macros = 0x3e01,
  DW_AT_LLVM37_isysroot = 0x3e02,
