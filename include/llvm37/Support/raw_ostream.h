...
#ifndef LLVM37_SUPPORT_RAW_OSTREAM_H
#define LLVM37_SUPPORT_RAW_OSTREAM_H
...
public:
  ...
  raw_ostream &operator<<(const llvm37::SmallVectorImpl<char> &Str) {
...
public:
  ~STDStreamCloser()
  {
    llvm37::raw_fd_ostream& fo = static_cast<llvm37::raw_fd_ostream&>(llvm37::outs());
    llvm37::raw_fd_ostream& fe = static_cast<llvm37::raw_fd_ostream&>(llvm37::errs());
    fo.flush();
    fe.flush();
    fo.close();
