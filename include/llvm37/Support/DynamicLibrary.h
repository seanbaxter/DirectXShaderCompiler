//===-- llvm37/Support/DynamicLibrary.h - Portable Dynamic Library -*- C++ -*-===//
//
...
#ifndef LLVM37_SUPPORT_DYNAMICLIBRARY_H
#define LLVM37_SUPPORT_DYNAMICLIBRARY_H
...
namespace sys {
  ...
  /// or for unloading libraries when the LLVM37 library is unloaded.
