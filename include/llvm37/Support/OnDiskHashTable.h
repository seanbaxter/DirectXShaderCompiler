...
///
//===----------------------------------------------------------------------===//
#ifndef LLVM37_SUPPORT_ONDISKHASHTABLE_H
#define LLVM37_SUPPORT_ONDISKHASHTABLE_H
...
template <typename Info> class OnDiskChainedHashTableGenerator {
  ...
  llvm37::SpecificBumpPtrAllocator<Item> BA;
...
public:
  ...
  offset_type Emit(raw_ostream &Out, Info &InfoObj) {
    ...
    uint64_t N = llvm37::OffsetToAlignment(TableOff, alignOf<offset_type>());
    TableOff += N;
    while (N--)
      LE.write<uint8_t>(0);
...
///
/// \copydetails llvm37::OnDiskChainedHashTable
