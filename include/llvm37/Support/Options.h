//===- llvm37/Support/Options.h - Debug options support -----------*- C++ -*-===//
//
...
/// }
///
/// When reading data for options the interface is via the LLVM37Context. Option
...
#ifndef LLVM37_SUPPORT_OPTIONS_H
#define LLVM37_SUPPORT_OPTIONS_H
