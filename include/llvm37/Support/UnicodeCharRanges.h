...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM37_SUPPORT_UNICODECHARRANGES_H
#define LLVM37_SUPPORT_UNICODECHARRANGES_H
...
#ifdef NDEBUG
  LLVM37_CONSTEXPR UnicodeCharSet(CharRanges Ranges) : Ranges(Ranges) {}
#else
...
#endif // LLVM37_SUPPORT_UNICODECHARRANGES_H
