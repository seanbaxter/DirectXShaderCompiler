...
/// tree over a generic graph. This is used typically in LLVM37 for fast
/// dominance queries on the CFG, but is fully generic w.r.t. the underlying
/// graph types.
///
//===----------------------------------------------------------------------===//

#ifndef LLVM37_SUPPORT_GENERICDOMTREE_H
#define LLVM37_SUPPORT_GENERICDOMTREE_H
...
/// various graphs in the LLVM37 IR or in the code generator.
...
public:
  ...
  DomTreeNodeBase<NodeT> *addNewBlock(NodeT *BB, NodeT *DomBB) {
    ...
    return (DomTreeNodes[BB] = IDomNode->addChild(
                llvm37::make_unique<DomTreeNodeBase<NodeT>>(BB, IDomNode))).get();
  }
