...
#ifndef LLVM37_SUPPORT_FILEOUTPUTBUFFER_H
#define LLVM37_SUPPORT_FILEOUTPUTBUFFER_H
...
private:
  ...
  FileOutputBuffer(std::unique_ptr<llvm37::sys::fs::mapped_file_region> R,
                   StringRef Path, StringRef TempPath);

  std::unique_ptr<llvm37::sys::fs::mapped_file_region> Region;
