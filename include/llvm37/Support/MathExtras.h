//===-- llvm37/Support/MathExtras.h - Useful math functions -------*- C++ -*-===//
//
...
#ifndef LLVM37_SUPPORT_MATHEXTRAS_H
#define LLVM37_SUPPORT_MATHEXTRAS_H
...
#if __has_builtin(__builtin_ctz) || LLVM37_GNUC_PREREQ(4, 0, 0)
...
#if __has_builtin(__builtin_ctzll) || LLVM37_GNUC_PREREQ(4, 0, 0)
...
#if __has_builtin(__builtin_clz) || LLVM37_GNUC_PREREQ(4, 0, 0)
...
#if __has_builtin(__builtin_clzll) || LLVM37_GNUC_PREREQ(4, 0, 0)
...
template <typename T> T findLastSet(T Val, ZeroBehavior ZB = ZB_Max) {
  ...
  // Use ^ instead of - because both gcc and llvm37 can remove the associated ^
