...
#ifndef LLVM37_SUPPORT_YAMLTRAITS_H
#define LLVM37_SUPPORT_YAMLTRAITS_H
...
///      static void output(const MyType &val, void*, llvm37::raw_ostream &out) {
///        // stream out custom formatting
///        out << llvm37::format("%x", val);
///      }
...
struct ScalarTraits {
  ...
  //static void output(const T &value, void *ctxt, llvm37::raw_ostream &out);
  //
...
///      static void output(const MyType &Value, void*, llvm37::raw_ostream &Out)
///      {
///        // stream out custom formatting
///        Out << Val;
///      }
...
struct BlockScalarTraits {
  ...
  //
  // Function to write the value as a string:
  // static void output(const T &Value, void *ctx, llvm37::raw_ostream &Out);
  //
  // Function to convert a string to a value.  Returns the empty
  // StringRef on success or an error string if string is malformed:
  // static StringRef input(StringRef Scalar, void *ctxt, T &Value);
...
struct has_ScalarTraits
{
  ...
  typedef void (*Signature_output)(const T&, void*, llvm37::raw_ostream&);
...
public:
  ...
  // allow anonymous enum values to be used with LLVM37_YAML_STRONG_TYPEDEF
  template <typename T>
...
yamlize(IO &io, T &Val, bool) {
  if ( io.outputting() ) {
    std::string Storage;
    llvm37::raw_string_ostream Buffer(Storage);
    ...
    if ( !Result.empty() ) {
      io.setError(llvm37::Twine(Result));
    }
  }
}
...
yamlize(IO &YamlIO, T &Val, bool) {
  if (YamlIO.outputting()) {
    ...
    if (!Result.empty())
      YamlIO.setError(llvm37::Twine(Result));
  }
}
...
struct ScalarTraits<bool> {
  static void output(const bool &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<StringRef> {
  static void output(const StringRef &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<std::string> {
  static void output(const std::string &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<uint8_t> {
  static void output(const uint8_t &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<uint16_t> {
  static void output(const uint16_t &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<uint32_t> {
  static void output(const uint32_t &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<uint64_t> {
  static void output(const uint64_t &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<int8_t> {
  static void output(const int8_t &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<int16_t> {
  static void output(const int16_t &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<int32_t> {
  static void output(const int32_t &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<int64_t> {
  static void output(const int64_t &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<float> {
  static void output(const float &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<double> {
  static void output(const double &, void*, llvm37::raw_ostream &);
...
private:
  typedef llvm37::AlignedCharArrayUnion<TNorm> Storage;
...
private:
  ...
  public:
    ...
    typedef llvm37::StringMap<std::unique_ptr<HNode>> NameToNode;

    bool isValidKey(StringRef key);

    NameToNode                        Mapping;
    llvm37::SmallVector<const char*, 6> ValidKeys;
  };
...
private:
  llvm37::SourceMgr                     SrcMgr; // must be before Strm
  std::unique_ptr<llvm37::yaml::Stream> Strm;
  std::unique_ptr<HNode>              TopNode;
  std::error_code                     EC;
  llvm37::BumpPtrAllocator              StringAllocator;
  llvm37::yaml::document_iterator       DocIterator;
...
public:
  Output(llvm37::raw_ostream &, void *Ctxt = nullptr, int WrapColumn = 70);
  ~Output() override;
...
#define LLVM37_YAML_STRONG_TYPEDEF(_base, _type)                                 \
    struct _type {                                                             \
        _type() { }                                                            \
...
///
LLVM37_YAML_STRONG_TYPEDEF(uint8_t, Hex8)
LLVM37_YAML_STRONG_TYPEDEF(uint16_t, Hex16)
LLVM37_YAML_STRONG_TYPEDEF(uint32_t, Hex32)
LLVM37_YAML_STRONG_TYPEDEF(uint64_t, Hex64)


template<>
struct ScalarTraits<Hex8> {
  static void output(const Hex8 &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<Hex16> {
  static void output(const Hex16 &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<Hex32> {
  static void output(const Hex32 &, void*, llvm37::raw_ostream &);
...
struct ScalarTraits<Hex64> {
  static void output(const Hex64 &, void*, llvm37::raw_ostream &);
...
#define LLVM37_YAML_IS_SEQUENCE_VECTOR(_type)                                 \
  namespace llvm37 {                                                          \
  namespace yaml {                                                          \
    template<>                                                              \
...
#define LLVM37_YAML_IS_FLOW_SEQUENCE_VECTOR(_type)                            \
  namespace llvm37 {                                                          \
  namespace yaml {                                                          \
    template<>                                                              \
    struct SequenceTraits< std::vector<_type> > {                           \
...
#define LLVM37_YAML_IS_DOCUMENT_LIST_VECTOR(_type)                            \
  namespace llvm37 {                                                          \
  namespace yaml {                                                          \
    template<>                                                              \
...
#endif // LLVM37_SUPPORT_YAMLTRAITS_H
