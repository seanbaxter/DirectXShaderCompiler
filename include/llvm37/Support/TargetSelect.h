...
#define LLVM37_TARGET(TargetName) void LLVMInitialize##TargetName##TargetInfo();
#include "llvm37/Config/Targets.def"

#define LLVM37_TARGET(TargetName) void LLVMInitialize##TargetName##Target();
#include "llvm37/Config/Targets.def"
  
  // Declare all of the target-MC-initialization functions that are available.
#define LLVM37_TARGET(TargetName) void LLVMInitialize##TargetName##TargetMC();
#include "llvm37/Config/Targets.def"
  
  // Declare all of the available assembly printer initialization functions.
#define LLVM37_ASM_PRINTER(TargetName) void LLVMInitialize##TargetName##AsmPrinter();
#include "llvm37/Config/AsmPrinters.def"

  // Declare all of the available assembly parser initialization functions.
#define LLVM37_ASM_PARSER(TargetName) void LLVMInitialize##TargetName##AsmParser();
...
#define LLVM37_DISASSEMBLER(TargetName) LLVMInitialize##TargetName##Disassembler();
#include "llvm37/Config/Disassemblers.def"
  }
