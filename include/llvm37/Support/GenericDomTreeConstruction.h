...
#ifndef LLVM37_SUPPORT_GENERICDOMTREECONSTRUCTION_H
#define LLVM37_SUPPORT_GENERICDOMTREECONSTRUCTION_H
...
void Calculate(DominatorTreeBase<typename GraphTraits<NodeT>::NodeType>& DT,
  ...
  DT.RootNode =
      (DT.DomTreeNodes[Root] =
           llvm37::make_unique<DomTreeNodeBase<typename GraphT::NodeType>>(
               Root, nullptr)).get();
