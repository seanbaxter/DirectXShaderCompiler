//===- llvm37/Support/ScaledNumber.h - Support for scaled numbers -*- C++ -*-===//
//
...
// the wrong place.  Look at include/llvm37/ADT/APFloat.h instead.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_SUPPORT_SCALEDNUMBER_H
#define LLVM37_SUPPORT_SCALEDNUMBER_H
