//===- llvm37/Support/CommandLine.h - Command line handler --------*- C++ -*-===//
//
...
#ifndef LLVM37_SUPPORT_COMMANDLINE_H
#define LLVM37_SUPPORT_COMMANDLINE_H
...
///===---------------------------------------------------------------------===//
/// SetVersionPrinter - Override the default (LLVM37 specific) version printer
...
///                          which will be called after the basic LLVM37 version
...
struct OptionValueBase : public GenericOptionValue {
  ...
  const DataType &getValue() const { llvm37_unreachable("no default value"); }
...
template <class DataType>
ValuesClass<DataType> LLVM37_END_WITH_NULL
...
/// StringMap<llvm37::cl::Option*> &opts = llvm37::cl::getRegisteredOptions();
...
/// llvm37::cl::ParseCommandLineOptions().
///
