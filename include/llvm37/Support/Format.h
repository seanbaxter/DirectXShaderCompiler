...
// LLVM37 subsystems to provide printf-style formatting.  This gives all the power
...
#ifndef LLVM37_SUPPORT_FORMAT_H
#define LLVM37_SUPPORT_FORMAT_H
...
class format_object final : public format_object_base {
  ...
  int snprint_tuple(char *Buffer, unsigned BufferSize,
    ...
    // caller, for example llvm37::format_object_base::print(char * Buffer, unsigned int BufferSize)
