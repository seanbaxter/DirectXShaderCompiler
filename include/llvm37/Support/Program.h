...
//===----------------------------------------------------------------------===//
//
// This file declares the llvm37::sys::Program class.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_SUPPORT_PROGRAM_H
#define LLVM37_SUPPORT_PROGRAM_H
...
#error "ProcessInfo is not defined for this platform!"
  ...
  /// entry individually so should generally be avoided. Core LLVM37 library
  ...
  enum WindowsEncodingMethod {
    /// UTF-8 is the LLVM37 native encoding, being the same as "do not perform
    /// encoding conversion".
    WEM_UTF8,
    WEM_CurrentCodePage,
    WEM_UTF16
  ...
  /// different from the one used in LLVM37 (UTF-8). We use this when writing
