...
#ifndef LLVM37_SUPPORT_TARGETREGISTRY_H
#define LLVM37_SUPPORT_TARGETREGISTRY_H
...
public:
  ...
  typedef TargetMachine *(*TargetMachineCtorTy)(
      ...
      CodeGenOpt::Level OL);
  // If it weren't for layering issues (this header is in llvm37/Support, but
  ...
  typedef MCSymbolizer *(*MCSymbolizerCtorTy)(
      const Triple &TT, LLVM37OpInfoCallback GetOpInfo,
      LLVM37SymbolLookupCallback SymbolLookUp, void *DisInfo, MCContext *Ctx,
      std::unique_ptr<MCRelocationInfo> &&RelInfo);
...
private:
  ...
  /// MCRelocationInfo, if registered (default = llvm37::createMCRelocationInfo)
  MCRelocationInfoCtorTy MCRelocationInfoCtorFn;

  /// MCSymbolizerCtorFn - Construction function for this target's
  /// MCSymbolizer, if registered (default = llvm37::createMCSymbolizer)
...
public:
  ...
  MCStreamer *createMCObjectStreamer(const Triple &T, MCContext &Ctx,
    ...
    default:
      llvm37_unreachable("Unknown object format");
    case Triple::COFF:
  ...
  MCStreamer *createAsmStreamer(MCContext &Ctx,
    ...
    MCStreamer *S = llvm37::createAsmStreamer(Ctx, std::move(OS), IsVerboseAsm,
  ...
  MCStreamer *createNullStreamer(MCContext &Ctx) const {
    MCStreamer *S = llvm37::createNullStreamer(Ctx);
  ...
  /// ownership.
  MCSymbolizer *
  createMCSymbolizer(StringRef TT, LLVM37OpInfoCallback GetOpInfo,
                     LLVM37SymbolLookupCallback SymbolLookUp, void *DisInfo,
                     MCContext *Ctx,
                     std::unique_ptr<MCRelocationInfo> &&RelInfo) const {
    MCSymbolizerCtorTy Fn =
        MCSymbolizerCtorFn ? MCSymbolizerCtorFn : llvm37::createMCSymbolizer;
...
///
/// extern "C" void LLVM37InitializeFooTargetInfo() {
...
///
/// extern "C" void LLVM37InitializeFooTarget() {
...
///
/// extern "C" void LLVM37InitializeFooMCAsmBackend() {
///   extern Target TheFooTarget;
...
/// function. Usage:
///
/// extern "C" void LLVM37InitializeFooMCAsmParser() {
///   extern Target TheFooTarget;
...
/// function. Usage:
///
/// extern "C" void LLVM37InitializeFooAsmPrinter() {
///   extern Target TheFooTarget;
...
/// function. Usage:
///
/// extern "C" void LLVM37InitializeFooMCCodeEmitter() {
///   extern Target TheFooTarget;
