//===-- llvm37/Support/MachO.h - The MachO file format ------------*- C++ -*-===//
//
...
#ifndef LLVM37_SUPPORT_MACHO_H
#define LLVM37_SUPPORT_MACHO_H
...
namespace llvm37 {
  namespace MachO {
    ...
    enum : uint32_t {
      // Constants for the "magic" field in llvm37::MachO::mach_header and
      // llvm37::MachO::mach_header_64
    ...
    enum HeaderFileType {
      // Constants for the "filetype" field in llvm37::MachO::mach_header and
      // llvm37::MachO::mach_header_64
      MH_OBJECT      = 0x1u,
      MH_EXECUTE     = 0x2u,
      MH_FVMLIB      = 0x3u,
    ...
    enum {
      // Constant bits for the "flags" field in llvm37::MachO::mach_header and
      // llvm37::MachO::mach_header_64
    ...
    enum : uint32_t {
      // Flags for the "cmd" field in llvm37::MachO::load_command
      LC_REQ_DYLD    = 0x80000000u
    };

    enum LoadCommandType : uint32_t {
      // Constants for the "cmd" field in llvm37::MachO::load_command
    ...
    enum : uint32_t {
      // Constant bits for the "flags" field in llvm37::MachO::segment_command
      SG_HIGHVM              = 0x1u,
      SG_FVMLIB              = 0x2u,
      SG_NORELOC             = 0x4u,
      ...
      // Constant masks for the "flags" field in llvm37::MachO::section and
      // llvm37::MachO::section_64
    ...
    enum SectionType : uint32_t {
      // Constant masks for the "flags[7:0]" field in llvm37::MachO::section and
      // llvm37::MachO::section_64 (mask "flags" with SECTION_TYPE)
    ...
    enum : uint32_t {
      // Constant masks for the "flags[31:24]" field in llvm37::MachO::section and
      // llvm37::MachO::section_64 (mask "flags" with SECTION_ATTRIBUTES_USR)
      ...
      // Constant masks for the "flags[23:8]" field in llvm37::MachO::section and
      // llvm37::MachO::section_64 (mask "flags" with SECTION_ATTRIBUTES_SYS)
    ...
    enum {
      // Constant masks for the "n_type" field in llvm37::MachO::nlist and
      // llvm37::MachO::nlist_64
      N_STAB = 0xe0,
      N_PEXT = 0x10,
      N_TYPE = 0x0e,
      N_EXT  = 0x01
    ...
    enum NListType {
      // Constants for the "n_type & N_TYPE" llvm37::MachO::nlist and
      // llvm37::MachO::nlist_64
      N_UNDF = 0x0u,
      N_ABS  = 0x2u,
      N_SECT = 0xeu,
    ...
    enum SectionOrdinal {
      // Constants for the "n_sect" field in llvm37::MachO::nlist and
      // llvm37::MachO::nlist_64
      NO_SECT  = 0u,
      MAX_SECT = 0xffu
    };
    ...
    enum {
      // Constant masks for the "n_desc" field in llvm37::MachO::nlist and
      // llvm37::MachO::nlist_64
    ...
    enum StabType {
      // Constant values for the "n_type" field in llvm37::MachO::nlist and
      // llvm37::MachO::nlist_64 when "(n_type & N_STAB) != 0"
      N_GSYM    = 0x20u,
      N_FNAME   = 0x22u,
      N_FUN     = 0x24u,
      N_STSYM   = 0x26u,
    ...
    enum : uint32_t {
      ...
      // llvm37::MachO::relocation_info structure when r_extern is 0.
      R_ABS = 0,

      // Constant bits for the r_address field in an
      // llvm37::MachO::relocation_info structure.
      R_SCATTERED = 0x80000000
    };

    enum RelocationInfoType {
      // Constant values for the r_type field in an
      // llvm37::MachO::relocation_info or llvm37::MachO::scattered_relocation_info
      // structure.
    ...
    // Structs NOT from <mach-o/reloc.h>, but that make LLVM37's life easier
