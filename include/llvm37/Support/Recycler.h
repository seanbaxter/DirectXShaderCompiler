//==- llvm37/Support/Recycler.h - Recycling Allocator --------------*- C++ -*-==//
//
...
#ifndef LLVM37_SUPPORT_RECYCLER_H
#define LLVM37_SUPPORT_RECYCLER_H
...
struct ilist_traits<RecyclerStruct> :
  ...
  static void deleteNode(RecyclerStruct *) {
    llvm37_unreachable("Recycler's ilist_traits shouldn't see a deleteNode call!");
  }
};
