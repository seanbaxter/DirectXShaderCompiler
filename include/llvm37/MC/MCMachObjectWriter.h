//===-- llvm37/MC/MCMachObjectWriter.h - Mach Object Writer -------*- C++ -*-===//
//
...
#ifndef LLVM37_MC_MCMACHOBJECTWRITER_H
#define LLVM37_MC_MCMACHOBJECTWRITER_H
...
class MachObjectWriter : public MCObjectWriter {
  ...
  llvm37::DenseMap<const MCSection *, std::vector<RelAndSymbol>> Relocations;
  llvm37::DenseMap<const MCSection *, unsigned> IndirectSymBase;
