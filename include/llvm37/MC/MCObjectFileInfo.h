//===-- llvm37/MC/MCObjectFileInfo.h - Object File Info -----------*- C++ -*-===//
//
...
#ifndef LLVM37_MC_MCOBJECTFILEINFO_H
#define LLVM37_MC_MCOBJECTFILEINFO_H
...
public:
  ...
  LLVM37_ATTRIBUTE_DEPRECATED(
      void InitMCObjectFileInfo(StringRef TT, Reloc::Model RM,
                                CodeModel::Model CM, MCContext &ctx),
      "StringRef GNU Triple argument replaced by a llvm37::Triple object");
