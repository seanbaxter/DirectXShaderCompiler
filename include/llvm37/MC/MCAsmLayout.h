...
#ifndef LLVM37_MC_MCASMLAYOUT_H
#define LLVM37_MC_MCASMLAYOUT_H
...
class MCAsmLayout {
  ...
  llvm37::SmallVector<MCSection *, 16> SectionOrder;
...
public:
  ...
  llvm37::SmallVectorImpl<MCSection *> &getSectionOrder() { return SectionOrder; }
  const llvm37::SmallVectorImpl<MCSection *> &getSectionOrder() const {
    return SectionOrder;
  }
