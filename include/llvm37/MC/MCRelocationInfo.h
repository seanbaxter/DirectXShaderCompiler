//==-- llvm37/MC/MCRelocationInfo.h --------------------------------*- C++ -*-==//
//
...
#ifndef LLVM37_MC_MCRELOCATIONINFO_H
#define LLVM37_MC_MCRELOCATIONINFO_H
...
public:
  ...
  /// The VariantKinds are defined in llvm37-c/Disassembler.h.
