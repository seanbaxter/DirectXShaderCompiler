//===-- llvm37/MC/MCAsmBackend.h - MC Asm Backend -----------------*- C++ -*-===//
//
...
#ifndef LLVM37_MC_MCASMBACKEND_H
#define LLVM37_MC_MCASMBACKEND_H

#include "llvm37/ADT/ArrayRef.h"
#include "llvm37/MC/MCDirectives.h"
#include "llvm37/MC/MCDwarf.h"
#include "llvm37/MC/MCFixup.h"
...
public:
  ...
  virtual MCELFObjectTargetWriter *createELFObjectTargetWriter() const {
    llvm37_unreachable("createELFObjectTargetWriter is not supported by asm "
                     "backend");
  }
