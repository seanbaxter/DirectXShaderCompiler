...
#ifndef LLVM37_MC_MCCONTEXT_H
#define LLVM37_MC_MCCONTEXT_H
...
namespace llvm37 {
  ...
  public:
    ...
    ///
    /// \param Idx - The index of a local variable passed to @llvm37.localescape.
    ...
    LLVM37_ATTRIBUTE_NORETURN void reportFatalError(SMLoc L,
...
inline void *operator new(size_t Bytes, llvm37::MCContext &C,
...
inline void operator delete(void *Ptr, llvm37::MCContext &C, size_t)
              throw () {
  C.deallocate(Ptr);
}
...
/// is called implicitly by the compiler if a placement new[] expression using
/// the MCContext throws in the object constructor.
inline void operator delete[](void *Ptr, llvm37::MCContext &C) throw () {
  C.deallocate(Ptr);
}
