//===-- llvm37/MC/MCFixup.h - Instruction Relocation and Patching -*- C++ -*-===//
//
...
#ifndef LLVM37_MC_MCFIXUP_H
#define LLVM37_MC_MCFIXUP_H
...
public:
  ...
  static MCFixupKind getKindForSize(unsigned Size, bool isPCRel) {
    switch (Size) {
    default: llvm37_unreachable("Invalid generic fixup size!");
