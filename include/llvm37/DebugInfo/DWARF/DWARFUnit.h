...
#ifndef LLVM37_LIB_DEBUGINFO_DWARFUNIT_H
#define LLVM37_LIB_DEBUGINFO_DWARFUNIT_H

#include "llvm37/ADT/STLExtras.h"
#include "llvm37/DebugInfo/DWARF/DWARFDebugAbbrev.h"
#include "llvm37/DebugInfo/DWARF/DWARFDebugInfoEntry.h"
#include "llvm37/DebugInfo/DWARF/DWARFDebugRangeList.h"
#include "llvm37/DebugInfo/DWARF/DWARFRelocMap.h"
#include "llvm37/DebugInfo/DWARF/DWARFSection.h"
#include <vector>
...
public:
  ...
  typedef llvm37::SmallVectorImpl<std::unique_ptr<UnitType>> UnitVector;
  typedef typename UnitVector::iterator iterator;
  typedef llvm37::iterator_range<typename UnitVector::iterator> iterator_range;
...
private:
  void parseImpl(DWARFContext &Context, const DWARFSection &Section,
    ...
    while (Data.isValidOffset(Offset)) {
      auto U = llvm37::make_unique<UnitType>(Context, Section, DA, RS, SS, SOS,
                                           AOS, LE, *this);
