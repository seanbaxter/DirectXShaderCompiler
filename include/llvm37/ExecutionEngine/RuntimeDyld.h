...
#ifndef LLVM37_EXECUTIONENGINE_RUNTIMEDYLD_H
#define LLVM37_EXECUTIONENGINE_RUNTIMEDYLD_H
...
public:
  ...
  class LoadedObjectInfo : public llvm37::LoadedObjectInfo {
  ...
  template <typename Derived> struct LoadedObjectInfoHelper : LoadedObjectInfo {
    ...
    std::unique_ptr<llvm37::LoadedObjectInfo> clone() const override {
