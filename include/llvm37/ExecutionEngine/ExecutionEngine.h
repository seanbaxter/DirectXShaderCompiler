...
#ifndef LLVM37_EXECUTIONENGINE_EXECUTIONENGINE_H
#define LLVM37_EXECUTIONENGINE_EXECUTIONENGINE_H
...
private:
  ...
  /// GlobalAddressMap - A mapping between LLVM37 global symbol names values and
  /// their actualized version...
  GlobalAddressMapTy GlobalAddressMap;

  /// GlobalAddressReverseMap - This is the reverse mapping of GlobalAddressMap,
  /// used to convert raw addresses into the LLVM37 global value that is emitted
...
/// \brief Abstract interface for implementation execution of LLVM37 modules,
...
public:
  ...
  virtual void mapSectionAddress(const void *LocalAddress,
    ...
    llvm37_unreachable("Re-mapping of section addresses not supported with this "
                     "EE!");
  }
  ...
  /// used by clients of the EE that want to have an LLVM37 global overlay
  ...
  /// getGlobalValueAtAddress - Return the LLVM37 global value object that starts
  ...
  virtual void setObjectCache(ObjectCache *) {
    llvm37_unreachable("No support for an object cache");
  }
  ...
  virtual void setProcessAllSections(bool ProcessAllSections) {
    llvm37_unreachable("No support for ProcessAllSections option");
  }
  ...
  /// stub, and 2) any thread modifying LLVM37 IR must hold the JIT's lock
  /// (ExecutionEngine::lock) or otherwise ensure that no other thread calls a
  /// lazy stub.  See http://llvm37.org/PR5184 for details.
...
DEFINE_SIMPLE_CONVERSION_FUNCTIONS(ExecutionEngine, LLVM37ExecutionEngineRef)
