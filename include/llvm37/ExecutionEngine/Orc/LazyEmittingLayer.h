...
#ifndef LLVM37_EXECUTIONENGINE_ORC_LAZYEMITTINGLAYER_H
#define LLVM37_EXECUTIONENGINE_ORC_LAZYEMITTINGLAYER_H
...
///
///   This layer accepts sets of LLVM37 IR Modules (via addModuleSet), but does
...
private:
  ...
  public:
    ...
    JITSymbol find(StringRef Name, bool ExportedSymbolsOnly, BaseLayerT &B) {
      ...
      llvm37_unreachable("Invalid emit-state.");
    }
  ...
  private:
    ...
    const GlobalValue* buildMangledSymbols(StringRef SearchName,
      ...
      auto Symbols = llvm37::make_unique<StringMap<const GlobalValue*>>();
...
LazyEmittingLayer<BaseLayerT>::EmissionDeferredSet::create(
  ...
  typedef EmissionDeferredSetImpl<ModuleSetT, MemoryManagerPtrT, SymbolResolverPtrT>
    EDS;
  return llvm37::make_unique<EDS>(std::move(Ms), std::move(MemMgr),
                                std::move(Resolver));
}
...
#endif // LLVM37_EXECUTIONENGINE_ORC_LAZYEMITTINGLAYER_H
