...
#ifndef LLVM37_EXECUTIONENGINE_ORC_OBJECTLINKINGLAYER_H
#define LLVM37_EXECUTIONENGINE_ORC_OBJECTLINKINGLAYER_H
...
protected:
  ...
  public:
    LinkedObjectSet(RuntimeDyld::MemoryManager &MemMgr,
        ...
        : RTDyld(llvm37::make_unique<RuntimeDyld>(MemMgr, Resolver)),
          State(Raw) {}
...
private:
  ...
  createLinkedObjectSet(MemoryManagerPtrT MemMgr, SymbolResolverPtrT Resolver) {
    ...
    return llvm37::make_unique<LOS>(std::move(MemMgr), std::move(Resolver));
  }
...
#endif // LLVM37_EXECUTIONENGINE_ORC_OBJECTLINKINGLAYER_H
