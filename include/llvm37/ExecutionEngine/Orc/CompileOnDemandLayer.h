...
#ifndef LLVM37_EXECUTIONENGINE_ORC_COMPILEONDEMANDLAYER_H
#define LLVM37_EXECUTIONENGINE_ORC_COMPILEONDEMANDLAYER_H
...
private:
  ...
  void addLogicalModule(CODLogicalDylib &LD, std::shared_ptr<Module> SrcM) {
    ...
    auto GVsAndStubsM = llvm37::make_unique<Module>(
    ...
    auto GVsAndStubsH =
      BaseLayer.addModuleSet(std::move(GVsAndStubsMSet),
                             llvm37::make_unique<SectionMemoryManager>(),
  ...
  BaseLayerModuleSetHandleT emitPartition(CODLogicalDylib &LD,
    ...
    auto M = llvm37::make_unique<Module>(NewName, SrcM.getContext());
    ...
    auto MemMgr = llvm37::make_unique<SectionMemoryManager>();
...
#endif // LLVM37_EXECUTIONENGINE_ORC_COMPILEONDEMANDLAYER_H
