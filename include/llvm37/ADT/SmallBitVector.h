//===- llvm37/ADT/SmallBitVector.h - 'Normally small' bit vectors -*- C++ -*-===//
//
...
#ifndef LLVM37_ADT_SMALLBITVECTOR_H
#define LLVM37_ADT_SMALLBITVECTOR_H
...
namespace std {
  ...
  inline void
  swap(llvm37::SmallBitVector &LHS, llvm37::SmallBitVector &RHS) {
    LHS.swap(RHS);
  }
}
