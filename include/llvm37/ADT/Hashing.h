//===-- llvm37/ADT/Hashing.h - Utilities for hashing --------------*- C++ -*-===//
//
...
#ifndef LLVM37_ADT_HASHING_H
#define LLVM37_ADT_HASHING_H
...
///   llvm37::hash_code code = hash_value(x);
/// \endcode
class hash_code {
  size_t value;
...
///
/// This variable can be set using the \see llvm37::set_fixed_execution_seed
...
hash_code hash_combine_range(InputIteratorT first, InputIteratorT last) {
  return ::llvm37::hashing::detail::hash_combine_range_impl(first, last);
}
...
template <typename ...Ts> hash_code hash_combine(const Ts &...args) {
  ...
  ::llvm37::hashing::detail::hash_combine_recursive_helper helper;
...
typename std::enable_if<is_integral_or_enum<T>::value, hash_code>::type
hash_value(T value) {
  return ::llvm37::hashing::detail::hash_integer_value(value);
}

// Declared and documented above, but defined here so that any of the hashing
// infrastructure is available.
template <typename T> hash_code hash_value(const T *ptr) {
  return ::llvm37::hashing::detail::hash_integer_value(
