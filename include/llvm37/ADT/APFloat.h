//===- llvm37/ADT/APFloat.h - Arbitrary Precision Floating Point ---*- C++ -*-==//
//
...
#ifndef LLVM37_ADT_APFLOAT_H
#define LLVM37_ADT_APFLOAT_H
...
///
/// These additional declarations are required in order to compile LLVM37 with IBM
/// xlC compiler.
