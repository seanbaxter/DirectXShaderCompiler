//===-- llvm37/ADT/APInt.h - For Arbitrary Precision Integer -----*- C++ -*--===//
//
...
#ifndef LLVM37_ADT_APINT_H
#define LLVM37_ADT_APINT_H
...
///     not.
///   * In general, the class tries to follow the style of computation that LLVM37
///     uses in its IR. This simplifies its use for LLVM37.
///
class APInt {
...
public:
  ...
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT And(const APInt &RHS) const {
  ...
  ///
  /// \returns An APInt value representing the bitwise OR of *this and RHS.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT Or(const APInt &RHS) const {
    return this->operator|(RHS);
  }
  ...
  ///
  /// \returns An APInt value representing the bitwise XOR of *this and RHS.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT Xor(const APInt &RHS) const {
    return this->operator^(RHS);
  }
  ...
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT ashr(unsigned shiftAmt) const;

  /// \brief Logical right-shift function.
  ///
  /// Logical right-shift this APInt by shiftAmt.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT lshr(unsigned shiftAmt) const;

  /// \brief Left-shift function.
  ///
  /// Left-shift this APInt by shiftAmt.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT shl(unsigned shiftAmt) const {
  ...
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT rotl(unsigned rotateAmt) const;

  /// \brief Rotate right by rotateAmt.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT rotr(unsigned rotateAmt) const;

  /// \brief Arithmetic right-shift function.
  ///
  /// Arithmetic right-shift this APInt by shiftAmt.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT ashr(const APInt &shiftAmt) const;

  /// \brief Logical right-shift function.
  ///
  /// Logical right-shift this APInt by shiftAmt.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT lshr(const APInt &shiftAmt) const;

  /// \brief Left-shift function.
  ///
  /// Left-shift this APInt by shiftAmt.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT shl(const APInt &shiftAmt) const;

  /// \brief Rotate left by rotateAmt.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT rotl(const APInt &rotateAmt) const;

  /// \brief Rotate right by rotateAmt.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT rotr(const APInt &rotateAmt) const;
  ...
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT udiv(const APInt &RHS) const;

  /// \brief Signed division function for APInt.
  ///
  /// Signed divide this APInt by APInt RHS.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT sdiv(const APInt &RHS) const;
  ...
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT urem(const APInt &RHS) const;

  /// \brief Function for signed remainder operation.
  ///
  /// Signed remainder operation on APInt.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT srem(const APInt &RHS) const;
  ...
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT trunc(unsigned width) const;
  ...
  /// current width.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT sext(unsigned width) const;
  ...
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT zext(unsigned width) const;

  /// \brief Sign extend or truncate to width
  ///
  /// Make this APInt have the bit width given by \p width. The value is sign
  /// extended, truncated, or left alone to make it that width.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT sextOrTrunc(unsigned width) const;

  /// \brief Zero extend or truncate to width
  ///
  /// Make this APInt have the bit width given by \p width. The value is zero
  /// extended, truncated, or left alone to make it that width.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT zextOrTrunc(unsigned width) const;

  /// \brief Sign extend or truncate to width
  ///
  /// Make this APInt have the bit width given by \p width. The value is sign
  /// extended, or left alone to make it that width.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT sextOrSelf(unsigned width) const;

  /// \brief Zero extend or truncate to width
  ///
  /// Make this APInt have the bit width given by \p width. The value is zero
  /// extended, or left alone to make it that width.
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT zextOrSelf(unsigned width) const;
  ...
  unsigned countLeadingZeros() const {
    if (isSingleWord()) {
      ...
      return llvm37::countLeadingZeros(VAL) - unusedBits;
    }
  ...
  unsigned countTrailingOnes() const {
    if (isSingleWord())
      return llvm37::countTrailingOnes(VAL);
  ...
  unsigned countPopulation() const {
    if (isSingleWord())
      return llvm37::countPopulation(VAL);
  ...
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT byteSwap() const;
  ...
  static APInt LLVM37_ATTRIBUTE_UNUSED_RESULT doubleToBits(double V) {
    union {
      uint64_t I;
      double D;
    } T;
  ...
  static APInt LLVM37_ATTRIBUTE_UNUSED_RESULT floatToBits(float V) {
    union {
      unsigned I;
      float F;
    } T;
  ...
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT sqrt() const;

  /// \brief Get the absolute value;
  ///
  /// If *this is < 0 then return -(*this), otherwise *this;
  APInt LLVM37_ATTRIBUTE_UNUSED_RESULT abs() const {
    if (isNegative())
      return -(*this);
    return *this;
  }
...
// order to compile LLVM37 with IBM xlC compiler.
