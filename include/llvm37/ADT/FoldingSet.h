//===-- llvm37/ADT/FoldingSet.h - Uniquing Hash Set ---------------*- C++ -*-===//
//
...
// SelectionDAGCSEMap, but was isolated to provide use across the llvm37 code set.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_ADT_FOLDINGSET_H
#define LLVM37_ADT_FOLDINGSET_H
...
///   void Profile(llvm37::FoldingSetNodeID &, Ctx);
