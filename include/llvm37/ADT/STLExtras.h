//===- llvm37/ADT/STLExtras.h - Useful STL related functions ------*- C++ -*-===//
//
...
#ifndef LLVM37_ADT_STLEXTRAS_H
#define LLVM37_ADT_STLEXTRAS_H
...
template <class T, T... I> struct integer_sequence {
  ...
  static LLVM37_CONSTEXPR size_t size() { return sizeof...(I); }
};
...
LLVM37_CONSTEXPR inline size_t array_lengthof(T (&)[N]) {
  return N;
}
...
typedef int(__cdecl *llvm37_cmp_func)(const void *, const void *);

template<typename T>
inline llvm37_cmp_func get_array_pod_sort_comparator(const T &) {
...
/// most sorts are not performance critical in LLVM37 and std::sort has to be
