//===--- llvm37/ADT/SparseMultiSet.h - Sparse multiset ------------*- C++ -*-===//
//
...
#ifndef LLVM37_ADT_SPARSEMULTISET_H
#define LLVM37_ADT_SPARSEMULTISET_H
...
template<typename ValueT,
         typename KeyFunctorT = llvm37::identity<unsigned>,
