...
#ifndef LLVM37_ADT_ARRAYREF_H
#define LLVM37_ADT_ARRAYREF_H
...
namespace llvm37 {
  ...
  public:
    ...
    template <size_t N>
    /*implicit*/ LLVM37_CONSTEXPR ArrayRef(const T (&Arr)[N])
      : Data(Arr), Length(N) {}
  ...
  public:
    ...
    template <size_t N>
    /*implicit*/ LLVM37_CONSTEXPR MutableArrayRef(T (&Arr)[N])
      : ArrayRef<T>(Arr) {}
