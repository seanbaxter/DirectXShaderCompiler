//===- llvm37/ADT/DepthFirstIterator.h - Depth First iterator -----*- C++ -*-===//
//
...
#ifndef LLVM37_ADT_DEPTHFIRSTITERATOR_H
#define LLVM37_ADT_DEPTHFIRSTITERATOR_H
...
class SetType = llvm37::SmallPtrSet<typename GraphTraits<GraphT>::NodeType*, 8>,
...
template <class T,
  class SetTy = llvm37::SmallPtrSet<typename GraphTraits<T>::NodeType*, 8>,
          bool External = false>
