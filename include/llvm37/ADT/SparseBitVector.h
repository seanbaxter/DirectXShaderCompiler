//===- llvm37/ADT/SparseBitVector.h - Efficient Sparse BitVector -*- C++ -*- ===//
//
...
#ifndef LLVM37_ADT_SPARSEBITVECTOR_H
#define LLVM37_ADT_SPARSEBITVECTOR_H
...
public:
  ...
  int find_first() const {
    ...
    llvm37_unreachable("Illegal empty element");
  }
