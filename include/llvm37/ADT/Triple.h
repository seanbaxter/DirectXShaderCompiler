//===-- llvm37/ADT/Triple.h - Target triple helper class ----------*- C++ -*-===//
//
...
#ifndef LLVM37_ADT_TRIPLE_H
#define LLVM37_ADT_TRIPLE_H
...
public:
  ...
  llvm37::Triple get32BitArchVariant() const;
  ...
  ///          architecture if no such variant can be found.
  llvm37::Triple get64BitArchVariant() const;
  ...
  ///          architecture if no such variant can be found.
  llvm37::Triple getBigEndianArchVariant() const;
  ...
  ///          architecture if no such variant can be found.
  llvm37::Triple getLittleEndianArchVariant() const;
  ...
  /// getArchTypeForLLVM37Name - The canonical type for the given LLVM37
  /// architecture name (e.g., "x86").
  static ArchType getArchTypeForLLVM37Name(StringRef Str);
