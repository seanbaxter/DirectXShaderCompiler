...
#ifndef LLVM37_ADT_STRINGREF_H
#define LLVM37_ADT_STRINGREF_H
...
namespace std {
  template<>
  struct is_nothrow_constructible <std::string, llvm37::StringRef>
    : std::false_type {
  };
  template<>
  struct is_nothrow_constructible <std::string, llvm37::StringRef &>
  ...
  template<>
  struct is_nothrow_constructible <std::string, const llvm37::StringRef &>
    : std::false_type {
  };
}
// HLSL Change Ends
