//===- llvm37/ADT/MapVector.h - Map w/ deterministic value order --*- C++ -*-===//
//
...
#ifndef LLVM37_ADT_MAPVECTOR_H
#define LLVM37_ADT_MAPVECTOR_H
...
template<typename KeyT, typename ValueT,
         typename MapType = llvm37::DenseMap<KeyT, unsigned>,
