//===- llvm37/ADT/PointerUnion.h - Discriminated Union of 2 Ptrs --*- C++ -*-===//
//
...
#ifndef LLVM37_ADT_POINTERUNION_H
#define LLVM37_ADT_POINTERUNION_H
...
namespace llvm37 {
  ...
  public:
    ...
    int is() const {
      typedef typename
        ::llvm37::PointerUnionTypeSelector<PT1, T, IsPT1,
          ::llvm37::PointerUnionTypeSelector<PT2, T, IsPT2,
  ...
  public:
    ...
    int is() const {
      ...
      typedef typename
        ::llvm37::PointerUnionTypeSelector<PT1, T, IsInnerUnion,
          ::llvm37::PointerUnionTypeSelector<PT2, T, IsInnerUnion, IsPT3 >
                                                                   >::Return Ty;
  ...
  public:
    ...
    int is() const {
      ...
      typedef typename
        ::llvm37::PointerUnionTypeSelector<PT1, T, InnerUnion1,
          ::llvm37::PointerUnionTypeSelector<PT2, T, InnerUnion1, InnerUnion2 >
                                                                   >::Return Ty;
