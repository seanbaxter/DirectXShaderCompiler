//==-- llvm37/ADT/ilist.h - Intrusive Linked List Template ---------*- C++ -*-==//
//
...
#ifndef LLVM37_ADT_ILIST_H
#define LLVM37_ADT_ILIST_H
...
public:
  ...
  size_type LLVM37_ATTRIBUTE_UNUSED_RESULT size() const {
...
namespace std {
  ...
  template<class Ty>
  void swap(llvm37::iplist<Ty> &Left, llvm37::iplist<Ty> &Right) {
    Left.swap(Right);
  }
}  // End 'std' extensions...

#endif // LLVM37_ADT_ILIST_H
