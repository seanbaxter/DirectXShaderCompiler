...
#ifndef LLVM37_TARGET_TARGETREGISTERINFO_H
#define LLVM37_TARGET_TARGETREGISTERINFO_H
...
protected:
  ...
  virtual unsigned composeSubRegIndicesImpl(unsigned, unsigned) const {
    llvm37_unreachable("Target has no sub-registers");
  }
...
public:
  ...
  getPointerRegClass(const MachineFunction &MF, unsigned Kind=0) const {
    llvm37_unreachable("Target didn't implement getPointerRegClass!");
  }
  ...
  virtual void materializeFrameBaseRegister(MachineBasicBlock *MBB,
    ...
    llvm37_unreachable("materializeFrameBaseRegister does not exist on this "
                     "target");
  }
  ...
  virtual void resolveFrameIndex(MachineInstr &MI, unsigned BaseReg,
                                 int64_t Offset) const {
    llvm37_unreachable("resolveFrameIndex does not exist on this target");
  }
  ...
  virtual bool isFrameOffsetLegal(const MachineInstr *MI, unsigned BaseReg,
                                  int64_t Offset) const {
    llvm37_unreachable("isFrameOffsetLegal does not exist on this target");
  }
