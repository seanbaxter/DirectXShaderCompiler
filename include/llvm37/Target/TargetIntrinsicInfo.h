//===-- llvm37/Target/TargetIntrinsicInfo.h - Instruction Info ----*- C++ -*-===//
//
...
#ifndef LLVM37_TARGET_TARGETINTRINSICINFO_H
#define LLVM37_TARGET_TARGETINTRINSICINFO_H
...
public:
  ...
  /// Create or insert an LLVM37 Function declaration for an intrinsic,
