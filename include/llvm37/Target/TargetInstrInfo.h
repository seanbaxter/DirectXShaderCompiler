//===-- llvm37/Target/TargetInstrInfo.h - Instruction Info --------*- C++ -*-===//
//
...
#ifndef LLVM37_TARGET_TARGETINSTRINFO_H
#define LLVM37_TARGET_TARGETINSTRINFO_H

#include "llvm37/ADT/DenseMap.h"
#include "llvm37/ADT/SmallSet.h"
#include "llvm37/CodeGen/MachineCombinerPattern.h"
...
public:
  ...
  virtual unsigned RemoveBranch(MachineBasicBlock &MBB) const {
    llvm37_unreachable("Target didn't implement TargetInstrInfo::RemoveBranch!");
  }
  ...
  virtual unsigned InsertBranch(MachineBasicBlock &MBB, MachineBasicBlock *TBB,
                                ...
                                DebugLoc DL) const {
    llvm37_unreachable("Target didn't implement TargetInstrInfo::InsertBranch!");
  }
  ...
  getUnconditionalBranch(MCInst &MI,
    ...
    llvm37_unreachable("Target didn't implement "
                     "TargetInstrInfo::getUnconditionalBranch!");
  }

  /// Get a machine trap instruction.
  virtual void getTrap(MCInst &MI) const {
    llvm37_unreachable("Target didn't implement TargetInstrInfo::getTrap!");
  }
  ...
  virtual unsigned getJumpInstrTableEntryBound() const {
    // This method gets called by LLVM37TargetMachine always, so it can't fail
  ...
  virtual void insertSelect(MachineBasicBlock &MBB,
    ...
    llvm37_unreachable("Target didn't implement TargetInstrInfo::insertSelect!");
  }
  ...
  virtual MachineInstr *optimizeSelect(MachineInstr *MI,
    ...
    llvm37_unreachable("Target must implement TargetInstrInfo::optimizeSelect!");
  }
  ...
  virtual void copyPhysReg(MachineBasicBlock &MBB,
                           ...
                           bool KillSrc) const {
    llvm37_unreachable("Target didn't implement TargetInstrInfo::copyPhysReg!");
  }
