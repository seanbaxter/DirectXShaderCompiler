//===-- llvm37/Target/TargetOptions.h - Target Options ------------*- C++ -*-===//
//
...
#ifndef LLVM37_TARGET_TARGETOPTIONS_H
#define LLVM37_TARGET_TARGETOPTIONS_H
...
namespace llvm37 {
  ...
  public:
    ...
    /// via the llvm37.fma.* intrinsic) will always be honored, regardless of
