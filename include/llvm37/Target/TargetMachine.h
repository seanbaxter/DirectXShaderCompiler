//===-- llvm37/Target/TargetMachine.h - Target Information --------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the TargetMachine and LLVM37TargetMachine classes.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_TARGET_TARGETMACHINE_H
#define LLVM37_TARGET_TARGETMACHINE_H
...
/// This class describes a target machine that is implemented with the LLVM37
/// target-independent code generator.
///
class LLVM37TargetMachine : public TargetMachine {
protected: // Can only create subclasses.
  LLVM37TargetMachine(const Target &T, StringRef DataLayoutString,
                    const Triple &TargetTriple, StringRef CPU, StringRef FS,
