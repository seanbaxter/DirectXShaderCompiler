//===-- llvm37/Target/TargetFrameLowering.h ---------------------------*- C++ -*-===//
//
...
#ifndef LLVM37_TARGET_TARGETFRAMELOWERING_H
#define LLVM37_TARGET_TARGETFRAMELOWERING_H
...
public:
  ...
  virtual int getFrameIndexReferenceFromSP(const MachineFunction &MF, int FI,
    ...
    llvm37_unreachable("unimplemented for non-x86");
    return 0;
  }
  ...
  eliminateCallFramePseudoInstr(MachineFunction &MF,
    ...
    llvm37_unreachable("Call Frame Pseudo Instructions do not exist on this "
                     "target!");
  }
