//===-- llvm37/Target/TargetLowering.h - Target Lowering Info -----*- C++ -*-===//
//
...
///
/// \file
/// This file describes how to lower LLVM37 code to machine code.  This has two
/// main components:
///
...
#ifndef LLVM37_TARGET_TARGETLOWERING_H
#define LLVM37_TARGET_TARGETLOWERING_H

#include "llvm37/ADT/DenseMap.h"
#include "llvm37/CodeGen/DAGCombine.h"
...
#include "llvm37/Target/TargetCallingConv.h"
...
public:
  ...
  static ISD::NodeType getExtendForContent(BooleanContent Content) {
    ...
    llvm37_unreachable("Invalid content kind");
  }
...
public:
  ...
  virtual EVT getSetCCResultType(const DataLayout &DL, LLVM37Context &Context,
                                 EVT VT) const;
  ...
  LegalizeTypeAction getTypeAction(LLVM37Context &Context, EVT VT) const {
  ...
  /// to transform to.
  EVT getTypeToTransformTo(LLVM37Context &Context, EVT VT) const {
  ...
  EVT getTypeToExpandTo(LLVM37Context &Context, EVT VT) const {
    assert(!VT.isVector());
    while (true) {
      ...
      case TypeExpandInteger:
        ...
        break;
      default:
        llvm37_unreachable("Type is not legal nor is it to be expanded!");
      }
    }
  }
  ...
  unsigned getVectorTypeBreakdown(LLVM37Context &Context, EVT VT,
                                  EVT &IntermediateVT,
  ...
  /// Return the EVT corresponding to this LLVM37 type.  This is fixed by the LLVM37
  ...
  /// Return the MVT corresponding to this LLVM37 type. See getValueType.
  ...
  /// Return the type of registers that this ValueType will eventually require.
  MVT getRegisterType(LLVM37Context &Context, EVT VT) const {
    if (VT.isSimple()) {
    ...
    llvm37_unreachable("Unsupported extended type!");
  }
  ...
  unsigned getNumRegisters(LLVM37Context &Context, EVT VT) const {
    if (VT.isSimple()) {
      assert((unsigned)VT.getSimpleVT().SimpleTy <
  ...
  /// \brief Get maximum # of store operations permitted for llvm37.memset
  ///
  /// This function returns the maximum number of store operations permitted
  /// to replace a call to llvm37.memset. The value is set by the target at the
  ...
  /// \brief Get maximum # of store operations permitted for llvm37.memcpy
  ///
  /// This function returns the maximum number of store operations permitted
  /// to replace a call to llvm37.memcpy. The value is set by the target at the
  /// performance threshold for such a replacement. If OptSize is true,
  /// return the limit for functions that have OptSize attribute.
  ...
  /// \brief Get maximum # of store operations permitted for llvm37.memmove
  ///
  /// This function returns the maximum number of store operations permitted
  /// to replace a call to llvm37.memmove. The value is set by the target at the
  /// performance threshold for such a replacement. If OptSize is true,
  /// return the limit for functions that have OptSize attribute.
  ...
  /// Determine if we should use _setjmp or setjmp to implement llvm37.setjmp.
  bool usesUnderscoreSetJmp() const {
    return UseUnderscoreSetJmp;
  }

  /// Determine if we should use _longjmp or longjmp to implement llvm37.longjmp.
  ...
  /// llvm37.savestack/llvm37.restorestack should save and restore.
  ...
  virtual Value *emitLoadLinked(IRBuilder<> &Builder, Value *Addr,
    ...
    llvm37_unreachable("Load linked unimplemented on this target");
  }
  ...
  virtual Value *emitStoreConditional(IRBuilder<> &Builder, Value *Val,
    ...
    llvm37_unreachable("Store conditional unimplemented on this target");
  }
  ...
  virtual bool shouldNormalizeToSelectSequence(LLVM37Context &Context,
                                               EVT VT) const {
...
protected:
  ...
  /// llvm37.setjmp or the version without _.  Defaults to false.
  void setUseUnderscoreSetJmp(bool Val) {
    UseUnderscoreSetJmp = Val;
  }

  /// Indicate whether this target prefers to use _longjmp to implement
  /// llvm37.longjmp or the version without _.  Defaults to false.
...
public:
  ...
  bool isExtFree(const Instruction *I) const {
    ...
    case Instruction::SExt:
      break;
    default:
      llvm37_unreachable("Instruction is not an extension");
    }
...
private:
  ...
  /// This target prefers to use _setjmp to implement llvm37.setjmp.
  ///
  /// Defaults to false.
  bool UseUnderscoreSetJmp;

  /// This target prefers to use _longjmp to implement llvm37.longjmp.
  ///
  /// Defaults to false.
...
private:
  LegalizeKind getTypeConversion(LLVM37Context &Context, EVT VT) const;
...
protected:
  ...
  ///
  /// When lowering \@llvm37.memset this field specifies the maximum number of
  ...
  ///
  /// When lowering \@llvm37.memcpy this field specifies the maximum number of
  ...
  ///
  /// When lowering \@llvm37.memmove this field specifies the maximum number of
...
/// This class defines information used to lower LLVM37 code to legal SelectionDAG
...
public:
  ...
  LowerCustomJumpTableEntry(const MachineJumpTableInfo * /*MJTI*/,
                            ...
                            MCContext &/*Ctx*/) const {
    llvm37_unreachable("Need to implement this hook if target has custom JTIs");
  }
  ...
  virtual EVT getTypeForExtArgOrReturn(LLVM37Context &Context, EVT VT,
                                       ISD::NodeType /*ExtendKind*/) const {
    EVT MinVT = getRegisterType(Context, MVT::i32);
    return VT.bitsLT(MinVT) ? MinVT : VT;
  }

  /// For some targets, an LLVM37 struct type must be broken down into multiple
  ...
  virtual void ReplaceNodeResults(SDNode * /*N*/,
                                  SmallVectorImpl<SDValue> &/*Results*/,
                                  SelectionDAG &/*DAG*/) const {
    llvm37_unreachable("ReplaceNodeResults not implemented for this target!");
  }
  ...
  /// llvm37 code if it wants to.  This is useful for turning simple inline asms
  /// into LLVM37 intrinsics, which gives the compiler more information about the
  ...
  /// to an LLVM37 register class, return a register of 0 and the register class
  /// pointer.
  ///
...
/// Given an LLVM37 IR type and return type attributes, compute the return value
