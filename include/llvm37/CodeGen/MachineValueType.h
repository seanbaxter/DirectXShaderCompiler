...
#ifndef LLVM37_CODEGEN_MACHINEVALUETYPE_H
#define LLVM37_CODEGEN_MACHINEVALUETYPE_H
...
namespace llvm37 {
  ...
  /// processor targeted by LLVM37 occurs here. This means that any legal value
...
class MVT {
  public:
    ...
    LLVM37_CONSTEXPR MVT() : SimpleTy(INVALID_SIMPLE_VALUE_TYPE) {}
    LLVM37_CONSTEXPR MVT(SimpleValueType SVT) : SimpleTy(SVT) { }
    ...
    MVT getVectorElementType() const {
      switch (SimpleTy) {
      default:
        llvm37_unreachable("Not a vector MVT!");
      case v2i1 :
      case v4i1 :
      case v8i1 :
      case v16i1 :
    ...
    unsigned getSizeInBits() const {
      switch (SimpleTy) {
      default:
        llvm37_unreachable("getSizeInBits called on extended MVT.");
      case Other:
        llvm37_unreachable("Value type is non-standard value, Other.");
      case iPTR:
        llvm37_unreachable("Value type size is target-dependent. Ask TLI.");
      case iPTRAny:
      case iAny:
      case fAny:
      case vAny:
      case Any:
        llvm37_unreachable("Value type is overloaded.");
      case Metadata:
        llvm37_unreachable("Value type is metadata.");
      case i1  :  return 1;
      case v2i1:  return 2;
      case v4i1:  return 4;
      case i8  :
    ...
    static MVT getFloatingPointVT(unsigned BitWidth) {
      switch (BitWidth) {
      default:
        llvm37_unreachable("Bad bit width!");
      case 16:
        return MVT::f16;
      case 32:
        return MVT::f32;
