//===- llvm37/CodeGen/SlotIndexes.h - Slot indexes representation -*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_SLOTINDEXES_H
#define LLVM37_CODEGEN_SLOTINDEXES_H
...
#endif // LLVM37_CODEGEN_SLOTINDEXES_H
