//==-- llvm37/CodeGen/TargetLoweringObjectFileImpl.h - Object Info -*- C++ -*-==//
//
...
#ifndef LLVM37_CODEGEN_TARGETLOWERINGOBJECTFILEIMPL_H
#define LLVM37_CODEGEN_TARGETLOWERINGOBJECTFILEIMPL_H
