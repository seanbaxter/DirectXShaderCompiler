//=- llvm37/CodeGen/ScheduleHazardRecognizer.h - Scheduling Support -*- C++ -*-=//
//
...
#ifndef LLVM37_CODEGEN_SCHEDULEHAZARDRECOGNIZER_H
#define LLVM37_CODEGEN_SCHEDULEHAZARDRECOGNIZER_H
