...
namespace llvm37 {
  ...
  public:
    LLVM37_CONSTEXPR EVT() : V(MVT::INVALID_SIMPLE_VALUE_TYPE), LLVMTy(nullptr) {}
    LLVM37_CONSTEXPR EVT(MVT::SimpleValueType SVT) : V(SVT), LLVMTy(nullptr) {}
    LLVM37_CONSTEXPR EVT(MVT S) : V(S), LLVMTy(nullptr) {}
