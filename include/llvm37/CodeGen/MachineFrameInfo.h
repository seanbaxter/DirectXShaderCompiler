...
#ifndef LLVM37_CODEGEN_MACHINEFRAMEINFO_H
#define LLVM37_CODEGEN_MACHINEFRAMEINFO_H
...
class MachineFrameInfo {
  ...
  struct StackObject {
    ...
    // If true, an LLVM37 IR value might point to this object.
  ...
  /// to builtin \@llvm37.frameaddress.
  bool FrameAddressTaken;

  /// This boolean keeps track of whether there is a call
  /// to builtin \@llvm37.returnaddress.
  bool ReturnAddressTaken;

  /// This boolean keeps track of whether there is a call
  /// to builtin \@llvm37.experimental.stackmap.
  bool HasStackMap;

  /// This boolean keeps track of whether there is a call
  /// to builtin \@llvm37.experimental.patchpoint.
  bool HasPatchPoint;
  ...
  /// True if the function contains a call to the llvm37.vastart intrinsic.
  bool HasVAStart;
...
public:
  ...
  /// \@llvm37.frameaddress in this function.
  ...
  /// Returns true if the function calls the llvm37.va_start intrinsic.
  ...
  /// efficiency. By default, fixed objects are not pointed to by LLVM37 IR
  ...
  /// to an object that might be pointed to by an LLVM37 IR value.
