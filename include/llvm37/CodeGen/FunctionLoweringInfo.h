//===-- FunctionLoweringInfo.h - Lower functions from LLVM37 IR to CodeGen --===//
//
...
#ifndef LLVM37_CODEGEN_FUNCTIONLOWERINGINFO_H
#define LLVM37_CODEGEN_FUNCTIONLOWERINGINFO_H
...
public:
  ...
  /// MBBMap - A mapping from LLVM37 basic blocks to their machine code entry.
  ...
  // llvm37 Value to the optional stack stack slot index.
