//===- llvm37/Codegen/LinkAllAsmWriterComponents.h ----------------*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_LINKALLASMWRITERCOMPONENTS_H
#define LLVM37_CODEGEN_LINKALLASMWRITERCOMPONENTS_H
...
namespace {
  struct ForceAsmWriterLinking {
    ForceAsmWriterLinking() {
      ...
      llvm37::linkOcamlGCPrinter();
      llvm37::linkErlangGCPrinter();

    }
  } ForceAsmWriterLinking; // Force link by creating a global definition.
}

#endif // LLVM37_CODEGEN_LINKALLASMWRITERCOMPONENTS_H
