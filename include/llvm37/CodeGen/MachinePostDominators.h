//=- llvm37/CodeGen/MachineDominators.h ----------------------------*- C++ -*-==//
//
...
#ifndef LLVM37_CODEGEN_MACHINEPOSTDOMINATORS_H
#define LLVM37_CODEGEN_MACHINEPOSTDOMINATORS_H
...
public:
  ...
  void print(llvm37::raw_ostream &OS, const Module *M = nullptr) const override;
};
