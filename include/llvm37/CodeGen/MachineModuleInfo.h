//===-- llvm37/CodeGen/MachineModuleInfo.h ------------------------*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_MACHINEMODULEINFO_H
#define LLVM37_CODEGEN_MACHINEMODULEINFO_H
...
class MachineModuleInfo : public ImmutablePass {
  ...
  /// TheModule - This is the LLVM37 Module being worked on.
...
public:
  ...
  unsigned LLVM37_ATTRIBUTE_UNUSED_RESULT
