//===-- llvm37/CodeGen/PseudoSourceValue.h ------------------------*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_PSEUDOSOURCEVALUE_H
#define LLVM37_CODEGEN_PSEUDOSOURCEVALUE_H
...
namespace llvm37 {
  ...
  public:
    ...
    /// PseudoSourceValue may also be pointed to by an LLVM37 IR Value.
    virtual bool isAliased(const MachineFrameInfo *) const;

    /// mayAlias - Return true if the memory pointed to by this
    /// PseudoSourceValue can ever alias an LLVM37 IR Value.
