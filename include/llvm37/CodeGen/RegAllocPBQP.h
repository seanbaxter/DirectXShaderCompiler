...
#ifndef LLVM37_CODEGEN_REGALLOCPBQP_H
#define LLVM37_CODEGEN_REGALLOCPBQP_H

#include "llvm37/CodeGen/MachineFunctionPass.h"
#include "llvm37/CodeGen/PBQP/CostAllocator.h"
#include "llvm37/CodeGen/PBQP/ReductionRules.h"
#include "llvm37/CodeGen/PBQPRAConstraint.h"
    ...
    while (true) {
      if (!OptimallyReducibleNodes.empty()) {
        ...
        case 2:
          applyR2(G, NId);
          break;
        default: llvm37_unreachable("Not an optimally reducible node.");
        }
...
#endif /* LLVM37_CODEGEN_REGALLOCPBQP_H */
