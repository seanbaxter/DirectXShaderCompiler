//===-- llvm37/CodeGen/MachineFunction.h --------------------------*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_MACHINEFUNCTION_H
#define LLVM37_CODEGEN_MACHINEFUNCTION_H
...
#include "llvm37/Support/ArrayRecycler.h"
...
public:
  ...
  /// getFunction - Return the LLVM37 function that this machine code represents
  ///
  const Function *getFunction() const { return Fn; }

  /// getName - Return the name of the corresponding LLVM37 function.
  ///
