...
#ifndef LLVM37_CODEGEN_SCHEDULEDAGINSTRS_H
#define LLVM37_CODEGEN_SCHEDULEDAGINSTRS_H

#include "llvm37/ADT/SparseMultiSet.h"
...
namespace llvm37 {
  ...
  /// without any frees.
  typedef SparseMultiSet<PhysRegSUOper, llvm37::identity<unsigned>, uint16_t>
  Reg2SUnitsMap;
