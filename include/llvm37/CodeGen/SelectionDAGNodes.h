//===-- llvm37/CodeGen/SelectionDAGNodes.h - SelectionDAG Nodes ---*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_SELECTIONDAGNODES_H
#define LLVM37_CODEGEN_SELECTIONDAGNODES_H
...
//                                                                           //
///////////////////////////////////////////////////////////////////////////////
/// Unlike LLVM37 values, Selection DAG nodes may return multiple
...
/// support for the llvm37 IR shufflevector instruction.  It combines elements
...
public:
  ...
  int  getSplatIndex() const {
    ...
    llvm37_unreachable("Splat with all undef indices?");
  }
...
/// An SDNode that holds an arbitrary LLVM37 IR Value. This is
/// used when the SelectionDAG needs to make a simple reference to something
/// in the LLVM37 IR representation.
///
