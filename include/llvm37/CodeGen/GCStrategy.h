//===-- llvm37/CodeGen/GCStrategy.h - Garbage collection ----------*- C++ -*-===//
//
...
//   stored in an alloca registered with llvm37.gcoot.
//
...
#ifndef LLVM37_IR_GCSTRATEGY_H
#define LLVM37_IR_GCSTRATEGY_H
...
public:
  ...
  /// calls to @llvm37.gcwrite.
  bool customWriteBarrier() const { return CustomWriteBarriers; }

  /// By default, read barriers are replaced with simple load
  /// instructions. If true, you must provide a custom pass to lower 
  /// calls to @llvm37.gcread.
...
/// LLVM37 source tree or via a loadable plugin.  An example registeration
/// would be:
