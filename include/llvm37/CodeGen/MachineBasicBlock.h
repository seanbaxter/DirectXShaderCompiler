//===-- llvm37/CodeGen/MachineBasicBlock.h ------------------------*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_MACHINEBASICBLOCK_H
#define LLVM37_CODEGEN_MACHINEBASICBLOCK_H
...
public:
  /// getBasicBlock - Return the LLVM37 basic block that this instance
  /// corresponded to originally. Note that this may be NULL if this instance
  /// does not correspond directly to an LLVM37 basic block.
  ///
  const BasicBlock *getBasicBlock() const { return BB; }

  /// getName - Return the name of the corresponding LLVM37 basic block, or
  /// "(null)".
