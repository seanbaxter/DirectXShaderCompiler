...
#ifndef LLVM37_CODEGEN_COMMANDFLAGS_H
#define LLVM37_CODEGEN_COMMANDFLAGS_H
...
cl::opt<llvm37::FPOpFusion::FPOpFusionMode>
...
cl::opt<llvm37::JumpTable::JumpTableType>
          ...
          if (auto *Call = dyn_cast<CallInst>(&I))
            if (const auto *F = Call->getCalledFunction())
              if (F->getIntrinsicID() == Intrinsic::debugtrap ||
                ...
                Call->addAttribute(llvm37::AttributeSet::FunctionIndex,
