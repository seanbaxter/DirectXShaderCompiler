//===-- llvm37/CodeGen/SelectionDAGISel.h - Common Base Class------*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_SELECTIONDAGISEL_H
#define LLVM37_CODEGEN_SELECTIONDAGISEL_H
...
public:
  ...
  virtual bool CheckPatternPredicate(unsigned PredNo) const {
    llvm37_unreachable("Tblgen should generate the implementation of this!");
  }
  ...
  virtual SDValue RunSDNodeXForm(SDValue V, unsigned XFormNo) {
    llvm37_unreachable("Tblgen should generate this!");
  }
...
#endif /* LLVM37_CODEGEN_SELECTIONDAGISEL_H */
