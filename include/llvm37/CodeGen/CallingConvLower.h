//===-- llvm37/CallingConvLower.h - Calling Conventions -----------*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_CALLINGCONVLOWER_H
#define LLVM37_CODEGEN_CALLINGCONVLOWER_H
...
public:
  ...
  SmallVectorImpl<llvm37::CCValAssign> &getPendingLocs() {
    return PendingLocs;
  }
