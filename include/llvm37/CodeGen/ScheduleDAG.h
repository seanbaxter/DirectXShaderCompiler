//===------- llvm37/CodeGen/ScheduleDAG.h - Common Base Class------*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_SCHEDULEDAG_H
#define LLVM37_CODEGEN_SCHEDULEDAG_H
...
namespace llvm37 {
  ...
  public:
    ...
    SDep(SUnit *S, Kind kind, unsigned Reg)
      ...
      switch (kind) {
      default:
        llvm37_unreachable("Reg given for non-register dependence!");
      case Anti:
      case Output:
        assert(Reg != 0 &&
    ...
    bool overlaps(const SDep &Other) const {
      ...
      llvm37_unreachable("Invalid dependency kind!");
    }
