...
#ifndef LLVM37_CODEGEN_FASTISEL_H
#define LLVM37_CODEGEN_FASTISEL_H
...
public:
  ...
  /// \brief Do "fast" instruction selection for the given LLVM37 IR instruction
  /// and append the generated machine instructions to the current block.
  /// Returns true if selection was successful.
  bool selectInstruction(const Instruction *I);

  /// \brief Do "fast" instruction selection for the given LLVM37 IR operator
  ...
  /// value for the given LLVM37 value.
  ...
  /// that we could have a sequence where multiple LLVM37 IR instructions are
...
private:
  ...
  bool handlePHINodesInSuccessorBlocks(const BasicBlock *LLVM37BB);
