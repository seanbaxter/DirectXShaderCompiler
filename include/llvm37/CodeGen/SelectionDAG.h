//===-- llvm37/CodeGen/SelectionDAG.h - InstSelection DAG ---------*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_SELECTIONDAG_H
#define LLVM37_CODEGEN_SELECTIONDAG_H
...
public:
  ...
  static void deleteNode(SDNode *) {
    llvm37_unreachable("ilist_traits<SDNode> shouldn't see a deleteNode call!");
  }
private:
...
/// This is used to represent a portion of an LLVM37 function in a low-level
...
public:
  explicit SelectionDAG(const TargetMachine &TM, llvm37::CodeGenOpt::Level);
  ~SelectionDAG();
  ...
  static const fltSemantics &EVTToAPFloatSemantics(EVT VT) {
    ...
    default: llvm37_unreachable("Unknown FP format");
