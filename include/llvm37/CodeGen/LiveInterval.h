//===-- llvm37/CodeGen/LiveInterval.h - Interval representation ---*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_LIVEINTERVAL_H
#define LLVM37_CODEGEN_LIVEINTERVAL_H
...
namespace llvm37 {
  ...
  public:
    ...
    LiveRange(bool UseSegmentSet = false)
        : segmentSet(UseSegmentSet ? llvm37::make_unique<SegmentSet>()
                                   : nullptr) {}
  ...
  public:
    ...
    bool isSpillable() const {
      return weight != llvm37::huge_valf;
    }

    /// markNotSpillable - Mark interval as not spillable
    void markNotSpillable() {
      weight = llvm37::huge_valf;
    }
