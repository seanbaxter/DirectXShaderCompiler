//===-- llvm37/CodeGen/AsmPrinter.h - AsmPrinter Framework --------*- C++ -*-===//
//
...
#ifndef LLVM37_CODEGEN_ASMPRINTER_H
#define LLVM37_CODEGEN_ASMPRINTER_H
...
public:
  ...
  /// Check to see if the specified global is a special global used by LLVM37. If
  /// so, emit it and return true, otherwise do nothing and return false.
  bool EmitSpecialLLVM37Global(const GlobalVariable *GV);
  ...
  /// Lower the specified LLVM37 Constant to an MCExpr.
  const MCExpr *lowerConstant(const Constant *CV);

  /// \brief Print a general LLVM37 constant to the .s file.
  ...
  virtual void EmitInstruction(const MachineInstr *) {
    llvm37_unreachable("EmitInstruction not implemented");
  }
...
private:
  ...
  void EmitLLVM37UsedList(const ConstantArray *InitList);
