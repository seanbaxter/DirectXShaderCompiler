//===- CodeGen/Analysis.h - CodeGen LLVM37 IR Analysis Utilities --*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares several CodeGen-specific LLVM37 IR analysis utilities.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_CODEGEN_ANALYSIS_H
#define LLVM37_CODEGEN_ANALYSIS_H
...
///
/// Given an LLVM37 IR aggregate type and a sequence of insertvalue or
