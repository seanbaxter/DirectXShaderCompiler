...
// addition of domain-specific or front-end specific intrinsics to LLVM37 without
// having to modify all of the C backend or interpreter.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_CODEGEN_INTRINSICLOWERING_H
#define LLVM37_CODEGEN_INTRINSICLOWERING_H
...
namespace llvm37 {
  ...
  public:
    ...
    /// LowerIntrinsicCall - This method replaces a call with the LLVM37 function
