...
// passes provided by the LLVM37 backend.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM37_CODEGEN_PASSES_H
#define LLVM37_CODEGEN_PASSES_H
...
public:
  ...
  /// Add common target configurable passes that perform LLVM37 IR to IR
  ...
  /// which converts from LLVM37 code to machine instructions.
  virtual bool addInstSelector() {
    return true;
  }

  /// Add the complete, standard set of LLVM37 CodeGen passes.
...
protected:
  ...
  /// addPreISelPasses - This method should add any "last minute" LLVM37->LLVM37
  ...
  /// LLVM37TargetMachine provides standard regalloc passes for most targets.
...
namespace llvm37 {
  ...
  /// createUnreachableBlockEliminationPass - The LLVM37 code generator does not
  /// work well with unreachable basic blocks (what live ranges make sense for a
  /// block that cannot be reached?).  As such, a code generator should either
  /// not instruction select unreachable blocks, or run this pass as its
  /// last LLVM37 modifying pass to clean up blocks that are not reachable from
  /// the entry block.
  ...
  /// MIRPrinting pass - this pass prints out the LLVM37 IR into the given stream
...
/// MachineDominanaceFrontier - This pass is a machine dominators analysis pass.
  ...
  /// MIRPrintingPass - this pass prints out the LLVM37 IR using the MIR
