//=- llvm37/CodeGen/ScoreboardHazardRecognizer.h - Schedule Support -*- C++ -*-=//
//
...
#ifndef LLVM37_CODEGEN_SCOREBOARDHAZARDRECOGNIZER_H
#define LLVM37_CODEGEN_SCOREBOARDHAZARDRECOGNIZER_H
...
#endif //!LLVM37_CODEGEN_SCOREBOARDHAZARDRECOGNIZER_H
