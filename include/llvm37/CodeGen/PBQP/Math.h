...
#ifndef LLVM37_CODEGEN_PBQP_MATH_H
#define LLVM37_CODEGEN_PBQP_MATH_H
...
public:
  ...
  explicit Vector(unsigned Length)
    ...
    // llvm37::dbgs() << "Constructing PBQP::Vector "
    //              << this << " (length " << Length << ")\n";
  }
  ...
  Vector(const Vector &V)
    ...
    // llvm37::dbgs() << "Copy-constructing PBQP::Vector " << this
    //              << " from PBQP::Vector " << &V << "\n";
  ...
  ~Vector() {
    // llvm37::dbgs() << "Deleting PBQP::Vector " << this << "\n";
    delete[] Data;
  }

  /// \brief Copy-assignment operator.
  Vector& operator=(const Vector &V) {
    // llvm37::dbgs() << "Assigning to PBQP::Vector " << this
    //              << " from PBQP::Vector " << &V << "\n";
    delete[] Data;
    Length = V.Length;
...
#endif // LLVM37_CODEGEN_PBQP_MATH_H
