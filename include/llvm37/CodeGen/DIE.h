...
#ifndef LLVM37_LIB_CODEGEN_ASMPRINTER_DIE_H
#define LLVM37_LIB_CODEGEN_ASMPRINTER_DIE_H
...
public:
  ...
  child_range children() {
    return llvm37::make_range(Children.begin(), Children.end());
  }
  ...
  value_range values() {
    return llvm37::make_range(Values.begin(), Values.end());
  }
