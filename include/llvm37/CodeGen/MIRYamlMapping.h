...
#ifndef LLVM37_LIB_CODEGEN_MIRYAMLMAPPING_H
#define LLVM37_LIB_CODEGEN_MIRYAMLMAPPING_H
...
template <> struct ScalarTraits<StringValue> {
  static void output(const StringValue &S, void *, llvm37::raw_ostream &OS) {
    OS << S.Value;
  }
...
template <> struct ScalarTraits<FlowStringValue> {
  static void output(const FlowStringValue &S, void *, llvm37::raw_ostream &OS) {
...
LLVM37_YAML_IS_SEQUENCE_VECTOR(llvm37::yaml::StringValue)
LLVM37_YAML_IS_FLOW_SEQUENCE_VECTOR(llvm37::yaml::FlowStringValue)
...
struct MachineStackObject {
  ...
  // TODO: Serialize LLVM37 alloca reference.
  unsigned ID;
...
LLVM37_YAML_IS_SEQUENCE_VECTOR(llvm37::yaml::VirtualRegisterDefinition)
LLVM37_YAML_IS_SEQUENCE_VECTOR(llvm37::yaml::MachineBasicBlock)
LLVM37_YAML_IS_SEQUENCE_VECTOR(llvm37::yaml::MachineStackObject)
LLVM37_YAML_IS_SEQUENCE_VECTOR(llvm37::yaml::FixedMachineStackObject)
...
/// 'RealignOption' as they are determined by the target and LLVM37 function
/// attributes.
