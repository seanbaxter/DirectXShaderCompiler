//=- llvm37/CodeGen/DFAPacketizer.h - DFA Packetizer for VLIW ---*- C++ -*-=====//
//
...
#ifndef LLVM37_CODEGEN_DFAPACKETIZER_H
#define LLVM37_CODEGEN_DFAPACKETIZER_H
...
public:
  ...
  bool canReserveResources(const llvm37::MCInstrDesc *MID);

  // reserveResources - Reserve the resources occupied by a MCInstrDesc and
  // change the current state to reflect that change.
  void reserveResources(const llvm37::MCInstrDesc *MID);

  // canReserveResources - Check if the resources occupied by a machine
  // instruction are available in the current state.
  bool canReserveResources(llvm37::MachineInstr *MI);

  // reserveResources - Reserve the resources occupied by a machine
  // instruction and change the current state to reflect that change.
  void reserveResources(llvm37::MachineInstr *MI);
