//==- llvm37/CodeGen/MachineMemOperand.h - MachineMemOperand class -*- C++ -*-==//
//
...
#ifndef LLVM37_CODEGEN_MACHINEMEMOPERAND_H
#define LLVM37_CODEGEN_MACHINEMEMOPERAND_H

#include "llvm37/ADT/PointerUnion.h"
#include "llvm37/CodeGen/PseudoSourceValue.h"
#include "llvm37/IR/Metadata.h"
#include "llvm37/IR/Value.h"  // PointerLikeTypeTraits<Value*>
...
/// information about pointers in memory operands, relating them back to LLVM37 IR
...
struct MachinePointerInfo {
  ...
  /// getAddrSpace - Return the LLVM37 IR address space number that this pointer
  /// points into.
...
/// that aren't explicit in the regular LLVM37 IR.
///
...
public:
  ...
  /// be a normal LLVM37 IR Value, or one of the special values used in CodeGen.
