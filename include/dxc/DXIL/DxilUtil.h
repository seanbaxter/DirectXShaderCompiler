...
namespace dxilutil {
  ...
  void EmitErrorOnContext(llvm37::LLVMContext &Ctx, llvm37::Twine Msg);
  void EmitWarningOnContext(llvm37::LLVMContext &Ctx, llvm37::Twine Msg);
  void EmitNoteOnContext(llvm37::LLVMContext &Ctx, llvm37::Twine Msg);
