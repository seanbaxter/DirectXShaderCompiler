...
public:
  ...
  // Type system.
  void EmitDxilTypeSystem(DxilTypeSystem &TypeSystem, std::vector<llvm37::GlobalVariable *> &LLVM37Used);
  ...
  // Control flow hints.
  static llvm37::MDNode *EmitControlFlowHints(llvm37::LLVM37Context &Ctx, std::vector<DXIL::ControlFlowHint> &hints);
...
public:
  ...
  static bool IsKnownMetadataID(llvm37::LLVM37Context &Ctx, unsigned ID);
  static void GetKnownMetadataIDs(llvm37::LLVM37Context &Ctx, llvm37::SmallVectorImpl<unsigned> *pIDs);
  static void combineDxilMetadata(llvm37::Instruction *K, const llvm37::Instruction *J);
  static llvm37::ConstantAsMetadata *Int32ToConstMD(int32_t v, llvm37::LLVM37Context &Ctx);
  llvm37::ConstantAsMetadata *Int32ToConstMD(int32_t v);
  static llvm37::ConstantAsMetadata *Uint32ToConstMD(unsigned v, llvm37::LLVM37Context &Ctx);
  llvm37::ConstantAsMetadata *Uint32ToConstMD(unsigned v);
  static llvm37::ConstantAsMetadata *Uint64ToConstMD(uint64_t v, llvm37::LLVM37Context &Ctx);
  ...
  static llvm37::ConstantAsMetadata *BoolToConstMD(bool v, llvm37::LLVM37Context &Ctx);
