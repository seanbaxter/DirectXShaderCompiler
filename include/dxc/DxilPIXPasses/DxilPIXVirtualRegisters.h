...
void AddMD(llvm37::LLVMContext &Ctx, llvm37::Instruction *pI, std::uint32_t InstNum);
...
void AddMD(llvm37::LLVMContext &Ctx, llvm37::Instruction *pI, std::uint32_t RegNum);
...
void AddMD(llvm37::LLVMContext &Ctx, llvm37::AllocaInst *pAlloca, std::uint32_t RegNum, std::uint32_t Count);
...
void AddMD(llvm37::LLVMContext &Ctx, llvm37::StoreInst *pSt, llvm37::MDNode *pAllocaReg, llvm37::Value *Index);
