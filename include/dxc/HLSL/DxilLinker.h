...
public:
  virtual ~DxilLinker() {}
  static DxilLinker *CreateLinker(llvm37::LLVMContext &Ctx, unsigned valMajor, unsigned valMinor);
...
protected:
  DxilLinker(llvm37::LLVMContext &Ctx, unsigned valMajor, unsigned valMinor) : m_ctx(Ctx), m_valMajor(valMajor), m_valMinor(valMinor) {}
