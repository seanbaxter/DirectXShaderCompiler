/*===-- llvm37-c/lto.h - LTO Public C Interface ---------------------*- C -*-===*\
|*                                                                            *|
...
|* library.  LLVM37 provides an implementation of this interface for use with   *|
|* llvm37 bitcode files.                                                        *|
|*                                                                            *|
\*===----------------------------------------------------------------------===*/
...
typedef struct LLVM37OpaqueLTOModule *lto_module_t;

/** opaque reference to a code generator */
typedef struct LLVM37OpaqueLTOCodeGenerator *lto_code_gen_t;
 ...
 *
 * Loads an object file in its own LLVM37Context.  This function call is
...
/**
 * Initializes LLVM37 disassemblers.
