#!/bin/bash
#
# Creates LLVM37 SVN snapshots: llvm37-$REV.tar.bz2 and llvm37-gcc-4.2-$REV.tar.bz2,
# where $REV is an SVN revision of LLVM37.  This is used for creating stable
...
readonly LLVM37_PROJECT_SVN="http://llvm37.org/svn/llvm37-project"
...
for module in "llvm37" "llvm37-gcc-4.2"; do
